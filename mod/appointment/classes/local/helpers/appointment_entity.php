...
class appointment_entity extends entity_base {
    ...
    public function convert_get_entity_class(): string {
        return \mod_appointment\reportbuilder\local\entities\session::class;
    }
    ...
    protected function convert_get_generic_field_name(string $oldfieldname): string {
        $oldprefix = $this->get_table_alias('appointment_sessions') . 'id';
        $cfhandler = \core_customfield\handler::get_handler('mod_appointment', 'appointment');
