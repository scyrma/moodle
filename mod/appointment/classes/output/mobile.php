...
class mobile {
    ...
    public static function mobile_session_book($args) {
        ...
        $data['notificationtypes'] = [
            ['id' => MOD_APPOINTMENT_BOTH, 'name' => get_string('notificationboth', 'appointment'), 'selected' => true],
            ['id' => MOD_APPOINTMENT_TEXT, 'name' => get_string('notificationemail', 'appointment')],
            ['id' => MOD_APPOINTMENT_ICAL, 'name' => get_string('notificationical', 'appointment')],
        ];
