...
class multiple extends session {
    ...
    public function definition() {
        ...
        $repeatarray[] = $mform->createElement('duration', 'split', get_string('split', 'appointment'), $options);
        $repeatarray[] = $mform->createElement('duration', 'break', get_string('break', 'appointment'), $options);
