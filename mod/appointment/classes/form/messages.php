...
class messages extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'confirmationsubject', get_string('email:subject', 'appointment'), ['size' => '55']);
        ...
        $mform->addElement('text', 'updatesubject', get_string('email:subject', 'appointment'), ['size' => '55']);
        ...
        $mform->addElement('text', 'remindersubject', get_string('email:subject', 'appointment'), ['size' => '55']);
        ...
        $mform->addElement('text', 'waitlistedsubject', get_string('email:subject', 'appointment'), ['size' => '55']);
        ...
        $mform->addElement('text', 'cancellationsubject', get_string('email:subject', 'appointment'), ['size' => '55']);
