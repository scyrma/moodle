...
class external extends \external_api {
     ...
     * @return bool
     */
    public static function user_signup($sessionid) {
    ...
    public static function user_signup_returns() {
        return new \external_value(PARAM_BOOL, 'Returns true on successful sign up or throws an error');
    }
    ...
    public static function user_cancel($sessionid, $cancelreason) {
        ...
        attendee::cancel_self($session, $context, $params['cancelreason']);
        return true;
    }
    ...
    public static function user_cancel_returns() {
        return new \external_value(PARAM_BOOL, 'True if successfully cancelled session booking or throws an error');
    }
}
