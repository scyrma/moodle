...
class lib_test extends advanced_testcase {
    ...
    public function setUp(): void {
        ...
        /** @var \core_customfield_generator $customfieldgenerator */
    ...
    public function test_appointment_selector_find_users() {
        ...
        $potentialuserselector1 = new \appointment_candidate_selector('addselect', ['sessionid' => $sessionid1]);
        ...
        $existinguserselector1 = new \appointment_existing_selector('removeselect', ['sessionid' => $sessionid1]);
        ...
        $potentialuserselector2 = new \appointment_candidate_selector('addselect', ['sessionid' => $sessionid2]);
        ...
        $existinguserselector2 = new \appointment_existing_selector('removeselect', ['sessionid' => $sessionid2]);
    ...
    public function test_mod_appointment_completion_get_active_rule_descriptions() {
        ...
        // Two activities, both with automatic completion. One has the 'completionattended' rule, one doesn't.
        $course = $this->getDataGenerator()->create_course(['enablecompletion' => 1]);
        $appointment3 = $this->getDataGenerator()->create_module('appointment', [
            'course' => $course->id,
            'completion' => 2,
            'completionattended' => 1,
        ]);
        $appointment4 = $this->getDataGenerator()->create_module('appointment', [
            'course' => $course->id,
            'completion' => 2,
            'completionattended' => 0,
        ]);
        ...
        $cm3 = cm_info::create(get_coursemodule_from_instance('appointment', $appointment3->id));
        $cm4 = cm_info::create(get_coursemodule_from_instance('appointment', $appointment4->id));
        ...
        $moddefaultsattend = new stdClass();
        $moddefaultsattend->customdata = ['customcompletionrules' => ['completionattended' => 1]];
        $moddefaultsattend->completion = 2;
        ...
        $activeruledescriptionsattend = [get_string('completionattended', 'appointment')];
        $this->assertEquals($activeruledescriptionsattend, mod_appointment_get_completion_active_rule_descriptions($cm3));
        $this->assertEquals([], mod_appointment_get_completion_active_rule_descriptions($cm4));
        $this->assertEquals($activeruledescriptionsattend,
            mod_appointment_get_completion_active_rule_descriptions($moddefaultsattend));
        $this->assertEquals([], mod_appointment_get_completion_active_rule_descriptions(new stdClass()));
    }
     ...
     * @covers ::user_has_attended_sessions()
     */
    public function test_take_attendance() {
        ...
        $this->assertTrue(user_has_attended_sessions($user1->id, $appointment->id));
        $this->assertTrue(user_has_attended_sessions($user2->id, $appointment->id));
        $this->assertFalse(user_has_attended_sessions($user3->id, $appointment->id));
    }
