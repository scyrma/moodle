...
class mod_appointment_lib_testcase extends advanced_testcase {
    ...
    /**
     * Ensure that appointment_get_completion_state reflects the correct status.
     *
     * @covers ::user_has_booked_sessions
     */
    public function test_appointment_get_completion_state() {
        $this->resetAfterTest();
        ...
        $this->assertFalse(appointment_get_completion_state($course, $cm, $student->id, false));
        ...
        $this->assertTrue(appointment_get_completion_state($course, $cm, $student->id, false));
