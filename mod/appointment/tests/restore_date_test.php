...
class restore_date_test extends restore_date_testcase {
    ...
    public function test_restore_dates() {
        ...
        $signup = $DB->get_record('appointment_signups', ['sessionid' => $session->id, 'userid' => $user->id]);
        ...
        $newsignup = $DB->get_record('appointment_signups', ['sessionid' => $newsession->id, 'userid' => $user->id]);
        ...
        // Test session dates.
        $sessiondates = $DB->get_record('appointment_sessions_dates', ['sessionid' => $session->id]);
        $newsessiondates = $DB->get_record('appointment_sessions_dates', ['sessionid' => $newsession->id]);
