...
Feature: Book appointments
  ...
  Background:
    ...
    And I set the following visible fields to these values:
      ...
      | startdate[1][day]    | ##+2 days##j##  |
      | startdate[1][month]  | ##+2 days##n##  |
  ...
  Scenario: Test booking
    ...
    And I should see "##tomorrow##l, j F Y##" in the "Details" "dialogue"
    And I should see "1:00" in the "Details" "dialogue"
    And I should see "Open" in the "Details" "dialogue"
    And I press "Book" in the modal form dialogue
  ...
  Scenario: Test booking through calendar
    ...
    And I click on "##tomorrow##F Y##" "link" in the "Monthly view" "block"
    And I click on "##tomorrow##j##" "link" in the "calendarmonth" "table"
    And I should see "1:00"
  ...
  Scenario: Test overbooking is possible
    ...
    And I press "Join waitlist" in the modal form dialogue
