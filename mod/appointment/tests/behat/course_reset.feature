...
Feature: Course reset with appointment module
  ...
  Scenario: Course reset of appointment module grades
    Given the following "courses" exist:
      | fullname | shortname | format | enablecompletion |
      | Course 1 | C1        | topics | 1                |
    And the following "users" exist:
    ...
    And the following should exist in the "user-grades" table:
      | -1-            | -1-                  | -3- | -4- |
      | Student First  | student1@example.com | 100 | 100 |
      | Student Second | student2@example.com | 50  | 50  |
      | Student Third  | student3@example.com | 0   | 0   |
    And I am on the "Course 1" "reset" page
    And I set the following fields to these values:
      | Remove all session sign-ups | 1 |
      | Delete all grades           | 1 |
    ...
    And the following should exist in the "user-grades" table:
      ...
      | Student Second | student2@example.com | -   | -   |
      | Student Third  | student3@example.com | -   | -   |
