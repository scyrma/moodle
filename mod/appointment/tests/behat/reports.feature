...
Feature: Student reports in Appointment module
  ...
  Background:
    ...
    And I click on "[data-toggle='collapse']" "css_element" in the "10:40" "table_row"
    And I press "Cancel"
  ...
  Scenario: Viewing appointment dates on the course page
    ...
    And the "Book an appointment" item should exist in the "Done" dropdown of the "Test appointment" "activity"
    ...
    And I should see "Saturday, 1 January 2000, 9:40 AM - 10:00 AM" in the "Test appointment" "activity"
    And the "Book an appointment" item should exist in the "To do" dropdown of the "Test appointment" "activity"
