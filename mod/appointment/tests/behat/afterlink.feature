...
Feature: Display info on course page
  ...
  Scenario: Afterlink content should display date when date is known
    ...
    And I am on "Course 1" course homepage
    And I should see "##tomorrow##%A, %d %B %Y##" in the "Test appointment" "activity"
    And I should see "1:00" in the "Test appointment" "activity"
    And I should see "2:00" in the "Test appointment" "activity"
    And I follow "Test appointment"
    And I click on "[data-toggle='collapse']" "css_element" in the "1:00" "table_row"
    And I press "Cancel"
  ...
  Scenario: Afterlink content should display status when date is unknown
    ...
    And I should see "10 seats available"
    And I follow "Test appointment"
    And I click on "[data-toggle='collapse']" "css_element" in the "Not set" "table_row"
    And I click on "Book" "button" in the "Not set" "table_row"
    And I am on "Course 1" course homepage
    And I should see "Wait-listed"
    And I follow "Test appointment"
    And I click on "[data-toggle='collapse']" "css_element" in the "Not set" "table_row"
    And I click on "Cancel" "button" in the "Not set" "table_row"
    And I click on "Confirm cancellation" "button" in the "Cancel booking" "dialogue"
    And I am on "Course 1" course homepage
    And I should see "10 seats available"
