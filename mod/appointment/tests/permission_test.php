...
class permission_test extends advanced_testcase {
     ...
     * @return array[]
     */
    public static function require_can_signup_provider(): array {
        return [
     ...
     * @return array[]
     */
    public static function require_can_cancel_signup_provider(): array {
        return [
     ...
     * @return array
     */
    public static function require_various_provider(): array {
        return [
