...
class privacy_provider_test extends provider_testcase {
    ...
    public function test_get_metadata() {
        ...
        foreach ($itemcollection as $table) {
            $this->assertNotEmpty(get_string($table->get_summary(), 'mod_appointment'));
            foreach ($table->get_privacy_fields() as $field => $stringkey) {
                $this->assertNotEmpty(get_string($stringkey, 'mod_appointment'));
            }
        }
    }
    ...
    public function test_get_contexts_for_userid() {
        ...
        $this->setUser($user1);
        appointment_user_signup($session1, $appointment1, $course1,
            MOD_APPOINTMENT_STATUS_WAITLISTED);
        appointment_user_signup($session3, $appointment3, $course3,
            MOD_APPOINTMENT_STATUS_WAITLISTED);

        // User2 sign up for session2.
        $this->setUser($user2);
        appointment_user_signup($session2, $appointment2, $course2,
            MOD_APPOINTMENT_STATUS_WAITLISTED);
    ...
    public function test_get_users_in_context() {
        ...
        appointment_user_signup($session3, $appointment2, $course,
