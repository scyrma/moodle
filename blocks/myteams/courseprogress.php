...
$type = optional_param('type', -1, PARAM_INT); // Pre-load table filtering by course status.
...
if ($type !== -1) {
    $report->set_filter_values([
        'courseprogress:status_operator' => select::EQUAL_TO,
        'courseprogress:status_value' => $type,
    ]);
}
