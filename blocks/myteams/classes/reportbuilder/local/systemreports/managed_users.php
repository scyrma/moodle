...
class managed_users extends system_report {
    ...
    protected function initialise(): void {
        ...
        if (!$user || !$user->is_manager()) {
            ...
            [$where, $params] = $user->get_managed_users_select();
    ...
    protected function add_columns(): void {
        ...
        // Column "lastaccess" (Hidden in the table but needed to handle custom sorting).
        $this->add_column_from_entity('user:lastaccess')
            ->add_attributes(['class' => 'd-none']);

        $this->set_initial_sort_column('user:lastaccess', SORT_DESC);
    }
