...
class course_progress extends system_report {
    ...
    protected function initialise(): void {
        ...
        // Retrieve data only for user specified by report parameter.
        ...
        $this->set_downloadable(true, get_string('courseprogressexport', 'block_myteams', $userfullname));
    }
    ...
    protected function add_columns(string $course, string $userenrolment): void {
        ...
        $this->get_column('completion:completed')
            ...
            ->add_fields("{$course}.startdate, {$userenrolment}.timestart, {$userenrolment}.status")
