...
/**
 * Global report link exporter class
 *
 ...
 */
class global_report_link_exporter extends exporter {
    ...
    protected static function define_related(): array {
        return [
            'reportlink' => global_report_link::class,
        ];
    }
    ...
    protected function get_other_values(renderer_base $output): array {
        /** @var global_report_link $reportlink */
        $reportlink = $this->related['reportlink'];

        return [
            'title' => $reportlink->get_title(),
            'url' => (string) $reportlink->get_url(),
        ];
    }
