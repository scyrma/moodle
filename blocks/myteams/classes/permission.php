...
class permission {
    ...
    public static function can_view_course_progress(int $userid): bool {
        ...
        // We need to check if current user can view other users profile and has manager permission.
        $user = core_user::get_user($userid, '*', MUST_EXIST);
        return user_can_view_profile($user) && org_permission::user_is_manager();
    }
