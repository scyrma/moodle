...
class myinprogress implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        if ($hascourses) {
            $hiddenbadgeclasses = 'badge badge-secondary badge-pill ml-1';
            ...
            $coursecarousel = new course_carousel($this->courses, $cardactions, constants::FILTER_VISIBLE,
                $extraclasses, $extraattributes, $extracoursenames, $customemptystate);
