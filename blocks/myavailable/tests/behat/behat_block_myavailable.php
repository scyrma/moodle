...
/**
 * Steps definitions for block_myavailable.
 *
 ...
 */
class behat_block_myavailable extends behat_base {
    /**
    ...
    public static function get_partial_named_selectors(): array {
        return [
            new behat_component_named_selector('Course card', [
                "//*[contains(@class, 'block_myavailable')]//div[contains(@class, 'card dashboard-card')][contains(., %locator%)]",
            ]),
        ];
    }
}
