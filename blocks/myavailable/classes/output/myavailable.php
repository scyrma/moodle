...
/**
 * Class to prepare the available block for display.
 *
 ...
 */
class myavailable implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        return (object) [
            'blocktitle' => $hascourses
                ? get_string('blocktitle', 'block_myavailable', $coursescount)
                : get_string('pluginname', 'block_myavailable'),
            'hascourses' => $hascourses,
            'coursecarousel' => $coursecarouseloutput ?? '',
            'emptyimgurl' => new moodle_url('/blocks/myavailable/pix/no-courses.png')
        ];
    }
};
