...
/**
 * Class representing whether or not a site is over a given file quote threshold.
 *
 * @copyright 2017 Cameron Ball <cameron@cameron1729.xyz>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reached_file_quota_percentage implements criterion {
     ...
     * Constructor.
     *
     * @param float $threshold Threshol to test against.
     */
    ...
    public function is_met() : bool {
        return (file_system_s3::unique_storage_size_used() / FILESTORAGE_QUOTA) >= $this->threshold;;
    }
}
