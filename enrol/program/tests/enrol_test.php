...
class enrol_program_enrol_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_can_self_enrol() {
        ...
        // User is not yet allocated to program, they can not enrol in the course.
        $this->assertEquals('You can not enrol yourself in this course.', $enrol->can_self_enrol($instance));
