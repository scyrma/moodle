...
class enrol_test extends \advanced_testcase {
    ...
    public function setUp(): void {
        ...
        $this->generator = $programgenerator;
    ...
    public function test_enrol_hook_course_not_in_program() {
        global $DB;
        ...
        // Try to enrol in a course that is not in the program anymore.
        $DB->delete_records('tool_program_courses', ['setid' => $this->baseset->get('id'), 'courseid' => $this->course1->id]);
