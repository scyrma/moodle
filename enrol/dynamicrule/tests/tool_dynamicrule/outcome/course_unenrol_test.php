 ...
 */
class course_unenrol_test extends advanced_testcase {
    ...
    public function test_get_description() {
        ...
        $configdataenrolmethod = ['coursetounenrol' => $course2->id, 'action' => course_unenrol::ACTION_DISABLE_ENROLMENT];
        ...
        $configdatamultiple = ['coursetounenrol' => $course1->id, 'action' => course_unenrol::ACTION_DISABLE_ENROLMENT,
            'enrolmentmethod' => $methods];
     ...
     *
     * @uses \enrol_dynamicrule\tool_dynamicrule\outcome\course_unenrol::get_description
     * @uses \enrol_dynamicrule\tool_dynamicrule\outcome\course_unenrol::get_uneditable_description
     */
    public function test_get_displayed_description() {
        $course1 = $this->getDataGenerator()->create_course();
        $teacher = $this->getDataGenerator()->create_user();
        $this->getDataGenerator()->enrol_user($teacher->id, $course1->id, 'teacher', 'manual');

        $rule0 = $this->get_generator()->create_rule();
        $configdata = ['coursetounenrol' => $course1->id, 'action' => course_unenrol::ACTION_DISABLE_ENROLMENT];
        $outcome = course_unenrol::create($rule0->id, $configdata);
