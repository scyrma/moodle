 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class course_enrol extends outcome_base {
    ...
    public function get_uneditable_description(): string {
        $coursecontext = \context_course::instance($this->get_configdata()['coursetoenrol']);
    ...
    public function validate_config_form(array $data): array {
        global $DB;
        $errors = [];
        $course = $DB->get_record('course', ['id' => $data['coursetoenrol']]);
        if (!$course) {
            ...
            $errors['coursetoenrol'] = get_string('errorinvalidcoursetenant', 'tool_dynamicrule');
        }
