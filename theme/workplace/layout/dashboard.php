...
$dashboard = $OUTPUT->is_dashboard() ? $workplace->dashboard() : '';
...
$templatecontext = [
    ...
    'dashboard' => $dashboard,
    'hascontent' => ($PAGE->user_is_editing() && $PAGE->user_can_edit_blocks()) ||
        $PAGE->blocks->region_has_content('content', $OUTPUT),
];

component_class_callback('tool_wp\workplace', 'workplace_license_redirect', ['/my']);
$templatecontext['flatnavigation'] = $PAGE->flatnav;
echo $OUTPUT->render_from_template('theme_workplace/wpdashboard', $templatecontext);
