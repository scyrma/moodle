...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function tenant_menu() {
        if (empty($this->tenantmenu)) {
            $this->tenantmenu = component_class_callback('tool_tenant\tenancy', 'tenant_menu', [$this], '');
        }
    ...
    public function custom_footer() {
        return format_text(component_class_callback('\tool_tenant\manager', 'get_footer_text', []),
            FORMAT_HTML, ['context' => context_system::instance()]);
    }
