...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    private function workplace_menu_content() {
        ...
        if (!$this->workplacemenucontent) {
            ...
            $template->exportimport = $this->get_workplace_quick_link('tool_wp_exportimport', 'exportimport', 'tool_wp');

            $links = ['courses', 'programs', 'certifications', 'certificates', 'organisation', 'users', 'tenants', 'reportbuilder',
                'dynamicrules', 'exportimport'];
