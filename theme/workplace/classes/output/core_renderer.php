...
class core_renderer extends \theme_boost\output\core_renderer {
     ...
     */
    public function workplace_menu_button() {
        ...
        if (!empty($this->page->theme->settings->wpmenumodal)) {
            return $this->render_from_template('theme_workplace/local/wpmenu/wpmenu_modal_link', $data);
        } else {
            return $this->render_from_template('theme_workplace/local/wpmenu/wpmenu_dropdown', $data);
        }
    }
     ...
     *
     * @return string HTML containing the workplace menu modal.
     */
    public function workplace_menu_modal() {
        $data = $this->get_workplace_menu_data();
        if (!empty($this->page->theme->settings->wpmenumodal)) {
            return $this->render_from_template('theme_workplace/local/wpmenu/wpmenu_modal_content', $data);
        }
        return '';
    }
    ...
    public function get_logo_url($maxwidth = null, $maxheight = 200) {
        ...
        // TODO: WP-3173 rename 'loginlogo' to 'logo' for consistency.
        return $tenantmanager->get_tenant_file_url(tenancy::get_tenant_id(), 'loginlogo');
    }
    ...
    public function get_compact_logo_url($maxwidth = 300, $maxheight = 300) {
        ...
        $tenantmanager = new tenant_manager();
        // TODO: WP-3173 rename 'headerlogo' to 'compactlogo' for consistency.
        return $tenantmanager->get_tenant_file_url(tenancy::get_tenant_id(), 'headerlogo');
    }
