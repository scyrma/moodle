...
class icon_system_fontawesome extends \core\output\icon_system_fontawesome {
    ...
    public function get_core_icon_map() {
        ...
        $iconmap['core:a/refresh'] = 'wp-refresh';
        ...
        $iconmap['core:e/cancel'] = 'wp-close';
        ...
        $iconmap['core:i/contentbank'] = 'wp-paint-brush';
        ...
        $iconmap['core:t/download'] = 'wp-download';
        ...
        $iconmap['tool_wp:arrow-circle-right'] = 'wp-arrow-right-circle';
        ...
        $iconmap['tool_wp:play-circle'] = 'wp-play-circle';
        ...
        $iconmap['tool_wp:upload'] = 'wp-upload';
