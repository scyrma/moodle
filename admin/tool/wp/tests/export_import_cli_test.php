...
/**
 * File containing tests for export/import CLI.
 *
 * @package     tool_wp
 * @category    test
 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class tool_wp_export_import_cli_testcase extends advanced_testcase {
    ...
    public function test_locate_tenant_export() {
        ...
        $clihelper = $this->construct_helper(cli_helper::EXPORT,
            ['--user=admin', '--tenant=t1', '--exporter=tool_wp\\tool_wp\\exporter\\courses']);
        ...
        $clihelper = $this->construct_helper(cli_helper::EXPORT,
            ['--user=user1', '--tenant=t1', '--exporter=tool_wp\\tool_wp\\exporter\\courses']);
