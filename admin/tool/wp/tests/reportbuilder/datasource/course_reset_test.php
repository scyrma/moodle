...
class course_reset_test extends core_reportbuilder_testcase {
    ...
    public function test_stress_datasource(): void {
        ...
        (new course_reset_api((int) $course->id, (int) $user->id))->reset_course(['reason' => 'Stress test']);

        $this->datasource_stress_test_columns(course_reset::class);
        $this->datasource_stress_test_columns_aggregation(course_reset::class);
        $this->datasource_stress_test_conditions(course_reset::class, 'course_reset:reason');
    }
}
