...
Feature: Export and import courses
  ...
  Scenario: Export all courses
    ...
    And I press "Next"
    And I click on "Select categories manually" "radio"
    And I press "Next"
    ...
    And I click on "Select all courses in Category1 and subcategories" "radio"
    And I press "Next"
    ...
    Then the following should exist in the "report-table" table:
      | Exporter      | Status    |
      | Courses       | Success   |
    And I click on "View export" "link" in the "Courses" "table_row"
  ...
  Scenario: Import a course as admin to any category
    ...
    And I press "Next"
    And I should see "Courses (2)"
    And I click on "Not restricting to any tenant" "radio"
    And I press "Next"
    And I should see "Instances"
    ...
    And I navigate to "Migration" in workplace launcher
    And I click on "Import" "link" in the "[role=tablist]" "css_element"
    And I click on "View import" "link"
