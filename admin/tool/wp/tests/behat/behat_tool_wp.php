...
XPATH
            ...
            new behat_component_named_selector('Tab content', [
                <<<XPATH
    .//div[@aria-labelledby=//ul[@role='tablist']//a[@role='tab' and @aria-selected='true' and contains(string(), %locator%)]/@id]
XPATH
            ], false),
            new behat_component_named_selector('Active tab', [
                <<<XPATH
    .//ul[@role='tablist']//a[@role='tab' and @aria-selected='true' and contains(string(), %locator%)]
XPATH
            ], false),
        ];
    }
