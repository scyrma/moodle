 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class export_import_cohorts_test extends advanced_testcase {
    ...
    public function test_export_single_cohort(): void {
        ...
        $cohort = self::getDataGenerator()->create_cohort(['name' => 'Legends', 'customfield_hi' => 'Hello']);
        ...
        $this->assertInstanceOf(\tool_wp\tool_wp\importer\cohorts::class, $importer);
        ...
        $this->assertCount(1, $customfielddata);

        /** @var \tool_wp\local\exportimport\wp_imported_entity $entity */
        $entity = iterator_to_array($customfielddata, false)[0];
        $this->assertEquals($field->get('id'), $entity->get_raw_field('fieldid'));
    }
    ...
    public function test_export_import_all_cohorts(): void {
        ...
        $cohort1 = $this->getDataGenerator()->create_cohort(['name' => 'Legends', 'customfield_hi' => 'Hello']);
        ...
        $customfielddata = $DB->get_records('customfield_data');
        $this->assertCount(2, $customfielddata);
    }
