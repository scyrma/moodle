...
use tool_wp\local\exportimport\helper as helper;
 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class tool_wp_export_import_customfields_testcase extends advanced_testcase {
    ...
    public function test_export_program_with_customfields(): void {
        ...
        $this->assertCount(4, $DB->get_records('customfield_field'));
