 ...
 * @license     Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class cohort_mapper_test extends \advanced_testcase {
     ...
     * @return array
     */
    public static function locate_mapping_success_provider(): array {
        return [
     ...
     * @return array
     */
    public static function locate_mapping_error_provider(): array {
        return [
