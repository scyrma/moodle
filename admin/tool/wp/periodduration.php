...
class tool_wp_periodduration extends MoodleQuickForm_group {
     ...
     */
    public function _createElements() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    ...
    /**
     * Check that non-negative number is supplied.
     *
     * @param array $value
    ...
    public function validateSubmitValue($value) {
        ...
        if ($number < 0) {
            return get_string('errornegativenumber', 'tool_wp');
        }
    }
}
