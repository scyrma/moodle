...
// Display only on mobile setting for block_myoverview.
if ($hassiteconfig && $blockmyoverviewsettings = $ADMIN->locate('blocksettingmyoverview')) {
    $blockmyoverviewsettings->add(new admin_setting_configcheckbox(
        'tool_wp/myoverviewdisplayonmobileonly',
        get_string('blockmyoverviewmobileonly', 'tool_wp'),
        get_string('blockmyoverviewmobileonly_help', 'tool_wp'),
        1));
}