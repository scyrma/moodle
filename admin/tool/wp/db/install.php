...
function xmldb_tool_wp_install() {
    ...
    if (!during_initial_install()) {
        // When the site was upgraded from Moodle LMS to Moodle Workplace, we require to agree to the
        // Workplace license. This setting is only present in mdl_config table so we don't need to
        // delay it to the tool_wp_after_config() hook.
