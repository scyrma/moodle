...
class admin_externalpage extends \admin_externalpage {
     ...
     * @param array|null $extraurlparams an array paramname => paramvalue, or parameters that need to be
     ...
     * @param moodle_url|null $url optional url to link in the breadcrumb
     * @return void
     */
