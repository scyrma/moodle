...
abstract class tab_form extends tab {
    ...
    /**
     * Name of the class that contains the form (must extend \moodleform)
     *
     * @return string
     */
    ...
    /**
     * Check permission of the current user to edit
     *
     * @return bool
     */
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $form = new $classname(null, null, 'post', '', [], $this->can_edit(), $this->data);
