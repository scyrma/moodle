 ...
 * @deprecated Since 4.0 - please use {@see \core\output\dynamic_tabs} or {@see tool_wp\output\secondary_tabs} instead
 */
class tabs implements \templatable {
    ...
    public function __construct(array $attributes = [], array $tabs = []) {
        debugging('Tabs are deprecated, please use \core\output\dynamic_tabs or tool_wp\output\secondary_tabs instead',
            DEBUG_DEVELOPER);
