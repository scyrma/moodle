...
class users extends importer_base {
    ...
    protected function initialise() {
        ...
        // Register a notice if username/email fields are changed in order to resolve conflicts.
    ...
    public function add_to_conflict_form(import_conflict_form $form, string $importedentity, string $errorcode, array $detailsarray,
        ...
        if (strcmp($errorcode, 'usernameconflict') == 0) {
            ...
            $mform->setDefault($elementname, 'skip');
        }
    }
            ...
            foreach ($users as $user) {
                $user
                    ...
                    ->set_validation_callback(function(array $data): void {
                        ...
                        // Grab enough fields to pass to fullname.
                        $userfullnamefields = array_intersect_key($data, get_all_user_name_fields());
