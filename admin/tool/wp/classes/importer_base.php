...
abstract class importer_base {
    ...
    /** @var string used in {@link register_entity()} */
     ...
     *
     * @param string $exporterclass exporter who created the file, if known
     * @return bool
     */
    public function is_relevant(?string $exporterclass = null): bool {
        // If this is a workplace import, check that the imported file has entities from the
        // get_entities().
        // If this is not a workplace import, throw exception - this method should be extended.
    ...
    final public function require_workplace_format() {
        if ($this->get_format() & self::FORMAT_WORKPLACE != self::FORMAT_WORKPLACE) {
