...
class course_reset extends datasource {
    ...
    protected function initialise(): void {
        ...
        $userrequested = database::generate_alias();
        ...
        $certificationtenantentity
            ...
            ->add_joins($certificationentity->get_joins())
            ->add_join("JOIN {tool_tenant} {$tooltenantalias} ON {$tooltenantalias}.id = {$certification}.tenantid");
        ...
        $programtenantentity
            ...
            ->set_table_alias('tool_tenant', $tooltenantalias)
            ->add_joins($programentity->get_joins())
