...
namespace tool_wp\reportbuilder\local\formatters;
...
class course_reset {
     ...
     * @return string
     */
    public static function reset_status(string $value, stdClass $row): string {
        if (!$row->resetstatus) {
            return '';
        }
     ...
     * @return string
     */
    public static function format_string(string $value): string {
