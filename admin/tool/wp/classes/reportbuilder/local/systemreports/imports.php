...
class imports extends system_report {
     ...
     * @return string
     */
    public function format_importer(string $value, stdClass $row): string {
     ...
     * @return string
     */
    public static function format_status(int $value): string {
        $statusstr = helper::format_export_import_status($value);
        return helper::get_export_import_status_badge($value, $statusstr);
    }
     ...
     * @return string
     */
    public static function format_size(int $value): string {
