...
debugging('Class \tool_wp\modal_form is deprecated. Please use \core_form\dynamic_form. '.
    'See also https://docs.moodle.org/dev/Modal_and_AJAX_forms', DEBUG_DEVELOPER);
...
abstract class modal_form extends \moodleform {
     ...
     * @param bool $editable
     * @param array|null $ajaxformdata Forms submitted via ajax, must pass their data here, instead of relying on _GET and _POST.
    ...
    final public function __construct($action = null, $customdata = null, $method = 'post', $target = '', $attributes = [],
        ...
        if ($isajaxsubmission) {
            ...
            \core_external\external_api::validate_context($this->get_form_context());
