...
use tool_wp\reportbuilder\local\systemreports\exports;
...
class export_details_exporter extends persistent_exporter {
    ...
    protected function get_other_values(\renderer_base $output): array {
        ...
        $user = $DB->get_record('user', ['id' => $this->persistent->get('createdby')]);
        ...
        $statusstr = exports::format_status($this->persistent->get('status'));
