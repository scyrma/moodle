...
abstract class export_import_mapper_base {
     ...
     *    In most cases mappers can just call {@link display_identifier_idnumber_name()}
     *    callback
     *    function(array $identifier): string
     *
    ...
    final public function log_mapping_notice(string $noticecode, array $identifier, array $additionaldata = []) {
        ...
        $this->importmanager->get_current_import_detail_persistent()->add_mapping_notice($this,
     ...
     */
    final static protected function display_identifier_idnumber_name(array $identifier, string $idnumberfield = 'idnumber',
