...
class export implements \templatable {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        if ($stage == 4) {
            ...
            $rv['downloadurl'] = \moodle_url::make_pluginfile_url(\context_system::instance()->id, 'tool_wp',
                'export', $exportmanager->get_export_id(), '/', 'export'.$exportmanager->get_export_id().'.zip')->out(false);
