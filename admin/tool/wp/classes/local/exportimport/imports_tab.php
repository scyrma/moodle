...
class imports_tab extends tab {
    ...
    public function export_for_template(\renderer_base $output) {
        $report = system_report_factory::create(imports_list_report::class);
        $content = new content_with_heading($report->output(), $this->get_tab_label());
        $content->add_button(get_string('doimport', 'tool_wp'),
            \tool_wp\local\exportimport\helper::import_url(null, '', 0),
            ['data-action' => 'new-import']);
