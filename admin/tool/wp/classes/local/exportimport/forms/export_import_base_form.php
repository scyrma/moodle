 ...
 */
abstract class export_import_base_form extends dynamic_form {
    /** @var int */
    protected $stage;
     ...
     * @return export_import_base_form
     */
    final public static function mock_form_submission($formdata) {
        ...
        /** @var export_import_base_form $form */
     ...
     *
     * This context is validated in {@see \core_external\external_api::validate_context()}
     *
