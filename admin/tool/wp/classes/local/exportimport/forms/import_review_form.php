...
class import_review_form extends import_base_form {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'willbeimported', get_string('willbeimported', 'tool_program'));
        ...
        if ($conflicts) {
            ...
            foreach ($conflicts as $conflict) {
                ...
                $text .= \html_writer::div(get_string('solution', 'tool_wp'). ': ' . $conflict[1], 'conflictsolution m-b-1');
            }
    ...
    public function process(\stdClass $data) {
        ...
        return parent::process($data) + ['url' => $url->out(false)];
    }
