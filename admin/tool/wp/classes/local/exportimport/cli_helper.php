...
class cli_helper {
    ...
    protected function export_options_definitions() {
        ...
        // TODO WP-1847 no-tenant is not implemented yet.
        unset($definitions['no-tenant']);
        return $definitions;
    }
     ...
     */
    public function perform_export(): int {
        ...
        if ($status == helper::STATUS_DONE) {
            $url = \moodle_url::make_pluginfile_url(\context_system::instance()->id, 'tool_wp',
                'export', $exportid, '/', 'export'.$exportid.'.zip')->out(false);
    ...
    public function choose_importer() {
        ...
        // TODO Implement importer choice (not used ATM).
