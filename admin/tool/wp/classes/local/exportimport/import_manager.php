...
class import_manager {
    ...
    public function get_export_file_preview_as_html(): ?string {
        ...
        $data = $this->get_csv_reader()->get_preview();
        if (!$data) {
        ...
        // TODO WP-2008 - display all rows from CSV (also the string from 'tag' language pack is used temporarily here).
        $morelink = $hasmore ?
            \html_writer::tag('p', $hasmore.' '.get_string('moretags', 'tag')) : '';
        return \html_writer::table($table) . $morelink;
    }
