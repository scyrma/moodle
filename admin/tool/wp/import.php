...
\tool_wp\admin_externalpage::setup_page('tool_wp_exportimport', '', null,
    \tool_wp\local\exportimport\helper::import_url($importid, $entrypoint, $entrypointid));
\tool_wp\admin_externalpage::setup_subpage(get_string('doimport', 'tool_wp'));
...
$import = new \tool_wp\local\exportimport\import($importmanager, $configdata);
echo $OUTPUT->render_from_template('tool_wp/import', $import->export_for_template($OUTPUT));
