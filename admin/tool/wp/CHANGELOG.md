...
## 4.3 - 2023-11-09
### Changed
- New external classes `external_helper` and `external_helper_exception` added, to start using as a base
  for external methods to support consistent user lookup parameters via multiple/optional attributes
- The deprecated file `classes/modal_form.php` has been removed.
- The deprecated WS `modal_form` has been removed.

## 4.2.2 Rolling - 2023-08-22
- Web service 'tool_mobile_get_config' now returns also the setting 'wp_tool_tenant_config_id' with the tenantid.

## 4.2 - 2023-05-30
### Changed
- The deprecated class \tool_wp\db and its tests have been removed.
