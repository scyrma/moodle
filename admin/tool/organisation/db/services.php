...
$functions = [
    ...
    'tool_organisation_get_managed_users' => [
        // Deprecated from Moodle Workplace 4.1.
        'classname' => tool_organisation_external::class,
    ...
    'tool_organisation_update_positions' => [
        'classname' => 'tool_organisation\external\update_positions',
        'methodname' => 'execute',
        'description' => 'Update positions',
        'type' => 'write',
    ],
    'tool_organisation_update_departments' => [
        'classname' => 'tool_organisation\external\update_departments',
        'methodname' => 'execute',
        'description' => 'Update departments',
        'type' => 'write',
    ],
    'tool_organisation_unassign_manager' => [
        // Deprecated from Moodle Workplace 4.3.
        'classname' => 'tool_organisation\external\unassign_manager',
        'methodname' => 'execute',
        'description' => 'Delete manually assigned manager',
        'type' => 'write',
        'ajax' => true,
    ],
    'tool_organisation_assign_managers' => [
        'classname' => tool_organisation\external\assign_managers::class,
        'description' => 'Manually assign managers for the users',
        'type' => 'write',
        'ajax' => true,
    ],
    'tool_organisation_unassign_managers' => [
        'classname' => tool_organisation\external\unassign_managers::class,
        'description' => 'Unassign managers from employees or employees from managers',
        'type' => 'write',
        'ajax' => true,
    ],
];
