...
class permission {
    ...
    protected static function is_editable(hierarchy $hierarchy, int $tenantid = 0): bool {
        ...
        return !$hierarchy->get('archived') && self::is_entity_visible_in_list($hierarchy) &&
    ...
    public static function can_edit_position_in_its_tenant(position $position): bool {
        return self::has_manage_positions_capability() &&
            self::is_editable($position, $position->get('tenantid')) &&
    ...
    public static function can_edit_department_in_its_tenant(department $department): bool {
        return self::has_manage_positions_capability() &&
            self::is_editable($department, $department->get('tenantid')) &&
    ...
    /**
     * Checks if position/department is 'visible' to the current user based on the position/department tenant
     *
     ...
     * @return bool
     */
    public static function is_entity_visible_in_list(hierarchy $hierarchy, int $userid = null): bool {
