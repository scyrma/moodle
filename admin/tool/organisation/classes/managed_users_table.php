...
class managed_users_table extends system_report {
    ...
    protected function initialise() {
        ...
        $f->set_options_callback(function() {
            return organisation::get_managed_users_departments_menu($this->manager, 0,
        ...
        $f->set_is_default(true);
        $f->set_options_callback(function() {
            return organisation::get_managed_users_positions_menu($this->manager, 0,
    ...
    protected function set_columns() {
        ...
        $usersort = db::sql_fullname($usertablealias, false, true);
