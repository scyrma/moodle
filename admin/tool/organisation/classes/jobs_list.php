...
use tool_organisation\local\entities\department as department_entity;
use tool_organisation\local\entities\jobs as job_entity;
use tool_organisation\local\entities\position as position_entity;
...
class jobs_list extends system_report {
    ...
    protected function initialise() {
        $this->set_columns();
        $this->set_filters();
        $this->set_main_table('tool_organisation_job', 'toj');
        ...
        $this->add_base_fields('toj.id, toj.userid, toj.departmentid, toj.tenantid, toj.positionid, ' .
            'toj.enddate, u.firstname as fullusername,' .
