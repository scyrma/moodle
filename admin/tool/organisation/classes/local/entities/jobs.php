...
class jobs extends entity_base {
    ...
    protected function get_joins(): array {
        ...
        return array_merge(parent::get_joins(),
            [" LEFT JOIN {tool_organisation_position} {$posalias} ON {$jobalias}.positionid = {$posalias}.id ",
                "LEFT JOIN {tool_organisation_department} {$deptalias} ON {$jobalias}.departmentid = {$deptalias}.id "]);
    }
    ...
    protected function get_all_columns(): array {
        ...
        $sql = self::generate_framework_query($posalias);
        $newcolumn = (new report_column(
            'positionframework',
        ...
        $sql = self::generate_framework_query($deptalias);
        $newcolumn = (new report_column(
            'departmentframework',
