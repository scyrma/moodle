...
class jobs extends entity_base {
    ...
    protected function get_default_table_aliases(): array {
        return ['tool_organisation_job' => 'toj'];
    }
    ...
    protected function get_joins(): array {
        $tablealias = $this->get_table_alias('tool_organisation_job');
        return array_merge(parent::get_joins(),
            [" LEFT JOIN {tool_organisation_position} topos ON {$tablealias}.positionid = topos.id ",
                "LEFT JOIN {tool_organisation_department} tod ON {$tablealias}.departmentid = tod.id "]);
    }
