...
class user_department extends \tool_dynamicrule\condition_sql {
    ...
    public function get_description(): string {
        ...
        return get_string('conditionuserdepartmentdescription', 'tool_organisation', $a);
    }
    ...
    public function get_sql(): array {
        ...
        $usertablealias = 'u'; // TODO replace hardcoded value.
        list($where, $params) = helper::user_is_in_department_select($this->get_departmentid(),
            $this->get_with_subdepartments(), $usertablealias);
