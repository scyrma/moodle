    ...
    public function get_description(): string {
        ...
        switch ($config['startdate']) {
            case self::START_EXECUTION :
                $startdate = new lang_string('ruleoutcomeassignjobstartruledate', 'tool_organisation');
                break;
            case self::START_USER_CREATION :
                $startdate = new lang_string('ruleoutcomeassignjobstartuserdate', 'tool_organisation');
                break;
            case self::START_ABSOLUTE :
                $startdate = userdate($config['startdateabsolute'], get_string('strftimedatefullshort'));
                break;
        }

        switch ($config['enddate']) {
            case self::END_NONE :
                $enddate = new lang_string('none');
                break;
            case self::END_RELATIVE :
                $enddate = $config['enddaterelative'];
                break;
            case self::END_ABSOLUTE :
                $enddate = userdate($config['enddateabsolute'], get_string('strftimedatefullshort'));
                break;
        }
        return get_string('ruleoutcomeassignjobdescwithdates', 'tool_organisation', [
