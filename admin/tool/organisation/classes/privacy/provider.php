...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        ...
        $reporting = [
            'userid' => 'privacy:metadata:userid',
            'managerid' => 'privacy:metadata:managerid',
            'permissions' => 'privacy:metadata:permissions',
            'depth' => 'privacy:metadata:depth',
            'path' => 'privacy:metadata:path',
            'isdirect' => 'privacy:metadata:isdirect',
        ];
        $collection->add_database_table('tool_organisation_reporting', $reporting, 'privacy:metadata:reportingsummary');

        $usermanager = [
            'userid' => 'privacy:metadata:umuserid',
            'managerid' => 'privacy:metadata:ummanagerid',
            'permissions' => 'privacy:metadata:umpermissions',
            'pathlevel' => 'privacy:metadata:umpathlevel',
            'path' => 'privacy:metadata:umpath',
            'timecreated' => 'privacy:metadata:umtimecreated',
            'timemodified' => 'privacy:metadata:umtimemodified',
        ];
        $collection->add_database_table('tool_organisation_manual_mgr', $usermanager, 'privacy:metadata:umsummary');
