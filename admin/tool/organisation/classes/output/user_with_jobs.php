...
class user_with_jobs extends exporter {
     ...
     * @return string
     */
    public function fullname(bool $override): string {
        return fullname($this->data, $override);
    }
    ...
    protected function get_other_values(renderer_base $output): array {
        ...
        $canmessage = (!empty($CFG->messaging) && \core_message\api::can_post_message($user));
        ...
        $rv = [
            'userfullname' => fullname($this->data),
            'jobs' => $jobs,
