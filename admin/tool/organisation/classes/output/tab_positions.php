...
class tab_positions extends tab {
    ...
    /**
     * Get instance of position manager
     * @return position_manager
     */
    protected function get_manager():position_manager {
        if ($this->manager === null) {
            $this->manager = new position_manager();
        }
        return $this->manager;
    }
    ...
    public function export_for_template(renderer_base $output) {
        ...
        if (!$manager->has_any_position_for_jobcreate()) {
