 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class department_deleted extends \core\event\base {
     ...
     */
    public static function create_from_object(department $department) : department_deleted {
        $event = static::create([
    ...
    public static function get_name() {
        return get_string('eventdepartmentdeleted', 'tool_organisation');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the department with id '$this->objectid'";
    }
