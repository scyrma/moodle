...
class job_deleted extends \core\event\base {
     ...
     * @return job_deleted
     */
    public static function create_from_object(job $job) : job_deleted {
        $event = static::create([
    ...
    public static function get_name() {
        return get_string('eventjobdeleted', 'tool_organisation');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the job with id '$this->objectid' " .
