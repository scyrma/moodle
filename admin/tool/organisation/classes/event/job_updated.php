 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class job_updated extends \core\event\base {
     ...
     * @return job_updated
     */
    public static function create_from_object(job $job, \stdClass $oldrecord) : base {
        $params = [
    ...
    public static function get_name() {
        return get_string('eventjobupdated', 'tool_organisation');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the job with id '$this->objectid' " .
