...
/**
 * The user_manager_updated event class.
 *
 ...
 */
class user_manager_updated extends base {
     ...
     * @return base
     */
    public static function create_from_object(user_manager $usermanager, int $oldmanagerid): base {
        $params = [
    ...
    public static function get_name(): string {
        return get_string('eventusermgrupdated', 'tool_organisation');
    }
    ...
    public function get_description(): string {
        return "The manually assigned manager was changed from ".$this->other['oldmanagerid']." to ".$this->other['managerid']."
            over user ".$this->other['employeeid'];
    }
