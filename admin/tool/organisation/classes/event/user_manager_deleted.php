...
/**
 * The user_manager_deleted event class.
 *
 ...
 */
class user_manager_deleted extends base {
    ...
    public static function get_name(): string {
        return get_string('eventusermgrdeleted', 'tool_organisation');
    }
    ...
    public function get_description(): string {
        return "The manually assigned manager was deleted from user with id ".$this->other['employeeid'];
    }
