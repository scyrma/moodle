...
/**
 * The department_created event class.
 *
 * @package    tool_organisation
 * @copyright  2018 Moodle Pty Ltd <support@moodle.com>
 * @author     2018 Marina Glancy
 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class department_created extends \core\event\base {
     ...
     */
    public static function create_from_object(department $department) : department_created {
        $event = static::create([
    ...
    public static function get_name() {
        return get_string('eventdepartmentcreated', 'tool_organisation');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the department with id '$this->objectid'";
    }
