...
class position_manager extends hierarchy_manager {
     ...
     * @return position
     */
    public function create_position(\stdClass $data) : position {
        $parent = !empty($data->parentid) ? $this->get_position($data->parentid) : new position();
        $position = $this->create_hierarchy($parent, $data);
        return $position;
    }
     ...
     */
    public function get_position(int $positionid) : position {
