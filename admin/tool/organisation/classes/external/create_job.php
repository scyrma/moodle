...
class create_job extends external_api {
    ...
    public static function execute($userid, $jobdeparment, $jobposition, $startdate = null, $enddate = null) : array {
        ...
        // TODO WP-1662 remove the tenant switch.
        tenancy::set_switched_tenant_id($tenantid);
        permission::require_can_assign_job_to_user($user->id);
        $conditions = [
            'idnumber' => $params['jobposition'],
            'tenantid' => $tenantid
        ];
        ...
        // Validate if enddate is mentioned then it should be bigger than startdate.
