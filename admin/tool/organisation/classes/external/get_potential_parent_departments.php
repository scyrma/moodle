...
class get_potential_parent_departments extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'departmentid' => new external_value(PARAM_INT, 'Department id', VALUE_REQUIRED),
        ]);
    }
     ...
     * @return array
     */
    public static function execute(string $search, int $departmentid): array {
        ...
        return $manager->get_potential_parents($search, $department);
    }
