...
class tool_organisation_observer {
    ...
    public static function user_deleted(user_deleted $event): void {
        ...
        // Delete user manually assigned manager relations.
        user_manager::delete_user_manager(['userid' => $event->objectid]);
        user_manager::delete_user_manager(['managerid' => $event->objectid]);
    ...
    public static function tenant_deleted(\tool_tenant\event\tenant_deleted $event): void {
        ...
        user_manager::delete_user_manager(['tenantid' => $event->objectid]);
    ...
    public static function tenant_user_updated(\tool_tenant\event\tenant_user_updated $event) {
        ...
        // Delete user manually assigned manager relations.
        user_manager::delete_user_manager(['userid' => $event->relateduserid]);
        user_manager::delete_user_manager(['managerid' => $event->relateduserid]);
