...
class showpastjobs extends filter_base {
    ...
    public function convert_condition_values(array $values, \core_reportbuilder\local\filters\base $newcondition): array {
        if ($newcondition instanceof \tool_organisation\reportbuilder\local\filters\showpast) {
        ...
        // The datasource mapped this condition to something else, not "showpast", so
