...
use tool_organisation\reportbuilder\local\filters\user_department;
...
/**
 * Filter users who have at least one job in a specific department
 *
 ...
 * @license   Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class department_select extends select {
    ...
    public function convert_condition_values(array $values, \core_reportbuilder\local\filters\base $newcondition): array {
        if ($newcondition instanceof user_department) {
    ...
    public function get_sql_filter(?array $values) : array {
        ...
        list ($sql, $params) = helper::user_is_in_department_select((int)$value, (bool)$operator, $usertablealias);
        return [$sql, $params];
    }
