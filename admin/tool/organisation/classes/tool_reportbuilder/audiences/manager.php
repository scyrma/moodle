...
/**
 * Report audience type based on a users with manager permission within the organisation structure
 *
 ...
 */
class manager extends audience_base {
    ...
    public function convert_get_audience_class(): string {
        return \tool_organisation\reportbuilder\audience\manager::class;
    }
