...
class tool_tenant {
    ...
    public static function get_tenant_admin_capabilities() {
        return [
            'tool/organisation:assignjobs' => CAP_ALLOW,
            'tool/organisation:managedepartments' => CAP_ALLOW,
            'tool/organisation:managepositions' => CAP_ALLOW,
            'tool/organisation:assigninlocked' => CAP_INHERIT, // Available but not allowed by default.
            'tool/organisation:assignmanuallymgr' => CAP_ALLOW,
        ];
    }
