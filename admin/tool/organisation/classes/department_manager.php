...
class department_manager extends hierarchy_manager {
     ...
     */
    public function get_department(int $departmentid, bool $currenttenantonly = true) : department {
     ...
     *     from unittests and imports
     */
    public function create_department(\stdClass $data, bool $currenttenantonly = true) : department {
        $parent = !empty($data->parentid) ? $this->get_department($data->parentid, $currenttenantonly) : new department();
        $department = $this->create_hierarchy($parent, $data, $currenttenantonly);
        return $department;
    }
    ...
    /**
     * Delete all departments inside one tenant. Used when tenant is deleted.
     *
     * @param int $tenantid
     */
    public function delete_all_departments_for_tenant(int $tenantid) {
