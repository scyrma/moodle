...
class tool_organisation_condition_user_department_testcase extends advanced_testcase {
    ...
    public function test_get_title() {
        $condition = new \tool_organisation\tool_dynamicrule\condition\user_department();
        $this->assertNotEmpty($condition->get_title());

        $condition = new \tool_organisation\tool_dynamicrule\condition\user_not_in_department();
        $this->assertNotEmpty($condition->get_title());
    }
    ...
    public function test_get_category() {
        ...
        $conditionneg = new \tool_organisation\tool_dynamicrule\condition\user_not_in_department();
    ...
    public function test_get_matching_users() {
        ...
        \tool_organisation\tool_dynamicrule\condition\user_department::create($rule1->id, $configdata);
        ...
        $configdata = ['departmentid' => $department1->id, 'withsubdepartments' => 0];
        \tool_organisation\tool_dynamicrule\condition\user_not_in_department::create($rule12->id, $configdata);
        ...
        $this->assertEquals([$user1a->id, $user3->id, $user4->id, get_admin()->id], array_column($users, 'id'), '', 0, 10, true);

        // Department 2.
        $rule2 = $this->get_generator()->create_rule();
        $configdata = ['departmentid' => $department2->id, 'withsubdepartments' => 0];
        \tool_organisation\tool_dynamicrule\condition\user_department::create($rule2->id, $configdata);
        ...
        $this->assertEquals([$user3->id, $user4->id], array_column($users, 'id'), '', 0, 10, true);

        // Department 2 negated.
        $rule22 = $this->get_generator()->create_rule();
        $configdata = ['departmentid' => $department2->id, 'withsubdepartments' => 0];
        \tool_organisation\tool_dynamicrule\condition\user_not_in_department::create($rule22->id, $configdata);
        ...
        $this->assertEquals([$user1->id, $user1a->id, $user2->id, get_admin()->id], array_column($users, 'id'), '', 0, 10, true);
        ...
        $users = \tool_dynamicrule\api::get_matching_users($rule1->id);
        $this->assertEquals([$user1->id, $user1a->id, $user2->id], array_column($users, 'id'), '', 0, 10, true);
        ...
        $users = \tool_dynamicrule\api::get_matching_users($rule12->id);
        $this->assertEquals([$user3->id, $user4->id, get_admin()->id], array_column($users, 'id'), '', 0, 10, true);
    }
    ...
    public function test_get_description() {
        ...
        $condition1 = \tool_organisation\tool_dynamicrule\condition\user_department::create($rule1->id, $configdata);

        $this->assertEquals(get_string('conditionuserdepartmentdescription', 'tool_organisation', $department1->name),
                            $condition1->get_description());

        $rule2 = $this->get_generator()->create_rule();
        $condition2 = \tool_organisation\tool_dynamicrule\condition\user_not_in_department::create($rule2->id, $configdata);

        $this->assertEquals(get_string('conditionuserdepartmentdescriptionnegated', 'tool_organisation', $department1->name),
    ...
    public function test_is_configuration_valid(): void {
        ...
        $condition2 = \tool_organisation\tool_dynamicrule\condition\user_not_in_department::create($rule1->id, $configdata);
    ...
    public function test_trigger_rule_processing() {
        ...
        \tool_organisation\tool_dynamicrule\condition\user_department::create($rule0->id, $configdata);
        $configdata = ['subject' => 'You are in department0', 'body' => 'Congratulations, you are in department0.'];
