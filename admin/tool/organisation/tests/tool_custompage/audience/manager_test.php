...
class manager_test extends advanced_testcase {
    ...
    public function test_get_sql(): void {
        ...
        [$managerposition, $managerdepartment] = $orggenerator->create_position_and_department($managerpermission);

        $usermanager = $this->getDataGenerator()->create_user();
        $orggenerator->assign_job([
        ...
        [$leadposition, $leaddepartment] = $orggenerator
