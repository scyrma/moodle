...
class tool_organisation_permission_testcase extends advanced_testcase {
    ...
    /**
     * Test for is_entity_visible_in_list
     */
    public function test_is_entity_visible_in_list(): void {
        self::setAdminUser();
        ...
        $this->assertTrue(\tool_organisation\permission::is_entity_visible_in_list($positionframework1));
        $departmentframework1 = (new \tool_organisation\department_manager())->create_department((object)['name' => 'F1']);
        $this->assertTrue(\tool_organisation\permission::is_entity_visible_in_list($departmentframework1));
        ...
        $this->assertTrue(\tool_organisation\permission::is_entity_visible_in_list($positionframework2));
        $departmentframework2 = (new \tool_organisation\department_manager())->create_department((object)$params, false);
        $this->assertTrue(\tool_organisation\permission::is_entity_visible_in_list($departmentframework2));
        ...
        $this->assertFalse(\tool_organisation\permission::is_entity_visible_in_list($positionframework3));
        $departmentframework3 = (new \tool_organisation\department_manager())->create_department((object)$params, false);
        $this->assertFalse(\tool_organisation\permission::is_entity_visible_in_list($departmentframework3));

        // Execute for a user in tenant2. They should see shared frameworks and frameworks in tenant2.
        $this->assertFalse(\tool_organisation\permission::is_entity_visible_in_list($positionframework1, $user2->id));
        $this->assertFalse(\tool_organisation\permission::is_entity_visible_in_list($departmentframework1, $user2->id));
        $this->assertTrue(\tool_organisation\permission::is_entity_visible_in_list($positionframework2, $user2->id));
        $this->assertTrue(\tool_organisation\permission::is_entity_visible_in_list($departmentframework2, $user2->id));
        $this->assertTrue(\tool_organisation\permission::is_entity_visible_in_list($positionframework3, $user2->id));
        $this->assertTrue(\tool_organisation\permission::is_entity_visible_in_list($departmentframework3, $user2->id));
    }
