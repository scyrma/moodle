...
class tool_organisation_department_testcase extends advanced_testcase {
    ...
    public function test_get_potential_parents() {
        ...
        $potentialparents = $manager->get_potential_parents('', $manager->get_department($this->framework1->id));
        $this->assertCount(0, $potentialparents);

        // Look for department11 potential parents without any search string.
        $potentialparents = $manager->get_potential_parents('', $manager->get_department($this->department11->id));
        ...
        $potentialparents = $manager->get_potential_parents('Test', $manager->get_department($this->department11->id));
