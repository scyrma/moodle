...
class end_jobs_test extends \advanced_testcase {
     ...
     * @param string|int $expectedenddate
     *
     * @dataProvider apply_to_users_provider
     */
    public function test_apply_to_users(array $ruleconfigdata, array $jobconfigdata, $expectedenddate): void {
        $this->setAdminUser();
        ...
        if (is_string($expectedenddate)) {
            $expectedenddate = strtotime($expectedenddate, $timenow);
        }
        if (isset($ruleconfigdata['enddateabsolute'])) {
            $ruleconfigdata['enddateabsolute'] = strtotime($ruleconfigdata['enddateabsolute'], $timenow);
        }
        if (isset($jobconfigdata['startdate'])) {
            $jobconfigdata['startdate'] = strtotime($jobconfigdata['startdate'], $timenow);
        }
        if (isset($jobconfigdata['enddate'])) {
            $jobconfigdata['enddate'] = strtotime($jobconfigdata['enddate'], $timenow);
        }
