...
class tool_organisation_organisation_testcase extends advanced_testcase {
     ...
     */
    public function test_user_in_department_or_position() {
        global $PAGE, $DB;
        $this->generate_structure();
        ...
        $this->assert_selected_users('admin,guest,u_pa1_db,u_pa1_db1,u_pa2_db,'.
            'u_pa2_db1,u_pa_db,u_pa_db1,u_pb_db,u_pb_db1', "NOT " . $where, $params);
        ...
        $this->assert_selected_users('admin,guest,u_pa1_da1,u_pa1_db,u_pa1_db1,u_pa2_da1,u_pa2_db,'.
            'u_pa2_db1,u_pb_da1,u_pb_db,u_pb_db1,u_pb_da,u_pa1_da,u_pa2_da', "NOT " . $where, $params);
        ...
        $this->assert_selected_users('admin,guest,u_pb_da1,u_pb_db,u_pb_db1,u_pb_da',
            "NOT " . $where, $params);
    }
