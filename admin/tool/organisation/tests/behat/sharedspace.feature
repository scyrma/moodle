...
Feature: Shared space in tool_organisation
  As a global admin
  I can not use Organisation structure in the Shared space
  ...
  Scenario: When in shared space the Report builder is not available
    ...
    And I should see "Organisation structure" in the ".workplace-menu" "css_element"
    ...
    And I click on "#workplace-menulink" "css_element"
    And I should see "All users" in the ".workplace-menu" "css_element"
    And I should not see "Organisation structure" in the ".workplace-menu" "css_element"
    And I log out
