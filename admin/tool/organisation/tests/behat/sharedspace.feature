...
Feature: Shared space in tool_organisation
  ...
  Scenario: Viewing and editing departments in shared space as tenant administrator
    ...
    Then I click on "Departments" "link" in the ".wptabs" "css_element"
    ...
    And "Edit name" "link" should exist in the "Department111_" table tree node
    And "Edit name" "link" should exist in the "Department112_" table tree node
    And "Edit name" "link" should exist in the "Department113_" table tree node
    And "Edit name" "link" should not exist in the "DepartmentS11_" table tree node
    And "Edit name" "link" should not exist in the "DepartmentS12_" table tree node
  ...
  Scenario: Viewing and editing positions in shared space as tenant administrator
    When I log in as "tenantadmin1"
    And I navigate to "Organisation structure" in workplace launcher
    Then I click on "Positions" "link" in the ".wptabs" "css_element"
    ...
    And "Edit name" "link" should exist in the "Position111_" table tree node
    And "Edit name" "link" should exist in the "Position112_" table tree node
    And "Edit name" "link" should exist in the "Position113_" table tree node
    And "Edit name" "link" should not exist in the "PositionS11_" table tree node
    And "Edit name" "link" should not exist in the "PositionS12_" table tree node
    # Tenantadmin does not see the 'Edit in Shared space' button.
    And I should not see "Edit in Shared space"
  ...
  Scenario: Creating jobs in a tenant using Departments and position from Shared space
    ...
    Then the following should exist in the "report-table" table:
      ...
      | User 11   | DepartmentS11_   | PositionS11_   |             |  ##today##j/m/y##  |            |
      | User 12   | DepartmentS11_   | PositionS11_   |             |  ##today##j/m/y##  |            |
  ...
  Scenario: Shared departments and shared positions show up on Teams dashboard
    ...
    And I should see "User 11" in the "#teams" "css_element"
    And I should see "User 12" in the "#teams" "css_element"
    And I should not see "User 13" in the "#teams" "css_element"
    And I should see "User 14" in the "#teams" "css_element"
    And I click on "Customise..." "radio"
    And I set the field "Position" to "PositionS11_"
    And I should see "User 11" in the "#teams" "css_element"
    And I should not see "User 12" in the "#teams" "css_element"
    And I should not see "User 13" in the "#teams" "css_element"
    And I should not see "User 14" in the "#teams" "css_element"
    And I click on "Include subpositions" "checkbox"
    And I should see "User 11" in the "#teams" "css_element"
    And I should see "User 12" in the "#teams" "css_element"
    And I should not see "User 13" in the "#teams" "css_element"
    And I should not see "User 14" in the "#teams" "css_element"
    And I set the field "Position" to "Any"
    And I set the field "Department" to "DepartmentS11_"
    And I should see "User 11" in the "#teams" "css_element"
    And I should see "User 12" in the "#teams" "css_element"
    And I should not see "User 13" in the "#teams" "css_element"
    And I should not see "User 14" in the "#teams" "css_element"
  ...
  Scenario: Ensure teams tab and shared programs work well with shared departments and positions
    ...
    And I click on "Users" "link" in the "ProgramShared" "table_row"
    And I press "Allocate users"
    Then I open the autocomplete suggestions list in the dialog
    And "User 13" "autocomplete_suggestions" should exist
    And "User 14" "autocomplete_suggestions" should exist
