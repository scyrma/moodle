...
Feature: Viewing one's team on the dashboard
  ...
  Scenario: Teams members report from the dashboard after applying filters
    ...
    And I click on "Apply" "button" in the "[data-region='report-filters']" "css_element"
    And I should see "User200" in the "region-main" "region"
    And I should see "User300" in the "region-main" "region"
    And I should see "User400" in the "region-main" "region"
    And I should see "User500" in the "region-main" "region"
    And I should see "User600" in the "region-main" "region"
    And I should see "User700" in the "region-main" "region"
    And I set the following fields in the "Organisation structure" "core_reportbuilder > Filter" to these values:
      | Show my own direct reports only | 1 |
    And I click on "Apply" "button" in the "[data-region='report-filters']" "css_element"
    And I should see "User200" in the "region-main" "region"
    And I should see "User300" in the "region-main" "region"
    And I should see "User400" in the "region-main" "region"
    And I should not see "User500" in the "region-main" "region"
    And I should not see "User600" in the "region-main" "region"
    And I should not see "User700" in the "region-main" "region"
    And I set the following fields in the "Organisation structure" "core_reportbuilder > Filter" to these values:
      | Customise... | 1              |
      | Position     | Position_t1_f3 |
    And I click on "Apply" "button" in the "[data-region='report-filters']" "css_element"
    And I should not see "User200" in the "region-main" "region"
    And I should see "User300" in the "region-main" "region"
    And I should not see "User400" in the "region-main" "region"
    And I should see "User500" in the "region-main" "region"
    And I should not see "User600" in the "region-main" "region"
    And I should not see "User700" in the "region-main" "region"
    And I set the following fields in the "Organisation structure" "core_reportbuilder > Filter" to these values:
      | Customise... | 1                |
      | Department   | Department_t1_d2 |
    And I click on "Apply" "button" in the "[data-region='report-filters']" "css_element"
    And I should not see "User200" in the "region-main" "region"
    And I should not see "User300" in the "region-main" "region"
    And I should not see "User400" in the "region-main" "region"
    And I should see "User500" in the "region-main" "region"
    And I should not see "User600" in the "region-main" "region"
    And I should not see "User700" in the "region-main" "region"
