...
Feature: Organisation structure generator
  ...
  Scenario: Organisation generator to quickly create teams
    ...
    And "User 12" "text" should exist in the "#teams" "css_element"
    And "User 13" "text" should exist in the "#teams" "css_element"
    ...
    And I set the field "Show everybody reporting to me" to "1"
    And "User 15" "text" should exist in the "#teams" "css_element"
    And "User 11" "text" should not exist in the "#teams" "css_element"
