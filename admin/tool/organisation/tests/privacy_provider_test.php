...
class privacy_provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_get_metadata() {
        ...
        // Get job table collection.
        $table = $itemcollection[0];
        ...
        // Get reporting table collection.
        $table = $itemcollection[1];
        $this->assertEquals('tool_organisation_reporting', $table->get_name());
        $this->assertEquals('privacy:metadata:reportingsummary', $table->get_summary());

        $privacyfields = $table->get_privacy_fields();
        $this->assertArrayHasKey('userid', $privacyfields);
        $this->assertArrayHasKey('managerid', $privacyfields);
        $this->assertArrayHasKey('permissions', $privacyfields);
        $this->assertArrayHasKey('depth', $privacyfields);
        $this->assertArrayHasKey('path', $privacyfields);
        $this->assertArrayHasKey('isdirect', $privacyfields);

        // Get user manager table collection.
        $table = $itemcollection[2];
        $this->assertEquals('tool_organisation_manual_mgr', $table->get_name());
        $this->assertEquals('privacy:metadata:umsummary', $table->get_summary());
    ...
    public function test_get_contexts_for_userid() {
        ...
        $this->assertEquals([\context_user::instance($this->user1->id)->id], $contextlist->get_contextids());
    }
    ...
    public function test_export_user_data() {
        ...
        $data = (object)$writer->get_data($contextpath);
