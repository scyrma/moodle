...
/**
 * File contains the unit tests for condition user_without_position class.
 *
 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class tool_organisation_condition_user_without_position_testcase extends advanced_testcase {
