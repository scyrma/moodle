 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class tool_organisation_export_import_testcase extends advanced_testcase {
    ...
    public function test_export_import_departments_csv_new_framework() {
        ...
        $this->assertCount(1, $depswithidnumber);
...
EOF
     ...
     * set to empty.
     */
    public function test_export_import_departments_csv_existing_framework() {
        global $DB;
        $this->generate_structure();
        $user = $this->generate_user('user1');
        $this->make_user_tenant_admin($user->id);
...
EOF
        ...
        $settings = [
            ...
            dep_importer_csv::IMPORT_SELECT_FRAMEWORK => $this->dfother->id,
            dep_importer_csv::IMPORT_HIERARCHY => dep_importer_csv::IMPORT_HIERARCHY_NONE,
            'csvmapping:name' => 'name',
            'csvmapping:idnumber' => 'idnumber',
            'csvmapping:description' => 'description',
     ...
     * set to increment.
     */
    public function test_export_import_posiions_csv_new_framework() {
        global $DB;
        $this->generate_structure();
        $user = $this->generate_user('user1');
        $this->make_user_tenant_admin($user->id);
        ...
        $this->assertCount(1, $poswithidnumber);
...
EOF
     ...
     * set to empty.
     */
    public function test_export_import_posiions_csv_existing_framework() {
        global $DB;
        $this->generate_structure();
        $user = $this->generate_user('user1');
        $this->make_user_tenant_admin($user->id);
...
EOF
        ...
        $settings = [
            ...
            pos_importer_csv::IMPORT_SELECT_FRAMEWORK => $this->pfother->id,
            pos_importer_csv::IMPORT_HIERARCHY => pos_importer_csv::IMPORT_HIERARCHY_NONE,
            'csvmapping:name' => 'name',
            'csvmapping:idnumber' => 'idnumber',
            'csvmapping:description' => 'description',
