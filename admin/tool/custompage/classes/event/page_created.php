 ...
 */
class page_created extends page_base {
    ...
    public static function get_name(): string {
        return get_string('pagecreated', 'tool_custompage');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' created the custom page with id '{$this->objectid}'";
    }
}
