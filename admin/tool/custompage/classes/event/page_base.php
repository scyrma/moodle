...
abstract class page_base extends base {
    ...
    /**
     * Creates an instance from given page
     *
     * @param page $page
     * @return self
     */
    final public static function create_from_object(page $page): parent {
        $event = self::create([
    ...
    public function get_url(): ?moodle_url {
        return new moodle_url('/admin/tool/custompage/view.php', ['id' => $this->objectid]);
    }
}
