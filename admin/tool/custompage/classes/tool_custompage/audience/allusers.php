...
class allusers extends base {
    ...
    public function get_config_form(MoodleQuickForm $mform): void {
        $mform->addElement('static', 'allsiteusers', get_string('allauthenticatedusersdesc', 'tool_custompage'));
    }
    ...
    public function get_name(): string {
        return get_string('allauthenticatedusers', 'tool_custompage');
    }
    ...
    public function get_description(): string {
        return get_string('allauthenticatedusersdesc', 'tool_custompage');
    }
