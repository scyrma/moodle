...
class duplicate extends external_api {
     ...
     * @return string
     */
    public static function execute(int $pageid, bool $amendglobal, bool $newglobal = false): string {
        [
            'pageid' => $pageid,
        ...
        return (new moodle_url('/admin/tool/custompage/manage.php', ['id' => $newpage->get('id')]))->out();
    }
    ...
    public static function execute_returns(): external_value {
        return new external_value(PARAM_URL, 'URL of the new page');
    }
}
