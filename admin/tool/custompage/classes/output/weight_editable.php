...
/**
 * Page weight editable component
 *
 ...
 */
class weight_editable extends inplace_editable {
    ...
    public function __construct(page $page) {
        ...
        parent::__construct('tool_custompage', 'weight', $page->get('id'), $editable, $page->get('weight'), $page->get('weight'),
            get_string('editweight', 'tool_custompage'));

        for ($weight = -10; $weight <= 10; $weight++) {
            $weights[$weight] = $weight;
        }
        $this->set_type_select($weights);
    }
