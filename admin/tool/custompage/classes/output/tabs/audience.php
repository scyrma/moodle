...
use tool_custompage\local\helpers\audience as helper;
...
class audience extends tab {
    ...
    public function get_tab_label(): string {
        return get_string('audience', 'tool_custompage');
    }
    ...
    public function get_template(): string {
        return 'tool_custompage/local/tabs/audience';
    }
    ...
    public function export_for_template(renderer_base $output): array {
        ...
        $menucardexporter = new page_audience_cards_exporter(null, [
            'global' => $page->get('global'),
        ]);

        $instances = helper::get_audiences_for_page($page->get('id'));

        return [
            'pageid' => $page->get('id'),
            'sidebarmenucards' => $menucardexporter->export($output),
            'hasinstances' => !empty($instances),
            'instances' => $instances,
            'singletenant' => $page->get('global') && !tenancy::is_site_multi_tenant()
        ];
    }
}
