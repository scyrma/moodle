...
use tool_custompage\form\page as form;
...
class details extends tab {
    ...
    public function get_template(): string {
        return 'tool_custompage/local/tabs/details';
    }
    ...
    public function export_for_template(renderer_base $output): array {
        $detailsform = new form(null, null, 'post', '', [], true, ['id' => $this->data['pageid']]);
        $detailsform->set_data_for_dynamic_submission();

        return [
            'detailsform' => $detailsform->render(),
        ];
    }
}
