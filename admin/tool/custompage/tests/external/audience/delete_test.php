...
/**
 * Unit tests of external class for deleting audiences
 *
 * @package     tool_custompage
 * @covers      \tool_custompage\external\audience\delete
...
class delete_test extends externallib_advanced_testcase {
    ...
    public function test_execute(): void {
        ...
        $result = delete::execute($page->get('id'), $audienceid);
        $result = external_api::clean_returnvalue(delete::execute_returns(), $result);

        $this->assertTrue($result);

        // Assert audience no longer exists.
        $this->assertFalse(audience::record_exists($audienceid));
    }
    ...
    public function test_execute_access_exception(): void {
        ...
        delete::execute($page->get('id'), $audience->get_persistent()->get('id'));
    }
}
