...
/**
 * Unit tests for the name editable class
 *
 * @package     tool_custompage
 * @covers      \tool_custompage\output\name_editable
 * @copyright   2022 Moodle Pty Ltd <support@moodle.com>
 * @author      2022 Paul Holden <paulh@moodle.com>
 * @license     Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class name_editable_test extends advanced_testcase {
    ...
    public function test_update(): void {
        ...
        $editable = name_editable::update($page->get('id'), 'New name');
        ...
        $this->assertEquals('New name', $page->read()->get('name'));
    }
    ...
    public function test_update_access_exception(): void {
        ...
        name_editable::update($page->get('id'), 'New name');
    }
    ...
    public function test_update_callback(): void {
        ...
        $editable = component_callback('tool_custompage', 'inplace_editable', ['name', $page->get('id'), 'New name']);
        $this->assertInstanceOf(name_editable::class, $editable);
