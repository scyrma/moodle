...
class upgradelib_test extends advanced_testcase {
    ...
    public function test_tool_custompage_create_myteams_page(): void {
        ...
        $myteamblockname = get_string('pluginname', 'block_myteams');
        $myteampage = $DB->get_record('tool_custompage', ['name' => $myteamblockname, 'global' => 1], '*', MUST_EXIST);
        ...
        $this->assertEquals($myteamblockname, $blockinstance->get_title());
