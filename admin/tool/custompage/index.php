...
if (permission::can_create_global_page() && tenancy::is_site_multi_tenant()) {
    ...
    $icon = $OUTPUT->pix_icon('t/add', '', 'moodle', ['class' => 'mt-1']);
    $button = html_writer::tag('button', $icon . get_string('newpage', 'tool_custompage'), [
