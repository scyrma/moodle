...
class generator_test extends advanced_testcase {
    ...
    public function test_create_user() {
        ...
        // Properly trigger event we intercepted so that observer in tool_tenant clears the stack of pre-allocated users.
        \core\event\user_created::create_from_userid($drako->id)->trigger();
    }
