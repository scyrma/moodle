...
/**
 * File containing tests for user profile fields
 *
 * @package     tool_tenant
 * @category    test
...
use tool_tenant\profile_manager;


/**
 * Class users_reports_test
 */
class tool_tenant_profile_fields_testcase extends \advanced_testcase {
    ...
    public function test_configuring_profile_fields_categories() {
        ...
        // Shared space.
        tool_tenant\sharedspace::enable_shared_space();
