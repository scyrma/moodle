...
Feature: Switch between tenants
  ...
  Scenario: Switch to a different tenant using dropdown
    ...
    And ".tenantswitch .nav-link > i" "css_element" should not exist
    ...
    # Drawer toggler does not work properly after page resize, reload the page.
    And I reload the page
    Then I click on "Side panel" "button"
    And I switch to tenant "Tenant2"
    And I should see "You have switched to 'Tenant2'"
  ...
  Scenario: Switch to a different tenant using autocomplete
    ...
    And ".tenantswitch .nav-link > i" "css_element" should exist
    And I switch to tenant "Tenant3"
    Then I should see "Tenant3" in the ".navbar" "css_element"
    And I should see "You have switched to 'Tenant3'"
    And I change window size to "mobile"
