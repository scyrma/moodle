...
Feature: Testing functionality of auth_oauth2
  ...
  Scenario: Check that correct buttons are displayed on each tenant login page after using tenant availability form
    ...
    Then I click on "Tenant availability" "link" in the "Moodle OAuth2 for Tenant1" "table_row"
    ...
    And I set the visible field "Select tenants" to "Tenant1"
    And I press "Save" in the modal form dialogue
    Then I should see "Service tenant availability updated correctly"
    # Set Tenant availability for the second service.
    Then I click on "Tenant availability" "link" in the "Moodle OAuth2 for All tenants" "table_row"
    ...
    Then I click on "Tenant availability" "link" in the "Moodle OAuth2 for everybody except Tenant2" "table_row"
    ...
    And I set the visible field "Select tenants" to "Tenant2"
    And I press "Save" in the modal form dialogue
