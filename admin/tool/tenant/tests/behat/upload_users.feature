...
Feature: Allocate users to tenants in upload users
  ...
  Scenario: Upload users allocating them on tenants
    ...
    And I click on "Manage tenant 'Big company'" "link" in the "Big company" table tree node
    And I should see "Tom Jones"
    And I navigate to "Users > Organisation > Manage tenants" in site administration
    And I click on "Manage tenant 'Small company'" "link" in the "Small company" table tree node
  ...
  Scenario: Upload users to change tenant
    ...
    And I set the following system permissions of "Tenant user allocator" role:
