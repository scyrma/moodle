...
Feature: Tenants generator
  ...
  Scenario: Testing generator, create users inside tenants
    ...
    And I navigate to "Users > Organisation > Manage tenants" in site administration
    Then "2" "text" should exist in the "Default tenant" table tree node
    And "No category" "text" should exist in the "Default tenant" table tree node
    And "1" "text" should exist in the "Nike" table tree node
    And "No category" "text" should exist in the "Nike" table tree node
    And "1" "text" should exist in the "Adidas" table tree node
    And "No category" "text" should exist in the "Adidas" table tree node
    And "0" "text" should exist in the "Empty" table tree node
    And "CAT1" "text" should exist in the "Empty" table tree node
    And I click on "Nike" "link" in the "Nike" table tree node
    And I should see "User 1"
    And I should not see "User 2"
    And I should not see "User 3"
  ...
  Scenario: Testing generator, create tenant administrators inside tenants
    ...
    When I log in as "admin"
    And I navigate to "Users > Organisation > Manage tenants" in site administration
    Then "2" "text" should exist in the "Nike" table tree node
    And I click on "Nike" "link" in the "Nike" table tree node
    And I should see "User 1"
    And I should see "User 2"
