...
Feature: Manage tenants
  ...
  Scenario: View tenant details
    ...
    And "Tenantadmin 1" "text" should exist in the "[data-formclass='tool_tenant\form\add_tenant_form']" "css_element"
    And I log out
    ...
    # TODO: Uncomment when MDL-74972 is merged.
    # And "Tenantadmin 1" "text" should exist in the "[data-formclass='tool_tenant\form\add_tenant_form']" "css_element"
    And "Category1" "text" should exist in the "[data-formclass='tool_tenant\form\add_tenant_form']" "css_element"
    And I log out
