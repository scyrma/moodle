...
Feature: Manage tenants
  ...
  Scenario: Reorder tenants
    ...
    When I log in as "user1"
    And I navigate to "Users > Organisation > Manage tenants" in site administration
    And "Big company" "text" should appear before "Small company" "text"
    And "Small company" "text" should appear before "Middle company" "text"
    And I click on "Move tenant 'Middle company'" "button"
    And I follow "To the top of the list"
    And "Middle company" "text" should appear before "Big company" "text"
    And "Big company" "text" should appear before "Small company" "text"
    And I click on "Move tenant 'Big company'" "button"
    And I follow "After \" Small company \""
    And "Middle company" "text" should appear before "Small company" "text"
    And "Small company" "text" should appear before "Big company" "text"
    And I navigate to "Users > Organisation > Manage tenants" in site administration
    And "Middle company" "text" should appear before "Small company" "text"
    And "Small company" "text" should appear before "Big company" "text"
    And I log out
