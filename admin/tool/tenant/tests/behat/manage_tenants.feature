...
Feature: Manage tenants
  ...
  Scenario: Create, edit, and archive empty tenants
    ...
    And I click on "New tenant 1" "link" in the "New tenant 1" "tool_wp > Table tree node"
    ...
    And I press "Save"
    And I navigate to "Users > Organisation > Manage tenants" in site administration
    And I click on "Second tenant" "link" in the "Second tenant" "tool_wp > Table tree node"
    And I navigate to "Details" in current page administration
    And I should see "Newcat" in the "Category" "select"
    And I navigate to "Users > Organisation > Manage tenants" in site administration
    And I click on ".dropdown-toggle" "css_element" in the "New tenant 1 edited" "tool_wp > Table tree node"
  ...
  Scenario: Recover and delete empty tenants
    ...
    And I click on ".dropdown-toggle" "css_element" in the "New tenant 1" "tool_wp > Table tree node"
    And I choose "Archive" in the open action menu
    And I click on "Yes" "button"
    And I click on ".dropdown-toggle" "css_element" in the "New tenant 2" "tool_wp > Table tree node"
    And I choose "Archive" in the open action menu
    And I click on "Yes" "button"
    And I click on ".dropdown-toggle" "css_element" in the "New tenant 3" "tool_wp > Table tree node"
    And I choose "Archive" in the open action menu
    And I click on "Yes" "button"
    And I follow "Archived tenants"
    And I click on ".dropdown-toggle" "css_element" in the "New tenant 1" "tool_wp > Table tree node"
  ...
  Scenario: Rename tenant from edit page
    ...
    When I log in as "user1"
    And I navigate to "Users > Organisation > Manage tenants" in site administration
    And I click on "Middle company" "link" in the "Middle company" "tool_wp > Table tree node"
    And I navigate to "Details" in current page administration
  ...
  Scenario: Creating tenants when tenant limit is reached
    ...
    And I click on "OK" "button" in the "Tenant limit reached" "dialogue"
    And I click on ".dropdown-toggle" "css_element" in the "Tenant1" "tool_wp > Table tree node"
    And I choose "Archive" in the open action menu
    And I click on "Yes" "button"
    And I press "New tenant"
    Then I should see "You can only create 3 tenants on this site. Please note that archived tenants are also counted towards this limit"
  ...
  Scenario: View tenant details
    ...
    And the field "Tenant name" matches value "Tenant1"
    And "Tenantadmin 1" "text" should exist in the "[data-tab-content=details]" "css_element"
    And I log out
    ...
    And "Tenantadmin 1" "text" should exist in the "[data-tab-content=details]" "css_element"
    And "Category1" "text" should exist in the "[data-tab-content=details]" "css_element"
    And I log out
  ...
  Scenario: View default tenant details
    ...
    And I navigate to "Active tenants" in current page administration
    And I click on "Default tenant" "link" in the "Default tenant" "tool_wp > Table tree node"
    And I navigate to "Details" in current page administration
    ...
    And I wait until ".toast-message" "css_element" does not exist
    And I navigate to "Users > Organisation > Manage tenants" in site administration
    And I should see "Small Company" in the "Active tenants" "tool_wp > Secondary tab"
    ...
    And I navigate to "Details" in current page administration
    Then I should see "This is the default tenant, therefore its configuration will always be used by the mobile app." in the "Details" "tool_wp > Secondary tab"
    And I navigate to "All tenants" in workplace launcher
    And I navigate to "Active tenants" in current page administration
    And I click on "Big company" "link" in the "Big company" "tool_wp > Table tree node"
    And I navigate to "Details" in current page administration
    Then I should not see "This is the default tenant, therefore its configuration will always be used by the mobile app." in the "Details" "tool_wp > Secondary tab"
    And I log out

  Scenario: Archive tenant from kebab action menu
    Given the following "tool_tenant > tenants" exist:
      | name    |
      | Tenant1 |
      | Tenant2 |
    ...
    Then I should see "Archived tenants" in the "h2" "css_element"
    And I should see "Tenant1"
    And I navigate to "Active tenants" in current page administration
    And I should see "Active tenants" in the "h2" "css_element"
    And I should not see "Tenant1"
    And I log out

  Scenario: Tenant report limit is observed when creating new reports
    Given the following config values are set as admin:
      | tool_tenant_customreportslimit     | 0 |
    And the following "tool_tenant > reports" exist:
      | tenant         | name     | source                                     |
      | Default tenant | Report 1 | core_user\reportbuilder\datasource\users   |
      | Default tenant | Report 2 | core_course\reportbuilder\datasource\courses |
    When I log in as "admin"
    ...
    And the following config values are set as admin:
      | tool_tenant_customreportslimit     | 2 |
    And I reload the page
    And "New report" "button" should not exist

  Scenario: Show tenant data attribute in html element
    Given the following "tool_tenant > tenants" exist:
      | name    | idnumber   |
      | Tenant1 | t1         |
      | Tenant2 | t2         |
    When I am on homepage for tenant "Default tenant"
    Then the "data-tenantid" attribute of "html" "css_element" should contain "1"
    And I am on homepage for tenant "Tenant1"
    And the "data-tenantidnumber" attribute of "html" "css_element" should contain "t1"
    And I log in as "admin"
    And I switch to tenant "Tenant2"
    And the "data-tenantidnumber" attribute of "html" "css_element" should contain "t2"

  Scenario: Archiving a tenant will remove tenant administrator roles
    Given the following "tool_tenant > tenants" exist:
      | name    |
      | Tenant1 |
      | Tenant2 |
    And the following "tool_tenant > users" exist:
      ...
      | tenantadmin1 | User      | 1        | ta1@address.invalid | Tenant1 | 1           |
      | tenantadmin2 | User      | 2        | ta2@address.invalid | Tenant2 | 0           |
    When I log in as "admin"
    And I navigate to "Users > Organisation > Manage tenants" in site administration
    And I click on "Tenant1" "link" in the "Tenant1" "tool_wp > Table tree node"
    Then "Tenant administrator" "text" should exist in the "User 1" "table_row"
    And I navigate to "Users > Organisation > Manage tenants" in site administration
    And I click on ".dropdown-toggle" "css_element" in the "Tenant1" "tool_wp > Table tree node"
    And I choose "Archive" in the open action menu
    And I should see "Are you sure you want to archive the tenant"
    And I should see "The tenant administrators will become regular users"
    And I click on "Yes" "button"
    And I click on ".dropdown-toggle" "css_element" in the "Tenant2" "tool_wp > Table tree node"
    And I choose "Archive" in the open action menu
    And I should see "Are you sure you want to archive the tenant"
    And I should not see "The tenant administrators will become regular users"
    And I click on "Yes" "button"
    And I follow "Archived tenants"
    And I click on ".dropdown-toggle" "css_element" in the "Tenant1" "tool_wp > Table tree node"
    And I choose "Restore" in the open action menu
    ...
    And I follow "Active tenants"
    And I click on "Tenant1" "link" in the "Tenant1" "tool_wp > Table tree node"
    And "Tenant administrator" "text" should not exist in the "User 1" "table_row"
