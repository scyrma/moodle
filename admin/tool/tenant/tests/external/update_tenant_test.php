 ...
 *
 * @package    tool_tenant
 * @covers     \tool_tenant\external\update_tenant
...
class update_tenant_test extends advanced_testcase {
    ...
    public function test_update_tenant() {
        ...
        $tenantupdated = $manager->get_tenant($tenant1->id);
        $this->assertFalse($tenantupdated->get('useloginurlidnumber'));
        ...
        $this->assertTrue($tenantupdated->get('useloginurlidnumber'));
        ...
        $this->assertTrue($tenantupdated2->get('useloginurlidnumber'));
    }
}
