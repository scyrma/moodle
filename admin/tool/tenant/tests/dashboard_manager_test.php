 ...
 *
 * @package     tool_tenant
 * @covers      \tool_tenant\dashboard_manager
...
class dashboard_manager_test extends advanced_testcase {
    ...
    protected $generator;
    /** @var int */
    protected $initialblockscount = 0;
    ...
    public function test_delete_tenant_dashboard_page(): void {
        ...
        $this->assertCount($this->initialblockscount + 1, $this->get_blocks($tenantpage->id));
    ...
    public function test_unlink_tenant_dashboard() {
        ...
        $this->assertCount($this->initialblockscount, $this->get_blocks($tenantpage->id));
    }
    ...
    public function test_copy_dashboard_page(): void {
        ...
        $this->assertCount($this->initialblockscount + 2, $tenant2dashboardblocks);
        ...
        $this->assertCount($this->initialblockscount, $sitedashboardblocks);
    ...
    public function test_reset_dashboard_page_for_users(): void {
        ...
        $this->assertCount($this->initialblockscount + 1, $this->get_blocks($user1page->id));
        $this->assertTrue($DB->record_exists('my_pages', ['userid' => $user2->id, 'name' => '__default', 'private' => 1]));
        $this->assertCount($this->initialblockscount + 1, $this->get_blocks($user2page->id));
        $this->assertTrue($DB->record_exists('my_pages', ['userid' => $user3->id, 'name' => '__default', 'private' => 1]));
        $this->assertCount($this->initialblockscount + 1, $this->get_blocks($user3page->id));
    ...
    public function test_test_link_all_tenant_dashboards() {
        ...
        // Sanity check.
        $this->assertTrue($DB->record_exists('my_pages', ['userid' => $user1->id, 'name' => '__default', 'private' => 1]));
        $this->assertCount($this->initialblockscount, $this->get_blocks($user1page->id));
        $this->assertTrue($DB->record_exists('my_pages', ['userid' => $user2->id, 'name' => '__default', 'private' => 1]));
        $this->assertCount($this->initialblockscount, $this->get_blocks($user2page->id));
        $this->assertTrue($DB->record_exists('my_pages', ['userid' => $user3->id, 'name' => '__default', 'private' => 1]));
        $this->assertCount($this->initialblockscount, $this->get_blocks($user3page->id));
    ...
    public function test_link_all_tenant_dashboards_with_resetuserdashboards() {
        ...
        $this->assertCount($this->initialblockscount, $this->get_blocks($user4page->id));
