 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class tool_tenant_sharedspace_testcase extends advanced_testcase {
    ...
    /**
     * Test that tenant_menu() returns the shared tenant when the shared space is enabled
     */
    public function test_get_tenants_menu() {
        ...
        $this->assertEquals(4, preg_match_all('/class="dropdown-item"/m', $menu, $matches));
