...
function tool_tenant_upgrade_migrate_old_tenant_colours() {
    ...
    foreach ($tenants as $tenant) {
        ...
        // Previous brand colour is used as navcolour.
        if (!empty($cssconfig['brand'])) {
            $cssconfig['navcolour'] = $cssconfig['brand'];
        }
