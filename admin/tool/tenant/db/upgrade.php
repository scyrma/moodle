...
function xmldb_tool_tenant_upgrade($oldversion) {
    ...
    if ($oldversion < 2022040100) {
        // This upgrade script was added right before 4.0 release but it is "backdated" so it is executed only on
        // upgrades from 3.11 to 4.0 and skipped on upgrades from 4.0beta to 4.0.
