...
$observers = [
    [
        ...
        'priority' => 999, // Very high priority, must be executed before any other observers but after logger.
    ],
    [
    ...
    [
        ...
        'callback' => 'tool_tenant_observer::on_category_deleted'
    ],
    [
        'eventname' => '\core\event\user_info_category_deleted',
        'callback' => tool_tenant_observer::class . '::on_user_info_category_deleted'
    ]
];
