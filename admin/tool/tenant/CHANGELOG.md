...
- The following deprecated methods have been removed:
  - `tool_tenant\manager::create_tenant_quick`
  - `tool_tenant\manager::can_create_users`
  - `tool_tenant\manager::can_update_users`
  - `tool_tenant\manager::can_browse_users`
  - `tool_tenant\manager::can_delete_users`
  - `tool_tenant\manager::can_suspend_users`
  - `tool_tenant\manager::can_see_roles_tab`
  - `tool_tenant\manager::can_move_users_between_tenants`
  - `tool_tenant\manager::can_edit_tenant_themes`
  - `tool_tenant\tenancy::get_tenant_admins`

## 4.2.2 Rolling - 2023-08-22
### Added
- Two new method were added to the `tool_tenant\reportbuilder\local\callbacks` class for ensuring that custom
  report sources adhere to tenant segregation:
  - `filter_by_tenant_category`
  - `filter_by_tenant_courses`
