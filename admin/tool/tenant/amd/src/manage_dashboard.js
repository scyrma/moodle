 ...
 */
const updateDashboardlinked = (tenantId, dashboardlinked, canEditSiteDashboard) => {
 ...
 * @param {String} canEditSiteDashboard
 */
const resetTenantDashboard = (buttonElement, tenantId, canEditSiteDashboard) => {
    event.preventDefault();
 ...
 * @param {Element} buttonElement
 */
const resetLinkedDashboard = (buttonElement) => {
    event.preventDefault();
    getStrings([
        {key: 'confirmation', component: 'admin'},
        {key: 'reset', component: 'moodle'},
 ...
 * @param {Element} buttonElement
 */
const linkAllTenants = (buttonElement) => {
    event.preventDefault();
    getStrings([
        {key: 'confirmation', component: 'admin'},
        {key: 'proceed', component: 'moodle'},
...
const init = () => {
    ...
    document.addEventListener('click', (event) => {
        ...
        if (linkDashboardButton) {
            ...
            updateDashboardlinked(tenantId, DashboardStatus.linked, canEditSiteDashboard);
        }
        ...
        if (unlinkDashboardButton) {
            ...
            updateDashboardlinked(tenantId, DashboardStatus.unlinked, canEditSiteDashboard);
        }
        ...
        if (resetTenantDashboardButton) {
            ...
            resetTenantDashboard(resetTenantDashboardButton, tenantId, canEditSiteDashboard);
        }
