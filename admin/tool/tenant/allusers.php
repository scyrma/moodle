...
admin_externalpage_setup('tool_tenant_allusers');
...
$report = system_report_factory::create(users_report::class, ['showall' => 1, 'pagesize' => 30]);
$userdata = new \tool_tenant\output\users_list($report, 0);
