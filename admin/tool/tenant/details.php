...
\tool_wp\admin_externalpage::setup_page('tool_tenant_theme');
...
$tabsoutput = new \tool_tenant\output\details(
    ['isdefault' => $tenant->get('isdefault'), 'tenantid' => $tenantid, 'id' => $tenantid]);
