...
/**
 * Reset dashboard for all users in linked tenants
 *
 * @package     tool_tenant
...
/**
 * reset_all_linked_dashboards class
 *
 * @package     tool_tenant
 * @copyright   2021 Moodle Pty Ltd <support@moodle.com>
 * @author      2021 Mikel Martín <mikel@moodle.com>
 * @license     Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class reset_all_linked_dashboards extends external_api {

    /**
     * Parameters for 'tool_tenant_reset_all_linked_dashboards' WebService
     *
    ...
    public static function execute(): bool {
        ...
        $users = dashboard_manager::get_users_in_linked_tenants();
    ...
    /**
     * Return structure for 'tool_tenant_reset_all_linked_dashboards' WebService
     *
