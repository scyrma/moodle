...
/**
 * Resend Confirmation Email Web service
 *
 * @package     tool_tenant
...
/**
 * Class resend_confirmation_email
 *
 * @package     tool_tenant
 * @copyright   2020 Moodle Pty Ltd <support@moodle.com>
 * @author      2020 Hittesh Ahuja <hittesh@moodle.com>
 ...
 * @license     Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class resend_confirmation_email extends external_api {

    /**
     * Describes the parameters for resending confirmation email.
     *
    ...
    public static function execute($userids) {
        ...
        \tool_tenant\permission::can_resend_email_users(); // Loose check first for security reasons.
        ...
        foreach ($params['userids'] as $userid) {
            try {
                ...
                if ($user->confirmed > 0) {
                    ...
                    \tool_tenant\permission::require_can_resend_email_user($user);
    ...
    public static function execute_returns(): external_single_structure {
        return new \external_single_structure([
            ...
            'skippedcount' => new external_value(PARAM_INT, 'Total number of already confirmed')
