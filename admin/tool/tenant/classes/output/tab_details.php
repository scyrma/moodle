...
use tool_tenant\form\add_tenant_form;
...
class tab_details extends tab_form {
    ...
    public function is_available(): bool {
        return permission::can_view_tenant_details($this->data['id']);
    }

    /**
     * Check permission of the current user to edit tenant details
     *
     * @return bool
     */
    protected function can_edit(): bool {
        $id = $this->data['id'] ?? 0;
        return permission::can_view_tenant_details($id) && permission::can_edit_tenant_details($id);
    }
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        $data['tabheading'] = get_string('tenantdetails', 'tool_tenant');
        return $data;
    }
}
