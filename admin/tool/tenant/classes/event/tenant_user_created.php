 ...
 *
 * This event can only be triggered when user is created and used in logging only. It is not necessary to observe this event,
 * listen instead to user_created and tenant_user_updated events.
 *
 * @package    tool_tenant
 * @copyright  2018 Moodle Pty Ltd <support@moodle.com>
 * @author     2018 Marina Glancy
...
class tenant_user_created extends base {
    ...
    public function get_description() {
        return "User with id '$this->relateduserid' was allocated " .
