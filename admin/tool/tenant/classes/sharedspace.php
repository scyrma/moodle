...
class sharedspace {
    ...
    /**
     * Get id of the tenant representing shared space, or null if shared space is not enabled. Please note, however that this
     * method does not distinguish between not enabled (NULL) vs. explicitly disabled (0).
     *
     * @return int|null
     */
    ...
    public static function show_shared_space_in_switch_operations(): bool {
        ...
        return $sharedid === false || ($sharedid > 0);
    }
}
