...
class tenant extends \core\persistent implements \cacheable_object {
    ...
    /**
     * Default tenant label for display.
     *
     * @return string Default label is returned if isdefault => true or blank.
     */
    public function get_default_tenant_label(): string {
        return $this->get('isdefault') ? \html_writer::span(get_string('defaultname', 'tool_tenant'), 'label',
