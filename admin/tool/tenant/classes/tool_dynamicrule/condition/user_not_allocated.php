...
class user_not_allocated extends condition_base {
    ...
    public function get_title(): string {
        return get_string('usersnotallocatedtotenant', 'tool_tenant');
    }
    ...
    public function get_sql(): array {
        $tenantuserselect = tenancy::get_users_subquery(false, false, "u.id", $this->get_tenantid());
        return ['', "NOT ({$tenantuserselect})", []];
    }
    ...
    public function get_description(): string {
        ...
        return get_string('conditionusernotallocateddescription', 'tool_tenant', $fullname);
    }
}
