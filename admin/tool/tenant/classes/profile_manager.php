...
class profile_manager {
     ...
     *
     * @param int|null $id category id, if not specified the default object will be returned
     ...
     * @param \stdClass|null $cfg if specified, use instead of $CFG (for config hook only)
     * @return array
     */
    ...
    public static function calculate_config_for_tenant(array &$config) {
        if (!array_key_exists('showuseridentity', $config)) {
            return;
        }
