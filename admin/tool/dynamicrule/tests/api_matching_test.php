...
class tool_dynamicrule_api_matching_testcase extends advanced_testcase {
    ...
    /**
     * Test 1.
     * Count of users should return 2 for the first rule and 1 for the second rule
     * Number of matches users - should show user11&user12 for the first rule and user23 for the second rule
     */
     ...
     * and user23 for the second rule.
     */
     ...
     * Test 3.
     * Process rules.
     * Getting matches for outcome should return empty array for both rules.
     */
     ...
     * Getting matches for outcome should show user14 for the first rule and empty
     * array for the second rule.
     */
     ...
     * Getting matches for outcome should show empty array for the first rule and empty array for the second rule
     */
     ...
     * Getting matches for outcome should show user12 for the first rule and empty array for the second rule
     */
