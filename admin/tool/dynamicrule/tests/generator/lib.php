...
class tool_dynamicrule_generator extends component_generator_base {
    ...
    public function create_condition_alwaystrue(int $ruleid): condition_base {
        ...
        return \tool_dynamicrule\api::create_rule_condition($ruleid, $class, ['always' => true]);
    }
    ...
    public function create_condition_alwaysfalse(int $ruleid): condition_base {
        ...
        return \tool_dynamicrule\api::create_rule_condition($ruleid, $class, ['always' => false]);
    }
     ...
     * @return outcome_base
     */
    public function create_outcome_donothing(int $ruleid) {
        ...
        return \tool_dynamicrule\api::create_rule_outcome($ruleid, $class, ['do' => 0]);
    }
