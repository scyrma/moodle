...
class tool_dynamicrule_outcome_notification_testcase extends advanced_testcase {
    ...
    public function test_apply_to_users() {
        ...
        $configdata = ['subject' => 'You matched!', 'body' => "Congratulations {{userfullname}},\n" .
            "you completed the course {{coursefullname}}"];
        ...
        $this->assertEquals(2, count($savedmessages));

        $this->assertEquals('Congratulations ' . fullname($userids[0]). ",\nyou completed the course " . $course1->fullname,
            $savedmessages[0]->fullmessagehtml);
        $this->assertEquals('Congratulations ' . fullname($userids[1]). ",\nyou completed the course " . $course1->fullname,
            $savedmessages[1]->fullmessagehtml);
    ...
    public function test_get_description() {
        ...
        $subject = 'You matched!';
        $configdata = ['subject' => $subject, 'body' => 'Congratulations, you matched the condition'];
        $outcome = \tool_dynamicrule\tool_dynamicrule\outcome\notification::create($rule0->id, $configdata);
    ...
    public function test_after_update() {
        ...
        $configdata = ['subject' => $subject, 'body' => 'Test body updated'];
