...
class tool_dynamicrule_condition_user_profile_field_testcase extends advanced_testcase {
    ...
    public function test_text_field_condition() {
        ...
        $categoryid = $this->add_profile_category();
        $fieldid = $this->add_profile_field_text($categoryid, $fieldshortname, $this->visibility);
    ...
    public function test_user_can_edit(): void {
        ...
        $this->add_profile_field_text($categoryid, $fieldshortname, PROFILE_VISIBLE_ALL);
        ...
        $this->add_profile_field_text($categoryid, $fieldshortname, PROFILE_VISIBLE_PRIVATE);
        ...
        $this->add_profile_field_text($categoryid, $fieldshortname, PROFILE_VISIBLE_NONE);
     ...
     */
    private function add_profile_field_text(int $categoryid, string $shortname, int $visible) {
        global $DB;
        ...
        return $DB->insert_record('user_info_field', $params);
    }
}
