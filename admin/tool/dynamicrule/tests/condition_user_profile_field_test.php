...
class tool_dynamicrule_condition_user_profile_field_testcase extends advanced_testcase {
    ...
    public function test_get_description() {
        ...
        $configdata = ['userprofilefield' => 'invalidfield', 'userprofilefieldvalue' => 'nanana'];
        $condition5 = \tool_dynamicrule\tool_dynamicrule\condition\user_profile_field::create($rule5->id, $configdata);
        ...
        $configdata = [];
        $condition6 = \tool_dynamicrule\tool_dynamicrule\condition\user_profile_field::create($rule6->id, $configdata);
        $this->assertEquals(get_string('conditionisbroken', 'tool_dynamicrule'), $condition6->get_description());

        $rule7 = $this->get_generator()->create_rule();
        $configdata = ['userprofilefield' => 0];
        $condition7 = \tool_dynamicrule\tool_dynamicrule\condition\user_profile_field::create($rule6->id, $configdata);
        $this->assertEquals(get_string('conditionisbroken', 'tool_dynamicrule'), $condition6->get_description());
    }
    ...
    public function test_trigger_rule_processing() {
        ...
        $configdata = ['subject' => 'User updated', 'body' => 'Congratulations, you updated your profile.'];
