...
class certificate_test extends \advanced_testcase {
    ...
    public function test_apply_to_user_with_program_completed_condition(): void {
        ...
        // Create program+course (with self-completion enabled) and user.
         [$tenant, [$user1]] = $this->get_tenant_generator()->create_tenant_and_users(1);
     ...
     *
     * @uses \tool_dynamicrule\tool_dynamicrule\outcome\certificate::get_description
     * @uses \tool_dynamicrule\tool_dynamicrule\outcome\certificate::get_uneditable_description
     */
    public function test_get_displayed_description() {
        ...
        // Grant priveleges to user ('tool/certificate:viewallcertificates').
        $roleid = create_role('Dummy role', 'dummyrole', 'dummy role description');
        $context = \context_system::instance();
        assign_capability('tool/certificate:viewallcertificates', CAP_ALLOW, $roleid, $context->id);
