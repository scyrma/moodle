...
class cohort_remove_test extends \advanced_testcase {
    ...
    public function test_apply_to_user_in_shared_tenant(): void {
        ...
        $cohort1 = self::getDataGenerator()->create_cohort();
        [$tenant, [$user1, $user2, $user3]] = $this->get_tenant_generator()->create_tenant_and_users(3);
        [$tenant2, [$user21, $user22, $user23]] = $this->get_tenant_generator()->create_tenant_and_users(3);
