...
class learning_plan_remove_test extends \advanced_testcase {
    ...
    public function test_apply_to_user_in_other_tenant(): void {
        ...
        $this->lpg->create_plan(['userid' => $userintenant0->id, 'templateid' => $lptemplate->get('id')]);
        $this->lpg->create_plan(['userid' => $userintenant1->id, 'templateid' => $lptemplate->get('id')]);
    ...
    public function test_apply_to_user_in_shared_tenant(): void {
        ...
        // Assign users in both tenants to the plan.
        $this->lpg->create_plan(['userid' => $userintenant1->id, 'templateid' => $lptemplate->get('id')]);
        $this->lpg->create_plan(['userid' => $userintenant2->id, 'templateid' => $lptemplate->get('id')]);
