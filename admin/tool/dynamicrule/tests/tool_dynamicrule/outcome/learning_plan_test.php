 ...
 */
class learning_plan_test extends \advanced_testcase {
    ...
    public function test_is_configuration_valid(): void {
        ...
        $template = $this->lpg->create_template();

        /** @var learning_plan $outcome */
        $outcome = learning_plan::create($rule->id, ['learningplan' => $template->get('id')]);
    ...
    public function test_is_available(): void {
        ...
        $this->assertFalse(learning_plan::is_available());

        $this->lpg->create_template();

        $this->assertTrue(learning_plan::is_available());
    }
    ...
    public function test_apply_to_user(): void {
        ...
        $this->lpg->create_plan(['userid' => $userwithlp, 'templateid' => $lptemplate->get('id')]);
