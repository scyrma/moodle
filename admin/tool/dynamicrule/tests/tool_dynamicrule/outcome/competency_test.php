...
class competency_test extends \advanced_testcase {
    ...
    public function test_apply_to_user() {
        ...
        $c1 = $this->lpg->create_competency(['competencyframeworkid' => $f1->get('id')]);
     ...
     *
     * @uses \tool_dynamicrule\tool_dynamicrule\outcome\competency::get_description
     * @uses \tool_dynamicrule\tool_dynamicrule\outcome\competency::get_uneditable_description
     */
    public function test_get_displayed_description() {
        ...
        $f1 = $this->lpg->create_framework();
        $c1 = $this->lpg->create_competency(['competencyframeworkid' => $f1->get('id'), 'shortname' => $shortname]);
        ...
        // Revoke permission to view competency.
        $roleid = $DB->get_field('role', 'id', ['shortname' => 'user']);
        role_change_permission($roleid, $c1->get_context(), 'moodle/competency:competencyview', CAP_PROHIBIT);
