...
class badge_test extends \advanced_testcase {
    ...
    public function test_apply_to_user() {
        ...
        $this->assertEqualsCanonicalizing($userids, array_column($DB->get_records('badge_manual_award'), 'recipientid'));
    }
    ...
    public function test_apply_to_user_in_shared_tenant() {
        ...
        $tenantusers = [$user1->id, $user2->id, $user21->id, $user22->id, get_admin()->id];
        $this->assertEqualsCanonicalizing($tenantusers, array_column($DB->get_records('badge_issued'), 'userid'));
        $this->assertEqualsCanonicalizing($tenantusers, array_column($DB->get_records('badge_manual_award'), 'recipientid'));
    }
    ...
    public function test_get_displayed_description() {
        ...
        // Admin user.
        $str = get_string('outcomebadgedescription', 'tool_dynamicrule', 'Test badge');
    ...
    public function test_field_mapping(): void {
        ...
        $newbadgeid = $this->create_badge()->id;
