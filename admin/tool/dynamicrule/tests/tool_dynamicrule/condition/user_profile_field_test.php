...
class user_profile_field_test extends \advanced_testcase {
    ...
    public function test_is_configuration_valid(): void {
        ...
        $configdata = [];
        /** @var user_profile_field $condition */
        $condition = user_profile_field::create($rule->id, $configdata);
        $this->assertFalse($condition->is_configuration_valid());
     ...
     * @return array
     */
    public static function provider_get_matching_users(): array {
        return [
     ...
     * @return array
     */
    public static function provider_text_field_condition(): array {
        return [
     ...
     * @return array
     */
    public static function provider_date_field_condition(): array {
        return [
     ...
     * @return array
     */
    public static function get_start_and_end_timestamp_for_variable_date_provider() : array {
        return [
