...
class process_rules_test extends advanced_testcase {
     ...
     *
     * @uses \tool_dynamicrule\tool_dynamicrule\outcome\learning_plan
     * @uses \tool_dynamicrule\tool_dynamicrule\condition\cohort_member
     */
    public function test_process_rules_task_with_scheduled_task_outcome(): void {
        ...
        $configdata = ['cohortid' => $cohort0->id];
        \tool_dynamicrule\tool_dynamicrule\condition\cohort_member::create($rule0->id, $configdata);
        $lptemplate = $this->get_competency_generator()->create_template();
        $configdata = ['learningplan' => $lptemplate->get('id')];
        \tool_dynamicrule\tool_dynamicrule\outcome\learning_plan::create($rule0->id, $configdata);
        ...
        $this->assertEqualsCanonicalizing([$user0->id], $DB->get_fieldset_select('competency_plan', 'userid', ''));
    }
