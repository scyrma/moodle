...
class tool_dynamicrule_api_testcase extends advanced_testcase {
    ...
    public function test_process_rule_chunks() {
        ...
        // Expect 2 more users (admin and username1).
        $this->assertEquals($aboveinlimit + 2, \tool_dynamicrule\api::count_matching_users($rule->id));
        $this->assertCount($aboveinlimit + 2, \tool_dynamicrule\api::get_matching_users($rule->id));
        $this->assertCount($aboveinlimit + 2, $this->get_generator()->get_matching_users_for_outcomes($rule->id));
        ...
        $this->assertEquals($aboveinlimit + 2, $DB->count_records('tool_dynamicrule_match'));
    }
