...
use tool_dynamicrule\tool_dynamicrule\outcome\learning_plan;
...
class observer_test extends advanced_testcase {
    ...
    /** @var core_competency_generator */
    protected $competencygenerator;
    ...
    public function setUp(): void {
        ...
        $this->competencygenerator = self::getDataGenerator()->get_plugin_generator('core_competency');
        $this->resetAfterTest();
    }
    ...
    public function test_event_does_not_trigger_scheduled_task_outcome_rule(): void {
        ...
        $configdata =
            ['userprofilefield' => 'city', 'city_value' => 'Tarragona', 'city_op' => user_profile_field::TEXT_CONTAINS];
        user_profile_field::create($rule0->id, $configdata);
        $lptemplate = $this->competencygenerator->create_template();
