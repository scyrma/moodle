...
class tool_dynamicrule_condition_course_completed_testcase extends advanced_testcase {
    ...
    public function test_trigger_rule_processing() {
        ...
        $configdata = ['subject' => 'Course0 completed', 'body' => 'Congratulations, you have completed course0.'];
        ...
        $this->assertEquals($messages[0]->subject, 'Course0 completed');
        $sink->clear();
    ...
    public function test_get_description() {
        ...
        $condition3 = \tool_dynamicrule\tool_dynamicrule\condition\course_completed::create($rule3->id, $configdata);
        $this->assertEquals(get_string('conditionisbroken', 'tool_dynamicrule'), $condition3->get_description());
    }
