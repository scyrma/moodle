...
use tool_dynamicrule\tool_dynamicrule\condition\course_not_completed;
 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class condition_course_not_completed_testcase extends \advanced_testcase {
    ...
    public function test_validate_config_form() {
        ...
        $configform = ['courseid' => $course0->id, 'operator' => 'after'];
        ...
        $configform = ['courseid' => $course1->id, 'operator' => 'after'];
