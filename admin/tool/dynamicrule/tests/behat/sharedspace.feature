...
Feature: Shared space in tool_dynamicrule
  ...
  Scenario: Add a rule with conditions and actions in shared space
    ...
    Then I click on "Rule1" "link" in the "Rule1" "table_row"
    And I click on "Enable" "button"
    And I click on "Enable" "button" in the "Confirm" "dialogue"
    And I run all adhoc tasks
    And I navigate to "Dynamic rules" in workplace launcher
    And I click on "Rule1" "link" in the "Rule1" "table_row"
  ...
  Scenario: Validate shared rule actions at different tenants
    ...
    And I should not see "Rule2" in the "reportbuilder-table" "table"
    And "Cannot enable rule 'RuleS' unless it has conditions, actions and doesn't contain any errors" "field" should be visible
    And I should not see "Shared space" in the "RuleS" "table_row"
    And "Archive" "link" should exist in the "RuleS" "table_row"
    And "Duplicate" "link" should exist in the "RuleS" "table_row"
    And "View report" "link" should exist in the "RuleS" "table_row"
    And I switch to tenant "Tenant1"
    And I navigate to "Dynamic rules" in workplace launcher
    And I should see "Rule1" in the "reportbuilder-table" "table"
    And I should not see "Rule2" in the "reportbuilder-table" "table"
    And I should see "Shared space" in the "RuleS" "table_row"
    And "Shared rule 'RuleS' can only be enabled from the shared space." "field" should be visible
    And "Archive" "link" should not exist in the "RuleS" "table_row"
    And "Duplicate" "link" should exist in the "RuleS" "table_row"
    And "View report" "link" should exist in the "RuleS" "table_row"
    And I switch to tenant "Tenant2"
    And I navigate to "Dynamic rules" in workplace launcher
    And I should not see "Rule1" in the "reportbuilder-table" "table"
    And I should see "Rule2" in the "reportbuilder-table" "table"
    And I should see "Shared space" in the "RuleS" "table_row"
    And "Shared rule 'RuleS' can only be enabled from the shared space." "field" should be visible
    And "Archive" "link" should not exist in the "RuleS" "table_row"
    And "Duplicate" "link" should exist in the "RuleS" "table_row"
  ...
  Scenario: Check matched report for the shared rule
    ...
    And I press "Save changes"
    Then I navigate to "Dynamic rules" in workplace launcher
    And I press "View report" action in the "RuleS" report row
    ...
    And "Shared rule 'RuleS' can only be disabled from the shared space." "field" should be visible
    And I press "View report" action in the "RuleS" report row
    And I should see "user11@invalid.com"
    And I should see "user12@invalid.com"
    And I should see "user13@invalid.com"
  ...
  Scenario: Duplicate shared rule
    ...
    And "Shared rule 'RuleS' can only be enabled from the shared space." "field" should be visible
    And I should see "Shared space" in the "RuleS" "table_row"
    And I press "Duplicate" action in the "RuleS" report row
    And I click on "Duplicate" "button" in the "Confirm" "dialogue"
  ...
  Scenario: Duplicate shared rule with non-applicable conditions.
    Given I log in as "admin"
    When I switch to tenant "Shared space"
    And I navigate to "Dynamic rules" in workplace launcher
    And I follow "New rule"
    ...
    And I set the following fields to these values:
      ...
      | firstname_value | User |
    And I press "Save changes"
    And I follow "Users allocated to tenant"
    And I set the field "Select tenant" to "Tenant1"
    And I press "Save changes"
    And I navigate to "Actions" in current page administration
    Then I should see "Add actions to this rule"
    And I click on "Notification" "link" in the "#ruleoutcomes" "css_element"
    ...
    And I should see "Shared space" in the "RuleS" "table_row"
    And I press "Duplicate" action in the "RuleS" report row
    And I should see "The rule contains entities that can't be used in non-shared rule and will be omitted" in the "Confirm" "dialogue"
    And I should see "Users allocated to tenant" in the "Confirm" "dialogue"
    And I click on "Duplicate" "button" in the "Confirm" "dialogue"
    # Sort by rule created date ascending, to ensure the partial matching that follows works.
    And I click on "Created" "link" in the "reportbuilder-table" "table"
    And I should see "Shared space" in the "RuleS" "table_row"
    And I should see "Users allocated to tenant 'Tenant1'" in the "RuleS" "table_row"
    And I should not see "Shared space" in the "RuleS Copy 1" "table_row"
    And I should not see "Users allocated to tenant 'Tenant1'" in the "RuleS Copy 1" "table_row"

  Scenario: Duplicate shared rule in shared space.
    Given I log in as "admin"
    When I switch to tenant "Shared space"
    And I navigate to "Dynamic rules" in workplace launcher
    And I follow "New rule"
    ...
    And I should not see "Shared space" in the "RuleS" "table_row"
    And I press "Duplicate" action in the "RuleS" report row
    And I should not see "The rule contains entities that can't be used in non-shared rule and will be omitted" in the "Confirm" "dialogue"
    And I should not see "Users allocated to tenant" in the "Confirm" "dialogue"
    And I click on "Duplicate" "button" in the "Confirm" "dialogue"
    # Sort by rule created date ascending, to ensure the partial matching that follows works.
    And I click on "Created" "link" in the "reportbuilder-table" "table"
    And I should see "Users allocated to tenant 'Tenant1'" in the "RuleS" "table_row"
    And I should see "Users allocated to tenant 'Tenant1'" in the "RuleS Copy 1" "table_row"
