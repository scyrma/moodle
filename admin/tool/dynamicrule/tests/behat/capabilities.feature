...
Feature: Check dynamic rules capabilities
  ...
  Scenario: Check if tenant admin can edit rules
    ...
    And "Duplicate" "link" should exist in the "Rule1" "table_row"
    ...
    When I press "Unarchive" action in the "Rule1" report row
    And I should not see "Rule1"
    ...
    And "View report" "link" should exist in the "Rule1" "table_row"
    And "View report" "link" should not exist in the "Rule2" "table_row"
  ...
  Scenario: Check if tenant admin can restore or delete previously archived rules
    ...
    Then I press "Archive" action in the "Rule1" report row
    And I should see "Are you sure you want to archive" in the "Confirm" "dialogue"
    And I click on "Archive" "button" in the "Confirm" "dialogue"
    And I should not see "Rule1"
    Then I press "Archive" action in the "Rule2" report row
    And I should see "Are you sure you want to archive" in the "Confirm" "dialogue"
    And I click on "Archive" "button" in the "Confirm" "dialogue"
    ...
    Then I press "Unarchive" action in the "Rule1" report row
    And I should not see "Rule1"
    And "Unarchive" "link" should not exist in the "Rule2" "table_row"
    And "Delete" "link" should not exist in the "Rule2" "table_row"
  ...
  Scenario: Check capabilities for entity if entity was deleted
    ...
    And "Archive" "link" should exist in the "Rule1" "table_row"
    And "Duplicate" "link" should exist in the "Rule1" "table_row"
    And "Archive" "link" should exist in the "Rule2" "table_row"
    And "Duplicate" "link" should exist in the "Rule2" "table_row"
  ...
  Scenario: Check capabilities with user profile fields
    ...
    And "View report" "link" should not exist in the "Rule1" "table_row"
    And "Archive" "link" should not exist in the "Rule2" "table_row"
    And "View report" "link" should not exist in the "Rule2" "table_row"
    And I log out
  ...
  Scenario: Check capabilities with outcome
    ...
    And "View report" "link" should exist in the "Rule1" "table_row"
    And "Archive" "link" should not exist in the "Rule2" "table_row"
    And "View report" "link" should exist in the "Rule2" "table_row"
    And I log out
