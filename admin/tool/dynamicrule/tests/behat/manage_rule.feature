...
Feature: Creating and editing rules
  ...
  Scenario: Add a rule with conditions and actions
    ...
    And "Cannot enable rule 'Rule1' unless it has conditions, actions and doesn't contain any errors" "field" should be visible
  ...
  Scenario: Edit rule name inline
    ...
    And the following should not exist in the "reportbuilder-table" table:
      | Name  |
      | Rule1 |
#    And I should see "New rule1" in the ".reportbuilder-table > .c1" "css_element"
#    And I should not see "Rule1" in the ".reportbuilder-table" "table"
  ...
  Scenario: Validate actions presence depending on tabs
    ...
    And I should not see "Rule1"
    And "Enable rule 'Rule2'" "field" should not exist in the "Rule2" "table_row"
    And "Disable rule 'Rule2'" "field" should not exist in the "Rule2" "table_row"
  ...
  Scenario: Enabling and disabling rules
    ...
    When I log in as "tenantadmin1"
    And I navigate to "Dynamic rules" in workplace launcher
    Then "Cannot enable rule 'Rule1' unless it has conditions, actions and doesn't contain any errors" "field" should be visible
    And "Cannot enable rule 'Rule2' unless it has conditions, actions and doesn't contain any errors" "field" should be visible
    And "Enable rule" "field" in the "Rule1" "table_row" should not be visible
    And "Enable rule" "field" in the "Rule2" "table_row" should not be visible
    And "Disable rule" "field" in the "Rule1" "table_row" should not be visible
    And "Disable rule" "field" in the "Rule2" "table_row" should not be visible
    And the "Cannot enable rule 'Rule1' unless it has conditions, actions and doesn't contain any errors" "checkbox" should be disabled
    And the "Cannot enable rule 'Rule2' unless it has conditions, actions and doesn't contain any errors" "checkbox" should be disabled
    ...
    And I press "Save changes"
    And I navigate to "Dynamic rules" in workplace launcher
    Then "Cannot enable rule 'Rule1' unless it has conditions, actions and doesn't contain any errors" "field" should not be visible
    And "Cannot enable rule 'Rule2' unless it has conditions, actions and doesn't contain any errors" "field" should be visible
    And "Enable rule" "field" in the "Rule1" "table_row" should be visible
    And "Enable rule" "field" in the "Rule2" "table_row" should not be visible
    And "Disable rule" "field" in the "Rule1" "table_row" should not be visible
    And "Disable rule" "field" in the "Rule2" "table_row" should not be visible
    And the "Cannot enable rule 'Rule2' unless it has conditions, actions and doesn't contain any errors" "checkbox" should be disabled
    And I click on "Enable rule" "field" in the "Rule1" "table_row"
    ...
    Then "Cannot enable rule 'Rule1' unless it has conditions, actions and doesn't contain any errors" "field" should not be visible
    And "Cannot enable rule 'Rule2' unless it has conditions, actions and doesn't contain any errors" "field" should be visible
    And "Enable rule 'Rule1'" "field" should not be visible
    And "Enable rule 'Rule2'" "field" should not be visible
    And "Disable rule" "field" in the "Rule1" "table_row" should be visible
    And "Disable rule" "field" in the "Rule2" "table_row" should not be visible
    And the "Cannot enable rule 'Rule2' unless it has conditions, actions and doesn't contain any errors" "checkbox" should be disabled
    ...
    When I navigate to "Dynamic rules" in site administration
    And I click on "Disable rule" "field" in the "Rule1" "table_row"
    And "Enable rule" "field" in the "Rule1" "table_row" should be visible
    And I click on "Enable rule" "field" in the "Rule1" "table_row"
    And "Enable rule" "field" in the "Rule1" "table_row" should not be visible
    And "Disable rule" "field" in the "Rule1" "table_row" should be visible
  ...
  Scenario: Rule reflects scheduled task status for conditions
    Given the following dynamic rules exist:
      | name  | tenant  |
      | Rule1 | Tenant1 |
    When I log in as "tenantadmin1"
    ...
    And I press "Save changes"
    And I navigate to "Dynamic rules" in workplace launcher
    Then I should not see "Scheduled task" in the "Rule1" "table_row"
    And I click on "a[data-action='editcontent']" "css_element" in the "Rule1" "table_row"
    And I follow "Time since user was created"
    And I press "Save changes"
    And I navigate to "Dynamic rules" in workplace launcher
    And I should see "Scheduled task" in the "Rule1" "table_row"

  Scenario: Rule reflects scheduled task status for outcomes
    Given the following dynamic rules exist:
      | name  | tenant  |
      | Rule1 | Default tenant |
    ...
    And I click on "a[data-action='editcontent']" "css_element" in the "Rule1" "table_row"
    And I navigate to "Actions" in current page administration
    And I follow "Assign learning plan"
    And I set the field "Select learning plan" to "Science template"
    And I press "Save changes"
    And I navigate to "Dynamic rules" in workplace launcher
    And I should see "Scheduled task" in the "Rule1" "table_row"
  ...
  Scenario: Show enabled/disabled dynamic rules to tenant admin, whom he has no right to enable/disable and edit.
    ...
    And I should see "Enrol users into a course (details not available)" in the "Rule1" "table_row"
    And "You don't have sufficient rights to disable this rule 'Rule1'" "field" should be visible
    ...
    And I should see "Enrol users into a course (details not available)" in the "Rule2" "table_row"
    And "Cannot enable rule 'Rule2' unless it has conditions, actions and doesn't contain any errors" "field" should be visible
    And "Edit details" "link" should not exist in the "Rule2" "table_row"
    And "Archive" "link" should not exist in the "Rule2" "table_row"
    And "Duplicate" "link" should not exist in the "Rule2" "table_row"
    # See active DR rule3 and Can edit and disable the rule
    And I should see "Send notification 'Test notification' to users"
    And "Disable rule" "field" in the "Rule3" "table_row" should be visible
