...
Feature: Creating and editing rules
  ...
  Scenario: Rules list filters
    ...
    And I should see "Rule2"
    And I press "Reset table"
    And I set the field "rule:conditions_op" to "contains"
    And I set the field "rule:conditions" to "User last login"
    And I should see "Rule1"
    And I should not see "Rule2"
    And I press "Reset table"
    And I set the field "rule:actions_op" to "contains"
  ...
  Scenario: Show matching users based on include suspended flag
    ...
    And the "class" attribute of "Suspended User" "table_row" should contain "dimmed_text"
    And I click on "Cancel" "button" in the "View matching users" "dialogue"
    And I navigate to "Dynamic rules" in workplace launcher
    And I click on "Edit details of rule 'Rulesuspended'" "link"
    # Uncheck Include suspended users.
    And I click on "includesuspendedusers" "checkbox"
    And I press "Save"
    And I click on "Edit rule 'Rulesuspended'" "link"
    Then I should see "3 total matches"
    And I follow "View matching users"
  ...
  Scenario: Show matched users report based on include suspended flag
    ...
    And I run all adhoc tasks
    And I navigate to "Dynamic rules" in workplace launcher
    Then I follow "View report for 'Rulesuspended'"
    And I should see "Suspended User" in the "report-table" "table"
    And the "class" attribute of "Suspended User" "table_row" should contain "dimmed_text"
    And I navigate to "Dynamic rules" in workplace launcher
    And I click on "Edit details of rule 'Rulesuspended'" "link"
    # Uncheck Include suspended users.
    And I click on "includesuspendedusers" "checkbox"
    And I press "Save"
    And I follow "View report for 'Rulesuspended'"
    Then I should see "Suspended User" in the "report-table" "table"
