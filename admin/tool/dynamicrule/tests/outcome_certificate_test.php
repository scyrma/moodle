...
use tool_dynamicrule\tool_dynamicrule\outcome\certificate;
 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class outcome_certificate_testcase extends advanced_testcase {
    ...
    public function test_apply_to_users() {
        ...
        $this->assertEquals(3, $DB->count_records('tool_certificate_issues'));
    }
