...
class tool_dynamicrule_condition_cohort_member_testcase extends advanced_testcase {
    ...
    public function test_trigger_rule_processing() {
        ...
        $configdata = ['subject' => 'Added to cohort0', 'body' => 'Congratulations, you have been added to cohort0.'];
    ...
    public function test_get_description() {
        ...
        $rule3 = $this->get_generator()->create_rule();
        $configdata = ['cohortid' => 9999];
        $condition3 = \tool_dynamicrule\tool_dynamicrule\condition\cohort_member::create($rule3->id, $configdata);
