...
class rules extends system_report {
    ...
    public function initialise(): void {
        ...
        $this->add_column((new column(
            ...
            ->add_attributes(['data-region' => 'wp-toggle']) // TODO: replace with core/toggle.
    ...
    public function get_enabled($value, \stdClass $row, $additionalarguments) {
        ...
        if (permission::can_enable_rule($rule)) {
            ...
            return $OUTPUT->render_from_template('core/action_menu_link', $link->export_for_template($PAGE->get_renderer('core')));
        }
    }
