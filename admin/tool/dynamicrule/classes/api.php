...
class api {
     ...
     *
     * The badge should be shown if at least one condition in the rule has "scheduled task" badge
     * (which usually means it does not listen to ANY events).
     *
    ...
    /**
     * Returns a list of enabled rules that are not scheduled tasks that contain the given conditions
     *
     * @param string $conditionclass
