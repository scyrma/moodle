...
class api {
    ...
    public static function get_matching_users(int $ruleid, int $targetuserid = null, int $currenttime = null): array {
        ...
        self::update_unmatched_users($ruleid, $users, $currenttime, $targetuserid);
    ...
    public static function process_rules() {
        ...
        $rules = rule::get_records(['enabled' => 1, 'archived' => 0, 'broken' => 0], 'name');
     ...
     */
    public static function get_rule_restriction_sql(int $ruleid, int $currenttime = null): array {
    ...
    public static function is_rule_configuration_valid(rule $rule): bool {
        ...
        $conditionsvalid = self::is_conditions_configuration_valid($rule);
        $outcomesvalid = self::is_outcomes_configuration_valid($rule);
