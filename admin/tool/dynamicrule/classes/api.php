...
class api {
    ...
    protected static function check_condition_sql(condition_sql $condition, string $join, string $where, array $params) {
        debugging('Function \tool_dynamicrule\api::check_condition_sql() is deprecated. '.
    ...
    public static function generate_alias() {
        debugging('Function \tool_dynamicrule\api::generate_alias() is deprecated. '.
    ...
    public static function generate_param_name() {
        debugging('Function \tool_dynamicrule\api::generate_param_name() is deprecated. '.
