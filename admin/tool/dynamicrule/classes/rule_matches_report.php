...
class rule_matches_report extends system_report {
    ...
    protected function set_columns() {
        ...
        $additionaluserfields = \core_user\fields::for_identity($context, false)->get_required_fields();
    ...
    protected function set_filters() {
        ...
        $additionaluserfields = \core_user\fields::for_identity(\context_system::instance(), false)->get_required_fields();
