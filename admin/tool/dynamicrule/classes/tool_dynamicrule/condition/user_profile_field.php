...
class user_profile_field extends \tool_dynamicrule\condition_sql {
    ...
    public function get_sql(): array {
        ...
        if (in_array($field, self::$defaultfields)) {
            ...
            // TODO: WP-2728 Notice that custom field "not" matches are not including all users,
            // but only those with custom fields defined in profile, this needs to be fixed.
