...
class user_created extends \tool_dynamicrule\condition_sql {
    ...
    public function get_config_form(\MoodleQuickForm $mform) {
        ...
        $mform->addHelpButton('usercreateformgroup', 'usercreatetype', 'tool_dynamicrule');
    }
    ...
    public function get_description(): string {
        $str = '';
        $date = \tool_certification\api::translate_relativedate_string($this->get_configdata()['usercreaterelative']);
        switch ($this->get_usercreatetype()) {
            case self::CREATE_TYPE_INLAST:
