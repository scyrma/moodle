...
class permission {
    ...
    /**
     * User can create dynamic rule
     *
     * @return bool
     */
    public static function can_create_rule(): bool {
     ...
     * @return bool
     */
    public static function can_duplicate_rule(rule $rule): bool {
        return !$rule->get('component') && self::can_edit_rule($rule);
    }
