...
class permission {
     ...
     * @return bool
     */
    public static function can_delete_condition(condition_base $condition): bool {
     ...
     * @return bool
     */
    public static function can_edit_condition(condition_base $condition, array $configdata = []): bool {
        if (empty($configdata)) {
     ...
     * @return bool
     */
    public static function can_delete_outcome(outcome_base $outcome): bool {
     ...
     * @return bool
     */
    public static function can_edit_outcome(outcome_base $outcome, array $configdata = []): bool {
        if (empty($configdata)) {
    ...
    public static function can_edit_rule(rule $rule): bool {
        $permission = static::get_cached_value('can_edit_rule', [$rule->get('id')]);
        if (is_null($permission)) {
            $permission = $rule->get('id') &&
            ...
            static::set_cached_value('can_edit_rule', $permission, [$rule->get('id')]);
        }
        return $permission;
    }
    ...
    public static function require_can_enable_rule(rule $rule) {
        if (!self::can_enable_rule($rule)) {
            self::require_can_edit_rule($rule);
            throw new \moodle_exception('cannotenablerule', 'tool_dynamicrule', '', $rule->get_formatted_name());
        }
    }
    ...
    public static function can_edit_all_rule_conditions(rule $rule): bool {
        $permission = static::get_cached_value('can_edit_all_rule_conditions', [$rule->get('id')]);
        if (is_null($permission)) {
            ...
            static::set_cached_value('can_edit_all_rule_conditions', $permission, [$rule->get('id')]);
        }
        return $permission;
    }
    ...
    public static function can_edit_all_rule_outcomes(rule $rule): bool {
        $permission = static::get_cached_value('can_edit_all_rule_outcomes', [$rule->get('id')]);
        if (is_null($permission)) {
            ...
            static::set_cached_value('can_edit_all_rule_outcomes', $permission, [$rule->get('id')]);
        }
        return $permission;
    }
}
