...
class registration {
     ...
     *
     * Can be called as:
     * component_class_callback('tool_dynamicrule\\registration', 'stats', [true]);
     *
    ...
    public static function stats($usestrings = false) {
        global $DB;
        $count = $DB->count_records('tool_dynamicrule', ['archived' => 0, 'enabled' => 1, 'component' => null]);
        return [
            'wpdynamicrules' => $count,
        ];
    }
