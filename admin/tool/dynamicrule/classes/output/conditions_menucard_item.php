...
class conditions_menucard_item implements \renderable, \templatable {
     ...
     */
    public function __construct(condition_base $condition) {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $params = [
            ...
            'isavailable' => $this->condition::is_available(),
            'notavailablelabel' => $this->condition->get_not_available_label(),
            'isscheduledtask' => (int)$this->condition->show_scheduled_task_badge(),
        ];
