...
class rule extends \core\persistent {
    ...
    /** @var int Normal (non-shared) rules type. */
    const TYPE_NORMAL = 1;
    /** @var int Shared rules type. */
    const TYPE_SHARED = 2;
     ...
     * @return bool
     */
    public function includes_suspended() : bool {
        return (bool)$this->get('includesuspendedusers');
    }
    ...
    protected function after_delete($result): void {
        ...
        if ($result) {
            ...
            \cache_helper::purge_by_event('dynamicrulesmodified');
        }
    }

    /**
     * After adding record - reset caches.
     */
    ...
    /**
     * After udpading record - reset caches.
     *
     * @param bool $result
     */
