...
abstract class outcome_base {
     ...
     */
    public static final function instance(int $id = 0, ?\stdClass $record = null) :? outcome_base {
     ...
     * @return outcome_base|null
     */
    protected static final function instance_from_persistent(outcome $persistent) :? outcome_base {
     ...
     * @return outcome_base
     */
    public static final function create(int $ruleid, array $configdata) : outcome_base {
        $record = new \stdClass();
