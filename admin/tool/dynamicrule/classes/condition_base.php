...
abstract class condition_base {
     ...
     */
    public static final function instance(int $id = 0, ?\stdClass $record = null) :? condition_base {
     ...
     * @return condition_base|null
     */
    protected static final function instance_from_persistent(condition $persistent) :? condition_base {
     ...
     */
    public static final function create(int $ruleid, array $configdata) : condition_base {
        $record = new \stdClass();
     ...
     * @return bool
     */
    public final function is_dummy(): bool {
