    ...
    Ajax.call([{
        ...
        if (results.length <= MAXSUGGESTIONS) {
            const promises = results.map((result) => {
                return Templates.render('tool_dynamicrule/form_certificate_selector_suggestion', result);
            });
            ...
            return await Str.get_string('toomanycertificatestoshow', 'tool_dynamicrule', '>' + MAXSUGGESTIONS).then((result) => {
