...
/**
 * Validates if rule duplication brings up non-applicable entities.
 *
 * @param {Number} ruleid
 * @return {Promise}
 */
export const preDuplicateValidation = ruleid => callDynamicRuleWS('tool_dynamicrule_duplicate_rule_validation', {id: ruleid});
