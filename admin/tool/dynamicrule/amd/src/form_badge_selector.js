            ...
            promise[0].then(function(results) {
                ...
                if (results.length <= MAXBADGES) {
                    ...
                    $.each(results, function(index, item) {
                        ...
                        promises.push(Templates.render('tool_dynamicrule/form_badge_selector_suggestion', ctx));
                    });
                    ...
                    return Str.get_string('toomanybadgestoshow', 'tool_dynamicrule', '>' + MAXBADGES)
                        .then(function(toomanybadgestoshow) {
                            return success(toomanybadgestoshow);
                        });
                }
            }).fail(failure);
        }
