 ...
 *
 * @module     tool_dynamicrule/form_competency_selector
 * @class      form_competency_selector
    ...
    Ajax.call([{
        ...
        if (results.length <= MAXSUGGESTIONS) {
            const promises = results.map((result) => {
                return Templates.render('tool_dynamicrule/form_competency_selector_suggestion', result);
            });
            ...
            return await Str.get_string('toomanycompetenciestoshow', 'tool_dynamicrule', '>' + MAXSUGGESTIONS).then((result) => {
