...
$functions = [
    ...
    'tool_dynamicrule_unarchive_rule' => [
        'classname'    => tool_dynamicrule\external::class,
    ...
    'tool_dynamicrule_duplicate_rule' => [
        'classname'    => tool_dynamicrule\external::class,
    ...
    'tool_dynamicrule_duplicate_rule_validation' => [
        'classname'    => tool_dynamicrule\external\duplicate_rule_validation::class,
        'description'  => 'Validates if rule duplication brings up non-applicable entities',
        'type'         => 'read',
        'capabilities' => 'tool/dynamicrule:manage',
        'ajax'         => true,
    ],
    ...
    'tool_dynamicrule_delete_outcome' => [
        'classname'    => tool_dynamicrule\external::class,
