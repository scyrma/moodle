...
/**
 * Class customfield for tool_certification.
 *
...
admin_externalpage_setup('certificationscustomfield');
...
echo $output->header(),
$output->heading(new lang_string('certificationscustomfield', 'tool_certification')),
