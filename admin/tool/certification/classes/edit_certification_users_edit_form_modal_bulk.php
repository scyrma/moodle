 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class edit_certification_users_edit_form_modal_bulk extends dynamic_form {
    ...
    protected function get_certification(): certification {
        if (!$this->certification) {
            $this->certification = new certification($this->optional_param('certificationid', 0, PARAM_INT));
        }
