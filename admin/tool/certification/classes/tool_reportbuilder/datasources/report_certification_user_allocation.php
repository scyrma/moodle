...
class report_certification_user_allocation extends \tool_reportbuilder\datasource {
    ...
    protected function set_columns(): void {
        ...
        $this->add_entity((new user())
            ...
            ->set_table_alias('tool_tenant_user', database::generate_alias())
            ->set_table_alias('tool_tenant', database::generate_alias())
