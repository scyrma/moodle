...
class api {
    ...
    public static function get_certifications_with_criteria_conditions(int $certificationid, int $status,
        ...
        $wheredate = '';
        $user2 = db::generate_alias();
        $certification = db::generate_alias();
        $certificationuser = db::generate_alias();
        $certificationusercompletion = db::generate_alias();

        $program = db::generate_alias();
        $programuser = db::generate_alias();
        $certificationparam = db::generate_param_name();
