...
class certification_expired extends condition_sql {
    ...
    public function validate_config_form(array $data): array {
        $errors = [];
        if (!isset($data['certificationid']) || !api::certification_exists_in_tenant($data['certificationid'])) {
    ...
    public function is_configuration_valid(): bool {
        global $DB;
        return $DB->record_exists(certification::TABLE, ['id' => $this->get_certificationid()]);
    }
