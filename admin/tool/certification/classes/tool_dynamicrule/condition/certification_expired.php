 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class certification_expired extends condition_base {
    /**
    ...
    public function get_title(): string {
        return get_string('conditioncertificationexpired', 'tool_certification');
    }
    ...
    public function get_config_form(MoodleQuickForm $mform): void {
        ...
        $datestr = get_string('expireddateisonorafter', 'tool_certification');
    ...
    public function get_sql(): array {
        ...
        $pr = database::generate_alias();
        $cid = database::generate_param_name();
        $pu = database::generate_alias();
        $certificationid = $this->get_certificationid();
        $statusid = constants::STATUS_EXPIRED;

        [$join, $where, $params] = api::get_certification_status_sql_query($certificationid, $statusid, false, 'u',
            $c, $cu, $cc, $pr, $cid, $pu);

        // If enabled check that user certification has expired on or after chosen date.
        if ($this->get_conditiondateenabled()) {
            $where .= " AND {$cc}.expirydate >= ".$this->get_conditiondate();
        }
    ...
    public function get_description(): string {
        ...
        if ($this->get_conditiondateenabled()) {
            ...
            $stringid = 'conditioncertificationexpireddescriptionwithdate';
        } else {
            $stringparams = $fullname;
            $stringid = 'conditioncertificationexpireddescription';
        }
