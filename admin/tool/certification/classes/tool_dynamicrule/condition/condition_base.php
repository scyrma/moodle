...
abstract class condition_base extends \tool_dynamicrule\condition_sql {
     ...
     *
     * @deprecated since Moodle Workplace 4.2 - Please use condition_base::get_certification_user_duedate() function instead
     *
    ...
    protected function get_allocation_duedate(certification_user $certificationuser): int {
        debugging('This function is deprecated - Please use condition_base::get_certification_user_duedate() function instead',
            DEBUG_DEVELOPER);
