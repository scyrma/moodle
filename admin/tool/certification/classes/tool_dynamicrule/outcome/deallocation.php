...
class deallocation extends outcome_base {
    ...
    public function apply_to_user(stdClass $user): void {
        ...
        switch ($this->get_deallocation_action()) {
    ...
    /**
     * Action to perform on deallocation (deallocate or suspend).
     *
     * @return int
     */
    private function get_deallocation_action(): int {
        return (isset($this->get_configdata()['action']) &&
            $this->get_configdata()['action'] == self::SUSPEND_USER) ?
            self::SUSPEND_USER : self::DEALLOCATE_USER;
    }
    ...
    public function get_description(): string {
        ...
        if ($this->get_deallocation_action() === self::DEALLOCATE_USER) {
