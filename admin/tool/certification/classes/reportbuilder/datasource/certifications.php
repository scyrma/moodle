...
class certifications extends datasource {
    ...
    protected function initialise(): void {
        ...
        if ($canshowtenantcolumn) {
            ...
            $tenantentity->add_join("JOIN {tool_tenant} {$tooltenant} ON {$tooltenant}.id = {$toolcertification}.tenantid");
    ...
    public function get_default_columns(): array {
        return [
            ...
            // TODO add tool_program_content:coursesinsetcommaseparatedlinks.
        ];
    }
