...
class user_allocations extends system_report {
    ...
    protected function initialise(): void {
        ...
        AND tpu2.certificationid = tcu.certificationid) AS lasttpuid");
    ...
    protected function add_actions(): void {
        ...
        $this->add_action((new action(
            ...
            global $USER;
            return $USER->id != $row->userid && \tool_program\permission::can_view_user_programs_progress((int) $row->userid);
        }));
    }
