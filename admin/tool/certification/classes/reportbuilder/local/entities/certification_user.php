...
class certification_user extends base {
    ...
    protected function get_all_columns(): array {
        ...
        // Is recertification column.
        $columns[] = (new column(
            'isrecertification',
            new lang_string('isrecertification', 'tool_certification'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
            ->set_type(column::TYPE_BOOLEAN)
            ->add_field("{$certificationuser}.isrecertification")
            ->set_is_sortable(true)
    ...
    protected function get_all_filters(): array {
        ...
        // Is recertification filter.
        $filters[] = (new filter(
            boolean_select::class,
            'isrecertification',
            new lang_string('isrecertification', 'tool_certification'),
            $this->get_entity_name(),
            "{$certificationuser}.isrecertification"
        ))
            ->add_joins($this->get_joins());
