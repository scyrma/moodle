...
class external extends external_api {
     ...
     * @return bool
     */
    public static function potential_program_selector_is_deprecated(): bool {
        return true;
    }
     ...
     * Program selector.
     *
     * @deprecated please use \tool_program\external::potential_program_selector instead
     *
     * @param string $search
     * @return array
     */
    ...
    public static function get_certification_user_log(int $certificationid, int $userid): array {
        ...
        return ['log' => $log, 'downloadform' => $downloadform];
    }
