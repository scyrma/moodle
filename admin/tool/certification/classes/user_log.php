...
class user_log {
    ...
    private function generate_log(): void {
        ...
        // We start adding user allocation event.
        $userallocatedstr = get_string('eventuserallocated', 'tool_certification');
        $this->add_event($this->userid, $userallocatedstr, $this->certificationuser->get('timecreated'));
