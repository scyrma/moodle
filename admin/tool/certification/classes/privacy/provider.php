    ...
    public static function get_metadata(collection $collection): collection {
        ...
        $collection->add_database_table(
            ...
            [
                ...
                'startdate' => 'privacy:metadata:certification_users:startdate',
                'startdatelocked' => 'privacy:metadata:certification_users:startdatelocked',
                'duedate' => 'privacy:metadata:certification_users:duedate',
                'duedatelocked' => 'privacy:metadata:certification_users:duedatelocked',
                'enddate' => 'privacy:metadata:certification_users:enddate',
                'enddatelocked' => 'privacy:metadata:certification_users:enddatelocked',
                'expirydate' => 'privacy:metadata:certification_users:expirydate',
                'expirydatelocked' => 'privacy:metadata:certification_users:expirydatelocked',
            ...
            foreach ($relatedcompletions as $relatedcompletion) {
                if (!isset($stores[$certification->id]['completions'][$relatedcompletion->id])) {
                    $stores[$certification->id]['completions'][$relatedcompletion->id] = [
                        ...
                        'expiry_date' => $relatedcompletion->expirydate ? transform::datetime($relatedcompletion->expirydate) : '-',
