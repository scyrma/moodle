...
/**
 * File for event recertification_started
 *
 ...
 *      - int duedate: due date for the user.
 * }
 *
 * @package    tool_certification
 * @author     2019 David Matamoros <davidmc@moodle.com>
 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class recertification_started extends base {
     ...
     */
    public static function create_from_recertification_started(certification_user $certuser, program_user $programuser) {
        if (!$certuser->get('id')) {
    ...
    public static function get_name(): string {
        return get_string('eventrecertificationstarted', 'tool_certification');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '$this->relateduserid' started recertification with id '$certificationid'.";
    }
