...
/**
 * Class tool_certification\event\user_allocation_created
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int certificationid: id of certification.
 *      - int userid: id of the user allocated.
 * }
 *
...
class user_allocation_created extends base {
     ...
     */
    public static function create_from_user_allocation_created(certification_user $certuser) {
        if (!$certuser->get('id')) {
    ...
    public static function get_name(): string {
        return get_string('eventuserallocated', 'tool_certification');
    }
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' allocated the user with id '$this->objectid'.";
    }
