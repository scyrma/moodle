...
/**
 * Class tool_certification\event\certification_updated
 *
 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class certification_updated extends base {
     ...
     * @return self
     */
    public static function create_from_certification_updated(certification $certification, \stdClass $oldrecord) {
        ...
        if (!$oldrecord->archived && $certification->get('archived')) {
    ...
    public static function get_name(): string {
        return get_string('eventcertificationupdated', 'tool_certification');
    }
    ...
    public function get_description(): string {
        if (!empty($this->other['isarchived'])) {
            return "The user with id '$this->userid' has archived the certification with id '$this->objectid'.";
        }

        if (!empty($this->other['isrestored'])) {
            return "The user with id '$this->userid' has restored the certification with id '$this->objectid'.";
        }

        return "The user with id '$this->userid' updated the certification with id '$this->objectid'.";
    }
    ...
    public function get_url(): moodle_url {
        return new moodle_url('/admin/tool/certification/index.php', ['id' => $this->objectid]);
    }
