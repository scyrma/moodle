...
/**
 * Class tool_certification\event\certification_created
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class certification_created extends base {
     ...
     * @return self
     */
    public static function create_from_certification_created(certification $certification) {
    ...
    public static function get_name(): string {
        return get_string('eventcertificationcreated', 'tool_certification');
    }
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' created the certification with id '$this->objectid'.";
    }
