...
class permission {
     ...
     * @return bool
     */
    public static function can_edit_dynamicrule_condition(certification $certification): bool {
     ...
     * @return bool
     */
    public static function can_edit_dynamicrule_outcome(certification $certification): bool {
        // We check using has_allocateuser_capability() here rather than can_allocate_anybody()
        // to prevent case when organisation manager may allocate someone who does not
        // belong to her team.
