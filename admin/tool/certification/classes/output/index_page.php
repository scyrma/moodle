...
use renderer_base;
use tool_certification\output\tab\certification_manager_reports_tab;
...
/**
 * Class tool_certification\output\index_page
 *
...
class index_page implements \templatable, \renderable {
    ...
    public function __construct() {
        ...
        $tabs = [
            new certification_manager_list_active_tab($attributes),
            new certification_manager_list_archived_tab($attributes),
            new certification_manager_reports_tab($attributes),
        ];
        foreach ($tabs as $tab) {
            if ($tab->is_available()) {
