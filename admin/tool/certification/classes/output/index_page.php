...
class index_page implements \templatable, \renderable {
    ...
    public function __construct() {
        ...
        $this->tabsoutput->add_tab(new certification_manager_list_active_tab($attributes));
        if (permission::can_view_archived_list($context)) {
            $this->tabsoutput->add_tab(new certification_manager_list_archived_tab($attributes));
        }
    }
