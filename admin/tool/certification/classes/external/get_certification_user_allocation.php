...
/**
 * Class to get all allocations for given user and given certification.
 *
 ...
 */
class get_certification_user_allocation extends external_api {
    /**
    ...
    public static function execute(int $certificationid, int $userid): array {
        ...
        certificationpermission::require_can_view_details($certification);
        ...
        // TODO: Remove this check and add strictness when MDL-74192 is merged.
        if (!$certificationuser) {
            return [];
        }

        $result = (new certification_user_exporter($certificationuser, ['context' => $context]))->export($renderer);
    ...
    public static function execute_returns(): external_single_structure {
        return certification_user_exporter::get_read_structure();
    }
}
