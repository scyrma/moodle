...
class active_table extends system_report {
    ...
    protected function initialise() {
        ...
        if ($filter = $this->get_filter('tool_program:fullname')) {
            $filter->set_is_default(true);
        }
        if ($filter = $this->get_filter('tool_certification:tags')) {
            $filter->set_is_default(true);
        }
    }
    ...
    private function add_actions(): void {
        ...
        $str = get_string('users', 'tool_certification');
