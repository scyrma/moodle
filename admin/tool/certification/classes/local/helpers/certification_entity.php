...
class certification_entity extends entity_base {
    ...
    public function convert_get_entity_class(): string {
        return \tool_certification\reportbuilder\local\entities\certification::class;
    }
    ...
    public function convert_get_filter_name(report_filter $oldfilter, \core_reportbuilder\datasource $newsource): string {
        if ($oldfilter->get_name() === 'tags') {
            ...
            throw new convert_not_possible('Certification tags filter can not be converted');
        }
    ...
    public function convert_get_condition_name(report_filter $oldcondition, \core_reportbuilder\datasource $newsource): string {
        if ($oldcondition->get_name() === 'tags') {
            // TODO WP-3702 implement tags filter.
            throw new convert_not_possible('Certification tags condition can not be converted');
        }
