 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class edit_certification_availability_form extends dynamic_form {
    /** @var certification */
    ...
    public function validation($data, $files): array {
        ...
        && (int)$data['expirydatetype'] === constants::DATE_ABSOLUTE) {
            $duedateabsolute = \tool_program\api::calculate_relative_date($data['duedaterelative'],
                (int)$data['startdateabsolute']);
