...
\tool_wp\admin_externalpage::setup_page('certifications', '', [],
    new moodle_url("/$CFG->admin/tool/certification/progress.php", ['id' => $certificationid]));
...
\tool_wp\admin_externalpage::setup_subpage($certificationprogressstr);

// Disable secondary navigation on this page, otherwise the "Site administration" tabs are shown.
$PAGE->set_secondary_navigation(false);

echo $OUTPUT->header();
$report = \tool_tenant\system_report_factory::create(progress::class, ['id' => $certificationid]);
echo $report->output();
echo $OUTPUT->footer();
