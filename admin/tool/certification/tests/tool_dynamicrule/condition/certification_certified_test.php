...
class certification_certified_test extends advanced_testcase {
    ...
    public function test_use_of_placeholder(): void {
        ...
        /** @var certification_certified $certificationcondition */
    ...
    public function test_completion_of_another_certification(): void {
        ...
        $certificategenerator = self::getDataGenerator()->get_plugin_generator('tool_certificate');
        $certificate = $certificategenerator->create_template((object)['name' => 'Test template']);
