 ...
 * @covers     \tool_certification\tool_dynamicrule\condition\certification_overdue
...
class certification_overdue_test extends advanced_testcase {
    ...
    public function test_get_description(): void {
        ...
        $expectedstr = get_string('conditioncertificationoverduedescription', 'tool_certification',
