 ...
 * @covers     \tool_certification\tool_dynamicrule\condition\certification_expired
 * @author     2019 David Matamoros <davidmc@moodle.com>
 * @copyright  2019 Moodle Pty Ltd <support@moodle.com>
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class certification_expired_test extends advanced_testcase {
    ...
    public function test_get_title(): void {
        $condition = certification_expired::instance();
    ...
    public function test_get_config_attributes(): void {
        ...
        $outcome = certification_expired::instance();
    ...
    public function test_get_matching_users_given_expired_status(): void {
        ...
        // We cannot certify user with expirydate in the past. Create completion record.
    ...
    public function test_get_description(): void {
        ...
        $expectedstr = get_string('conditioncertificationexpireddescription', 'tool_certification',
    ...
    public function test_is_configuration_valid(): void {
        ...
        // Empty configuration.
        $condition = certification_expired::create($rule->id, []);
    ...
    public function test_user_can_add(): void {
        ...
        $configdata = ['certificationid' => $certification->get('id')];
        certification_expired::create($rule1->id, $configdata);

        $this->assertFalse(certification_expired::instance()->user_can_add());

        $this->generator->assign_allocateuser_capability($user->id, $certification->get_context());
        $this->assertTrue(certification_expired::instance()->user_can_add());
    }
    ...
    public function test_user_can_edit(): void {
        ...
        $configdata = ['certificationid' => $certification->get('id')];
        certification_expired::create($rule1->id, $configdata);
        $this->assertFalse(certification_expired::instance()->user_can_edit($configdata));

        $this->generator->assign_allocateuser_capability($user->id, $certification->get_context());
        $this->assertFalse(certification_expired::instance()->user_can_edit($configdata));

        $this->tenantgenerator->allocate_user($user->id, $tenant->id);
        $this->assertTrue(certification_expired::instance()->user_can_edit($configdata));
    }
}
