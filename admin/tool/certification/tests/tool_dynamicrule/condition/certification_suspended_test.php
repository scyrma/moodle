 ...
 * @covers     \tool_certification\tool_dynamicrule\condition\certification_suspended
...
class certification_suspended_test extends advanced_testcase {
    ...
    public function test_get_matching_users_given_suspended_status(): void {
        ...
        $certificationuser1 = $this->generator->allocate_user($user1->id, $certification->get('id'));
    ...
    public function test_get_description(): void {
        ...
        $expectedstr = get_string('conditioncertificationsuspendeddescription', 'tool_certification',
