...
class tool_certification_generator extends component_generator_base {
    ...
    public function create_certification_user(array $record): certification_user {
        ...
        return $this->allocate_user($record['userid'], $record['certificationid'], $record);
    }
     ...
     * @return array
     */
    public function get_dummy_userdata(int $certificationid, int $userid, array $overrides = []): array {
        unset($overrides['certificationid']);
     ...
     * @return certification_user
     */
    public function allocate_user(int $userid, int $certificationid, array $overrides = []): certification_user {
        $certification = new certification($certificationid);
        $userdata = $this->get_dummy_userdata($certificationid, $userid, $overrides);
