...
class tool_certification_generator extends component_generator_base {
     ...
     * @deprecated since 3.11.5 - please use tool_tenant_generator::create_tenant_and_users() instead.
     * @return object
     */
    public function create_tenant_and_user(): object {
        debugging('This method is deprecated, please use tool_tenant_generator::create_tenant_and_users()');
