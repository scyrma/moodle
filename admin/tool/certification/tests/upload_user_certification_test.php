...
class upload_user_certification_test extends advanced_testcase {
     ...
     */
    public function test_update_start_date_and_due_date() {
        $this->resetAfterTest();
        $this->setAdminUser();
...
EOF;
     ...
     */
    public function test_update_certification_date_and_last_certification() {
        $this->resetAfterTest();
        $this->setAdminUser();
        $today = usergetmidnight(time());
...
EOF;
     ...
     */
    public function test_certification_user_remove_program() {
        $this->resetAfterTest();
        $this->setAdminUser();
        $today = usergetmidnight(time());
