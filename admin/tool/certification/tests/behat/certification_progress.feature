...
Feature: Complete a certification and check if user and manager can view the correct status
  ...
  Scenario: User completes certification and user and manager can view the correct certification status
    ...
    And the following should exist in the "reportbuilder-table" table:
      | First name/Surname  | Certification status  | Current program progress  | Is recertification | Current program status | Current program |
      | User 11             | Certified             | -                         | No                 | -                      |                 |
      | User 12             | Open                  | 0%                        | No                 | Open                   | Program1        |
    ...
    And I click on "//span[text()='Certifications']/following::span/a[text()='Full report']" "xpath_element" in the "User 11" "table_row"
