...
Feature: Check capabilities
  ...
  Background:
    ...
    And I set the following system permissions of "certification user manager" role:
      | capability              | permission |
      | tool/certification:allocateuser | Allow      |
      | moodle/site:configview  | Allow      |
    And I set the following system permissions of "certification edit manager" role:
      | capability              | permission |
  ...
  Scenario: Manager has both capabilities and can edit and allocate users
    ...
    And ".edit_certification" "css_element" should exist in the "Certification1" "table_row"
    And ".edit_details" "css_element" should exist in the "Certification1" "table_row"
    And ".allocate_users" "css_element" should exist in the "Certification1" "table_row"
    ...
    And I should see "Select program"
  ...
  Scenario: Manager has allocate user capabilities but can not edit certification
    ...
    And I should see "Certification1"
    And I should not see "Certification2"
    And ".edit_certification" "css_element" should not exist in the "Certification1" "table_row"
    And ".edit_details" "css_element" should not exist in the "Certification1" "table_row"
    And ".allocate_users" "css_element" should exist in the "Certification1" "table_row"
  ...
  Scenario: Manager has edit capabilities and can not allocate users
    ...
    And ".edit_certification" "css_element" should exist in the "Certification1" "table_row"
    And ".edit_details" "css_element" should exist in the "Certification1" "table_row"
    And ".allocate_users" "css_element" should not exist in the "Certification1" "table_row"
    Then I click on ".edit_certification" "css_element" in the "Certification1" "table_row"
    And the "class" attribute of "a#certification_calendar_tab-tab" "css_element" should not contain "disabled"
    And the "class" attribute of "a#certification_users_tab-tab" "css_element" should not contain "disabled"
    Then I click on "Edit details" "button"
