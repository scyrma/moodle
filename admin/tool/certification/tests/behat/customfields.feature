...
Feature: Create custom fields on certifications
  ...
  Background:
    ...
    And the following "permission overrides" exist:
      ...
      | moodle/reportbuilder:editall             | Allow      | certificationeditmanager | System       |           |
  ...
  Scenario: Create and edit custom fields
    ...
    And I should see "Testing a custom text field" in the ".reportbuilder-sidebar-menu #card_certification" "css_element"
    Then I click on "[data-action='report-add-column'][data-unique-identifier='certification:fullname']" "css_element"
