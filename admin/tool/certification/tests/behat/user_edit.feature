...
Feature: Edit certification users allocations
  ...
  Scenario: We edit one user allocation
    ...
    Then I press "Save changes" in the modal form dialogue
    And I should see "##+2 days##j/m/y##" in the "User a" "table_row"
    ...
    And I set the field "Reset additional courses" to "1"
    And I set the following fields to these values:
      | expirydatetype       | Select date      |
      | expirydate[day]      | ##-15 days##j##  |
      | expirydate[month]    | ##-15 days##n##  |
