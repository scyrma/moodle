...
Feature: Check datasources for certifications
  ...
  Scenario: Manager can create a user allocation and a certifications report
    ...
    And I should see "Full name" in the "#entity_tool_certification" "css_element"
    ...
    And I should see "Program" in the "#entity_tool_certification" "css_element"
    ...
    And I should see "Status" in the "#entity_tool_certification_users" "css_element"
    ...
    Then I click on "[data-field='tool_certification_users:userduedate']" "css_element"
    And I should see "Due date" in the "[data-region='report-table']" "css_element"
    Then I click on "[data-field='tool_certification:certificationprogram']" "css_element"
