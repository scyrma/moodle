...
Feature: Certify and revoke user certifications
  ...
  Background:
    ...
    # Certification1 is set to expire in 10 days. Certification2 and Certification3 are set to never expire.
    Given the following "tool_certification > certifications" exist:
      | fullname       | archived | tenant  | program   | idnumber | requirerecertification | recertificationprogram  | expirydatetype  | expirydateabsolute  |
      | Certification1 | 0        | Tenant1 | Program1  |  num1    | 1                      | Program3                | 1               | + 10 day            |
      | Certification2 | 0        | Tenant2 | Program2  |  num2    | 0                      | Program2                | 4               | + 1 year            |
      | Certification3 | 0        | Tenant1 | Program3  |  num3    | 0                      | Program3                | 4               | + 1 year            |
  ...
  Scenario: Certify and revoke one user allocation
    ...
    Then I press "Revoke certification" action in the "User a" report row
    ...
    Then I press "Certify user" action in the "User a" report row
    And I select "## +10 day ##%d/%m/%y (Default)##" from the "expirydatetype" singleselect
    Then I click on "Certify" "button" in the "Certify" "dialogue"
    And I should see "Certified" in the "User a" "table_row"
    And I should see "## +10 day ##%d/%m/%y##" in the "User a" "table_row"
    ...
    And "Certify user" "link" should exist in the "User a" "table_row"
    Then I log out
  ...
  Scenario: Certify and recertify user allocation and check that certify and revoke work as expected
    ...
    Then I press "Revoke certification" action in the "User a" report row
    And I should see "Revoke certification"
    Then I click on "Yes" "button" in the "Revoke certification" "dialogue"
    Then "Revoke certification" "link" should not exist in the "User a" "table_row"
    Then "Certify user" "link" should exist in the "User a" "table_row"
    And I should not see "Certified" in the "User a" "table_row"
    And I log out
