...
Feature: Create certification
  ...
  Background:
    ...
    And the following users allocations to tenants exist:
      ...
      | manager2 | Tenant2 |
      | manager3 | Tenant1 |
    And user "manager1" has a department manager position over users "user1,user2" with permissions "3"
    And user "manager3" has a department manager position over users "user1,user2" with permissions "3"
  ...
  Scenario: Create a certification with basic information
    ...
    And "Program2" "autocomplete_selection" should not exist
    ...
    # Recertification tab.
    Then I click on "Recertification" "link" in the "region-main" "region"
    # Basic details.
    And I set the following fields to these values:
