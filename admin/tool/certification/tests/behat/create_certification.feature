...
Feature: Create certification
  ...
  Scenario: Create a certification with basic information
    ...
    And I should see "Users who have status 'Certified' in certification"
    And I should see "Users who do not have status 'Certified' in certification"
    And I should see "Users who have status 'Overdue' in certification"
    And I should see "Users who have status 'Expired' in certification"
    And I should see "Users who have status 'Suspended' in certification"
