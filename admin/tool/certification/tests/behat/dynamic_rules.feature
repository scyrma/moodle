...
Feature: Certification conditions and actions are marked as broken if certification gets deleted or archived
  ...
  Scenario: Certification certified condition and Allocate users action is marked as broken if certification gets archived/deleted
    ...
    And I click on ".form-autocomplete-downarrow" "css_element" in the ".select_certification" "css_element"
    And I should see "Certification2" in the ".select_certification .form-autocomplete-suggestions" "css_element"
    Then I click on "Certification2" "text" in the ".select_certification .form-autocomplete-suggestions" "css_element"
    And I press "Save changes"
    ...
    And I press "Archive"
    Then I click on ".archive_certification" "css_element" in the "Certification2" "table_row"
    And I press "Archive"
    And I should not see "Certification1"
    And I should not see "Certification2"
    Then I click on "Archived" "link"
    Then I click on ".delete_certification" "css_element" in the "Certification2" "table_row"
