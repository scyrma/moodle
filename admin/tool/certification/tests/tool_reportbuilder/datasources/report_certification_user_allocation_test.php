 ...
 */
class report_certification_user_allocation_test extends advanced_testcase {
    ...
    protected function set_up_for_report(): array {
        ...
        $this->generator->allocate_user($user, $certification->get('id'));
        ...
        $othercertification = $this->generator->generate_certification(['tenantid' => $othertenantid]);
        $users = [];
        for ($i = 0; $i < 5; $i++) {
            ...
            $this->generator->allocate_user($users[$i], $othercertification->get('id'));
        }
    ...
    public function test_permissions(): void {
        ...
        $reportid = $this->rbgenerator->create_report(['source' => report_certification_user_allocation::class])->get_id();
    ...
    public function test_convert_to_core_reportbuilder(): void {
        ...
        $this->rbgenerator->datasource_test_convert_to_core_reportbuilder(report_certification_user_allocation::class, $this);
    }
}
