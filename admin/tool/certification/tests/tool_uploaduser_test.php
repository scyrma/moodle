...
class tool_uploaduser_test extends advanced_testcase {
     ...
     * @return array
     */
    public static function certification_certify_provider(): array {
        return [
...
EOF;
        ...
        $this->assertEquals(constants::STATUS_CERTIFIED,
            api::get_user_allocation_status($c1->get('id'), $user11->id)[0]['status']);
        $this->assertEquals(constants::STATUS_CERTIFIED,
            api::get_user_allocation_status($c1->get('id'), $user12->id)[0]['status']);
        $this->assertEquals(constants::STATUS_EXPIRED,
            api::get_user_allocation_status($c1->get('id'), $user13->id)[0]['status']);
        $this->assertEquals(constants::STATUS_CERTIFIED,
            api::get_user_allocation_status($c1->get('id'), $user14->id)[0]['status']);
...
EOF;
        ...
        $this->assertFalse($certcompletions[0]->get('islast'));
        ...
        $this->assertFalse($certcompletions[1]->get('islast'));
        ...
        $this->assertTrue($certcompletions[2]->get('islast'));
...
EOF;
        ...
        $this->assertEquals(constants::STATUS_OPEN,
            api::get_user_allocation_status($c1->get('id'), $user1->id)[0]['status']);
        ...
        $this->assertEquals(constants::STATUS_OPEN,
            api::get_user_allocation_status($c1->get('id'), $user2->id)[0]['status']);
...
EOF;
    ...
    public function test_update_certification_dates_certified(): void {
        ...
        // Double check the set up.
        $this->assertEquals(constants::STATUS_CERTIFIED,
            api::get_user_allocation_status($c1->get('id'), $user3->id)[0]['status']);
...
EOF;
    ...
    public function test_update_certification_dates_recertification(): void {
        ...
        // Double check the set up.
        $this->assertEquals(constants::STATUS_CERTIFIED,
            api::get_user_allocation_status($c1->get('id'), $user4->id)[0]['status']);
