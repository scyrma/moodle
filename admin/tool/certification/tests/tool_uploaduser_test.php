...
class tool_uploaduser_testcase extends advanced_testcase {
     ...
     */
    public function test_uploaduser_certification_certified() {
        $this->resetAfterTest();
        $this->setAdminUser();
...
EOF;
     ...
     */
    public function test_uploaduser_recertification_certified() {
        $this->resetAfterTest();
        $this->setAdminUser();
...
EOF;
     ...
     */
    public function test_uploaduser_multiple_certifications() {
        $this->resetAfterTest();
        $this->setAdminUser();
...
EOF;
     ...
     */
    protected function prepare_certification_with_recertification(array $params = []) {
        // Create a certification with recertification.
    ...
    public function test_allocate_user_with_dates() {
        $this->resetAfterTest();
        $this->setAdminUser();
...
EOF;
    ...
    public function test_update_certification_dates_open_certification() {
        $this->resetAfterTest();
        $this->setAdminUser();
        $today = usergetmidnight(time());
...
EOF;
    ...
    public function test_update_certification_dates_certified() {
        $this->resetAfterTest();
        $this->setAdminUser();
        $today = usergetmidnight(time());
...
EOF;
    ...
    public function test_update_certification_dates_recertification() {
        $this->resetAfterTest();
        $this->setAdminUser();
        $today = usergetmidnight(time());
