...
class external_test extends externallib_advanced_testcase {
    ...
    public function test_archive_certification_no_permission(): void {
        ...
        \tool_certification\external::archive_certification($certification->get('id'));
    }
    ...
    public function test_restore_certification_no_permission(): void {
        ...
        $this->expectException('moodle_exception');
        \tool_certification\external::restore_certification($certification->get('id'));
    }
    ...
    public function test_delete_certification_no_permission(): void {
        ...
        $this->expectException('moodle_exception');
        \tool_certification\external::delete_certification($certification->get('id'));
    }
    ...
    public function test_deallocate_user_no_permission(): void {
        ...
        $certification = $this->generator->generate_certification(['tenantid' => $data->defaulttenantid]);
        $this->generator->allocate_user($data->user->id, $certification->get('id'));
    ...
    public function test_get_certification_user_log(): void {
        ...
        // Certify.
        \tool_certification\api::set_user_as_certified($user2->id, $certificationid, null, $now, get_admin()->id);
        // Revoke.
        \tool_certification\api::revoke_certification_from_user($user2->id, $certificationid);

        $response = \tool_certification\external::get_certification_user_log($certificationid, $user2->id);
    ...
    public function test_get_certification_user_log_no_permission(): void {
        ...
        $this->expectException('moodle_exception');
        \tool_certification\external::get_certification_user_log($certificationid, $user2->id);
    }
