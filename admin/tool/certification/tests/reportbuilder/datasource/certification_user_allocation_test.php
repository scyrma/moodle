...
class certification_user_allocation_test extends core_reportbuilder_testcase {
    ...
    public function test_stress_datasource(): void {
        ...
        $this->datasource_stress_test_columns(certification_user_allocation::class);
        $this->datasource_stress_test_columns_aggregation(certification_user_allocation::class);
        $this->datasource_stress_test_conditions(certification_user_allocation::class, 'certification_user:timecreated');
    }
}
