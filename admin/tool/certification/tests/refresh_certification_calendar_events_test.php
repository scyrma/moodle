...
/**
 * Class tool_certification_refresh_certification_calendar_events_testcase
 *
 * @package   tool_certification
 * @copyright 2021 Moodle Pty Ltd <support@moodle.com>
 * @author    2021 David Matamoros <davidmc@moodle.com>
 * @license   Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class tool_certification_refresh_certification_calendar_events_testcase extends advanced_testcase {
