 ...
 * @covers    \tool_certification_observer
...
class observer_test extends advanced_testcase {
    ...
    public function test_tenant_user_updated(): void {
        global $DB;
        self::setAdminUser();
    ...
    public function test_tenant_user_updated_shared_certification(): void {
        global $DB;
        self::setAdminUser();
        ...
        $this->set_grade_in_course($assignrow, (int)$user3->id, 50);
