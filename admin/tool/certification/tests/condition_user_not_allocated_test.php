...
class tool_certification_condition_user_not_allocated_testcase extends advanced_testcase {
     ...
     */
    public function test_get_matching_users_future_allocation() {
    ...
    public function test_event_observer_user_deallocated() {
        ...
        (new tool_dynamicrule\task\process_rules())->execute();
