...
class lib_test extends advanced_testcase {
    ...
    public function test_section_block_myteams(): void {
        ...
        [$tenant1, [$user1, $user2, $user3, $user4, $user5]] = $this->tenantgenerator->create_tenant_and_users(5);
        $tadmin = $this->tenantgenerator->create_user(['tenantadmin' => 1, 'tenantid' => $tenant1->id]);
        $this->setUser($tadmin);
        ...
        $certificationshared = $this->generator->generate_certification([
            'fullname' => 'Certification shared',
        ...
        // User with shared certification.
        $sharedcertificationdata = (object) [
            'userid' => $user5->id,
            'certificationid' => $certificationshared->get('id'),
            'startdate' => strtotime(' +1 day'),
            'startdatelocked' => 1,
            'duedate' => strtotime(' +2 day'),
            'duedatelocked' => 1,
        ...
        api::allocate_user($certificationshared, $sharedcertificationdata);
        $user5certification = tool_certification_block_myteams_user_section($user5->id)[0]->get_items();
        ...
        $this->assertCount(1, $user5certification);
        ...
        $this->assertFalse($user1certification[0]->get_overdue());
        ...
        $this->assertTrue($user2certification[0]->get_overdue());
        ...
        $this->assertTrue($user3certification[0]->get_overdue());
        ...
        $this->assertEquals('Certification shared', $user5certification[0]->get_title());
        $this->assertEquals('0% completed', $user5certification[0]->get_subtitle());
        $this->assertFalse($user5certification[0]->get_overdue());
        $this->assertEmpty($user1certification[0]->get_badges());
    }
}
