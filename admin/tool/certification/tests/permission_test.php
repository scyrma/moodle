...
class tool_certification_permission_testcase extends advanced_testcase {
    ...
    public function test_check_belongs_same_tenant(): void {
        ...
        $othertenantid = $this->get_tenantgenerator()->create_tenant()->id;
        // Create one user.
        $user = $this->getDataGenerator()->create_user();
        $this->setUser($user);
        // We allocate user into othertenant.
        $this->assertEquals($defaulttenantid, \tool_tenant\tenancy::get_tenant_id());
        $this->get_tenantgenerator()->allocate_user($user->id, $othertenantid);
        ...
        $certification2 = $this->get_generator()->generate_certification(['tenantid' => $othertenantid]);
    ...
    public function test_has_edit_capability(): void {
        ...
        $this->get_generator()->assign_edit_capability($user->id, $context);
    ...
    public function test_can_view_list(): void {
        ...
        $this->get_generator()->assign_allocateuser_capability($user2->id, $context);
