...
use tool_certification\tool_dynamicrule\condition\certification_suspended;
 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class tool_certification_condition_certification_suspended_testcase extends advanced_testcase {
    ...
    public function test_get_title(): void {
        $condition = new certification_suspended();
    ...
    public function test_get_config_attributes(): void {
        ...
        $outcome = new certification_suspended();
    ...
    public function test_get_matching_users_given_suspended_status(): void {
        ...
        $now = time();
        $certificationuser1->set('status', \tool_certification\constants::STATUS_OVERRIDE_SUSPENDED);
