...
class catalogue_exporter_test extends advanced_testcase {
    ...
    public function test_export(): void {
        ...
        $this->assertEquals($program1->get('id'), $data->listitems[2]['itemid']);
        ...
        $this->assertEquals('warning', $data->listitems[2]['duedatebadgetype']);
        ...
        // Fourth item in the list should be Program2.
        $this->assertEquals('My program 2', $data->listitems[3]['fullname']);
        $this->assertEquals($program2->get('id'), $data->listitems[3]['itemid']);
        $this->assertNotEmpty($data->listitems[3]['image']);
        $this->assertEquals('0.0', $data->listitems[3]['progress']);
        $this->assertEquals(0, $data->listitems[3]['numcourses']);
        $this->assertEquals(0, $data->listitems[3]['lastaccess']);
        $this->assertEquals($duedate2, $data->listitems[3]['duedate']);
        $this->assertEquals('Overdue', $data->listitems[3]['duedatebadgestr']);
        $this->assertEquals('danger', $data->listitems[3]['duedatebadgetype']);
        $this->assertEquals(router::build_program_url($program2->get('id')), $data->listitems[3]['url']);
        $this->assertTrue($data->listitems[3]['isprogram']);
    }
