...
class get_user_catalogue_program_test extends externallib_advanced_testcase {
    ...
    public function test_execute(): void {
        ...
        $timeaccess = time() - MINSECS;
        $DB->insert_record('user_lastaccess',
            ['userid' => $USER->id, 'courseid' => $course->id, 'timeaccess' => $timeaccess]);
        ...
        $this->assertEquals($timeaccess, $catalogueprogram['lastaccess']);
        $params = [
        ...
        $this->assertTrue($programcourse['isenrolled']);
        $this->assertFalse($programcourse['ishidden']);
        $this->assertFalse($programcourse['showhiddencoursebadge']);
        $this->assertEquals($timeaccess, $programcourse['lastaccess']);
    }
