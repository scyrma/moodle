...
class provider_test extends provider_testcase {
    ...
    public function test_export_user_preferences(): void {
        ...
        $this->assertEquals('Yes', $exportedpreferences->tool_catalogue_hide_program_cover_help->value);
        $this->assertEquals(
            get_string('privacy:metadata:preference:tool_catalogue_hide_program_cover_help', 'tool_catalogue'),
            $exportedpreferences->tool_catalogue_hide_program_cover_help->description
        );

        $this->assertEquals('Yes', $exportedpreferences->tool_catalogue_collapse_recently_accessed_courses->value);
        $this->assertEquals(
            get_string('privacy:metadata:preference:tool_catalogue_collapse_recently_accessed_courses', 'tool_catalogue'),
            $exportedpreferences->tool_catalogue_collapse_recently_accessed_courses->description
        );
    }
