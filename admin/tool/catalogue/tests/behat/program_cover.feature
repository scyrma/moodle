...
Feature: Program cover in the Learning catalogue plugin
  ...
  Scenario: User should see the program information
    ...
    And I should see "50% completed" in the "Program structure" "tool_catalogue > Catalogue pagesection"
    And I should see "100% completed" in the "Program structure" "tool_catalogue > Catalogue pagesection"
    # Proceed to program.
