...
Feature: Course cover in the Learning catalogue plugin
  ...
  Scenario: User can see course cover when accessing a program course through catalogue
    ...
    # Course files. Shouldn't be visible because we only uploading 1 image which is course image.
    And I should not see "Course files"
  ...
  Scenario: User can see course cover in the course information tab
    Given the following config values are set as admin:
    | courseoverviewfileslimit | 2     |
    # Upload a file.
    When I am on the "PC01" "Course" page logged in as "admin"
    And I navigate to "Settings" in current page administration
    And I upload "lib/tests/fixtures/gd-logo.png" file to "Course image" filemanager
    And I upload "lib/filestorage/tests/fixtures/testimage.jpg" file to "Course image" filemanager
    And I press "Save and display"
    And I log out
    ...
    And "//img[contains(@src,'pluginfile.php') and contains(@src, '/testimage.jpg')]" "xpath_element" should exist in the "Course files" "tool_catalogue > Catalogue pagesection"
    And "//img[contains(@src,'pluginfile.php') and contains(@src, '/gd-logo.png')]" "xpath_element" should not exist in the "Course files" "tool_catalogue > Catalogue pagesection"
  ...
  Scenario: Course tabs are in correct positions
    When I am on the "PC01" "Course" page logged in as "admin"
    Then I should see "Course" in the ".secondary-navigation li:nth-of-type(1)" "css_element"
    And I should see "Information" in the ".secondary-navigation li:nth-of-type(2)" "css_element"
    And I should see "Settings" in the ".secondary-navigation li:nth-of-type(3)" "css_element"
    And I should see "Participants" in the ".secondary-navigation li:nth-of-type(4)" "css_element"
    And I should see "Grades" in the ".secondary-navigation li:nth-of-type(5)" "css_element"
    And I should see "More" in the ".secondary-navigation li:nth-of-type(6)" "css_element"
    And I should not see "Reports" in the ".secondary-navigation" "css_element"
    And I should not see "Question bank" in the ".secondary-navigation" "css_element"
    And I should not see "Content bank" in the ".secondary-navigation" "css_element"
    And I should not see "Course completion" in the ".secondary-navigation" "css_element"
    And I should not see "Badges" in the ".secondary-navigation" "css_element"
    And I should not see "Competencies" in the ".secondary-navigation" "css_element"
    And I should not see "Filters" in the ".secondary-navigation" "css_element"
    And I should not see "Accessibility toolkit" in the ".secondary-navigation" "css_element"
    And I click on "More" "link" in the ".secondary-navigation" "css_element"
    And I should see "Reports" in the ".secondary-navigation .dropdownmoremenu li:nth-of-type(1)" "css_element"
    And I should see "Question bank" in the ".secondary-navigation .dropdownmoremenu li:nth-of-type(2)" "css_element"
    And I should see "Content bank" in the ".secondary-navigation .dropdownmoremenu li:nth-of-type(3)" "css_element"
    And I should see "Course completion" in the ".secondary-navigation .dropdownmoremenu li:nth-of-type(4)" "css_element"
    And I should see "Badges" in the ".secondary-navigation .dropdownmoremenu li:nth-of-type(5)" "css_element"
    And I should see "Competencies" in the ".secondary-navigation .dropdownmoremenu li:nth-of-type(6)" "css_element"
    And I should see "Filters" in the ".secondary-navigation .dropdownmoremenu li:nth-of-type(7)" "css_element"
    And I should see "Accessibility toolkit" in the ".secondary-navigation .dropdownmoremenu li:nth-of-type(9)" "css_element"
