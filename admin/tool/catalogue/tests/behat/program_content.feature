...
Feature: Program content in the Learning catalogue plugin
  ...
  Scenario: User can navigate between sets and courses within the program
    ...
    # Check that program related alerts and tabs are not shown in sets.
    And I should not see "Information" in the "nav-tab" "region"
    And I should not see "##+1 year##Complete this program by '%d/%m/%y' to get the certification 'Certification 01'##" in the "[data-region='alert-dismissible']" "css_element"
    ...
    And I should not see "0% completed" in the "Course12" "tool_catalogue > Catalogue item"
    # Check content of Set2.
    And I click on "Program 01" "link" in the ".breadcrumb" "css_element"
    And I should see "Information" in the "nav-tab" "region"
    And I should see "##+1 year##Complete this program by '%d/%m/%y' to get the certification 'Certification 01'##" in the "[data-region='alert-dismissible']" "css_element"
    And I reload the page
    And I should see "Information" in the "nav-tab" "region"
    And I should see "##+1 year##Complete this program by '%d/%m/%y' to get the certification 'Certification 01'##" in the "[data-region='alert-dismissible']" "css_element"
  ...
  Scenario: User cannot see hidden courses
    ...
    And I click on "Program 01" "tool_catalogue > Catalogue item"
    And I click on "Proceed to program content" "button"
    Then I should not see "Mathematics"
    And I should see "Course not available"
    # User with permissions can see hidden courses with a badge.
    And I am on the "My courses" page logged in as "tenantadmin1"
    And I click on "Program 01" "tool_catalogue > Catalogue item"
    And I click on "Proceed to program content" "button"
    And I should see "Hidden from learners" in the "Mathematics" "tool_catalogue > Catalogue item"
  ...
  Scenario: User can see the recent accessed courses section
    ...
    # Collapse the 'Recently accessed courses' section and check that collapse status is saved.
    And I click on "[data-toggle='collapse']" "css_element" in the "Recently accessed courses" "tool_catalogue > Catalogue pagesection"
    And I should not see "Course11" in the "Recently accessed courses" "tool_catalogue > Catalogue pagesection"
    And I reload the page
    And I should not see "Course11" in the "Recently accessed courses" "tool_catalogue > Catalogue pagesection"
    And I click on "[data-toggle='collapse']" "css_element" in the "Recently accessed courses" "tool_catalogue > Catalogue pagesection"
    And I should see "Course11" in the "Recently accessed courses" "tool_catalogue > Catalogue pagesection"
    And I change window size to "tablet"
    # Reducing the screen size, less elements should be shown in the last accessed order.
    Then I should not see "Course11" in the "Recently accessed courses" "tool_catalogue > Catalogue pagesection"
    And I should see "Course12" in the "Recently accessed courses" "tool_catalogue > Catalogue pagesection"
    And I should see "Course14" in the "Recently accessed courses" "tool_catalogue > Catalogue pagesection"
    And I change window size to "mobile"
    # On mobile size screen, only the last accessed course should be shown.
    Then I should not see "Course11" in the "Recently accessed courses" "tool_catalogue > Catalogue pagesection"
    And I should not see "Course12" in the "Recently accessed courses" "tool_catalogue > Catalogue pagesection"
    And I should see "Course14" in the "Recently accessed courses" "tool_catalogue > Catalogue pagesection"

  Scenario: User can see correct course information
    Given the following "tool_program > programs" exist:
      | fullname   | tenant  | completioncriteria |
      | Program 02 | Tenant1 | 1                  |
    ...
    And I am on the "My courses" page
    # Check the completion percentages appear correctly only when completion is enabled
    And I should see "50% completed" in the "Course11" "tool_catalogue > Catalogue item"
    And I should see "0% completed" in the "Course12" "tool_catalogue > Catalogue item"
    And I should not see "% completed" in the "Course1" "tool_catalogue > Catalogue item"
    And I click on "Program 02" "tool_catalogue > Catalogue item"
    And I should see "50% completed" in the "Course11" "tool_catalogue > Recently accessed course card"
    And I should see "50% completed" in the "Course11" "tool_catalogue > Catalogue item"
    And I should see "0% completed" in the "Course12" "tool_catalogue > Recently accessed course card"
    And I should see "0% completed" in the "Course12" "tool_catalogue > Catalogue item"
    # TODO: the percentage should not appear in "Recently accessed courses" for courses with completion disabled WP-4103
    #And I should not see "% completed" in the "Course1" "tool_catalogue > Recently accessed course card"
    And I should not see "% completed" in the "Course1" "tool_catalogue > Catalogue item"
  ...
  Scenario: User preferences use their own permission checks
    ...
    And I click on "Program 01" "tool_catalogue > Catalogue item"
    And I click on "Proceed to program content" "button"
    Then "Information" "link" should exist in the "nav-tab" "region"
    And "Program" "link" should exist in the "nav-tab" "region"
