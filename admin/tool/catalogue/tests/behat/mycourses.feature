...
Feature: My courses page with the Learning catalogue plugin
  ...
  Background:
    ...
    And the following "courses" exist:
      | fullname                | shortname | enablecompletion | enddate      |
      | Non-program Course 01   | NPC001    | 1                | ##+2 days##  |
    ...
    And the following "tool_program > programs" exist:
      ...
      | Program 01  | Tenant1 | after_user_allocation | 2 weeks         |
  ...
  Scenario: User can see and filter programs and courses in the catalogue
    ...
    And I should see "Due in 13 days" in the "Program 01" "tool_catalogue > Catalogue item"
