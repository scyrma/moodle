...
class constants {
    ...
    /** @var string Never display */
    public const NEVER_DISPLAY = 0;
    /** @var string Display only for students and guest access */
    public const DISPLAY_ONLY_FOR_STUDENTS_AND_GUESTS = 1;
    /** @var string Display for everybody */
    public const DISPLAY_FOR_EVERYBODY = 2;
    /** @var string Display only for users who do not have admin/tenantadmin role */
    public const DISPLAY_ONLY_FOR_NOT_ADMIN = 3;
}
