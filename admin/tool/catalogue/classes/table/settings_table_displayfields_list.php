...
/**
 * Table with all available fields that can be displayed in the catalogue (list view)
 *
 ...
 */
class settings_table_displayfields_list extends settings_table_displayfields_base {
    /** @var string Name of the setting */
    protected $settingname = configuration::SETTING_DISPLAYFIELDS_LIST;
    ...
    protected function setup_fields() {
        ...
        $this->visiblefields = configuration::get_display_fields_list();
