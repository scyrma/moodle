...
/**
 * Table with all available fields that can be used in catalogue filters
 *
 ...
 */
class settings_table_filterfields extends settings_table_base {
    /** @var string Name of the setting */
    protected $settingname = configuration::SETTING_FILTERFIELDS;
    ...
    protected function setup_fields() {
        ...
        $this->visiblefields = configuration::get_filter_fields();
