...
class course_cover implements templatable, renderable {
    ...
    /** @var bool Cover shown in the course page */
    private $incourse;
     ...
     * @param bool $incourse
     */
    public function __construct(stdClass $course, bool $incourse = false) {
        $this->course = $course;
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $data->pagesectiondates->collapse = !$this->incourse;
        ...
        $data->pagesectiontrainers->collapse = !$this->incourse;
        $data->hasrestrictions = $coursedata->hasrestrictions;
        $data->restrictions = $coursedata->restrictions;
        // If the course covers has availability restrictions or is a course page, do not show the buttons.
        $data->hasbuttons = !($this->incourse || $data->hasrestrictions);
        $data->courseurl = course_get_url($this->course);
