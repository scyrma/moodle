 ...
 */
class my_courses implements renderable, named_templatable {
    ...
    public function export_for_template(renderer_base $output): stdClass {
        ...
        $template = (object)[];
        // It needs to diferenciate between catalogue/programcontent pages for course items.
    ...
    public function get_template_name(renderer_base $renderer): string {
        return 'tool_catalogue/mycourses/mycourses_page';
    }
}
