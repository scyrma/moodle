 ...
 */
class program_cover implements named_templatable, renderable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $related = [
            ...
            'allocations' => manager::get_user_allocations($this->userid, $this->program->get('id')),
        ];
        ...
        if ($data->startdateshow || $data->duedateshow || $data->enddateshow) {
    ...
    public function get_template_name(renderer_base $renderer): string {
        return 'tool_catalogue/mycourses/cover/program/program_cover';
    }
}
