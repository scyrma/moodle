...
class program_cover implements templatable, renderable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $related = [
            ...
            'allocations' => manager::get_user_allocations($this->program->get('id')),
        ];
        $exporter = new program_exporter($this->program, $related);
        ...
        if ($data->hashelp) {
            ...
            $data->helpurl = new moodle_url('https://moodle.org/help/my-index-program-cover');
