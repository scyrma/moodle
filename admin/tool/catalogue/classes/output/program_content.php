 ...
 */
class program_content implements named_templatable, renderable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        if (!empty($data->recentlyaccessedcourses)) {
            $data->pagesectionrecentlyaccessedcourses = (object) [];
            $iscollapsed = (bool) get_user_preferences('tool_catalogue_collapse_recently_accessed_courses', false);
            $data->pagesectionrecentlyaccessedcourses->collapse = $iscollapsed;
        }
        ...
        // On the UI all the sets on the base set are treated as base for the JS navigation.
    ...
    public function get_template_name(renderer_base $renderer): string {
        return 'tool_catalogue/mycourses/cover/program/program_content';
    }
}
