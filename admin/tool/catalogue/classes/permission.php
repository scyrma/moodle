...
class permission {
    ...
    /**
     * Check if user is allowed to configure catalogue
     *
     * @return bool
     */
    public static function can_configure_catalogue(): bool {
        $context = \context_system::instance();
        return has_capability('tool/catalogue:config', $context);
    }

    /**
     * Require to check if user is allowed to configure catalogue
     *
     * @throws \required_capability_exception
     */
    public static function require_can_configure_catalogue(): void {
        if (!self::can_configure_catalogue()) {
            throw new \required_capability_exception(\context_system::instance(),
                'tool/catalogue:config', 'nopermissions', '');
        }
    }
}
