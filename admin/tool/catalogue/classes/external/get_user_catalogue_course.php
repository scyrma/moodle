...
class get_user_catalogue_course extends external_api {
    ...
    public static function execute(int $courseid, int $userid = 0): array {
        ...
        // In this case we need to validate system context because we use this web service also to show course
        // when the user is not enroled and context_course would fail here.
