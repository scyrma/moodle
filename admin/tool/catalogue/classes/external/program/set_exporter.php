...
class set_exporter extends exporter {
    ...
    protected function get_other_values(renderer_base $output): array {
        ...
        $data['sortorder'] = $programitemset->get_persistent()->get('sortorder');
        ...
        $data['url'] = (string) router::build_program_set_url($program->get('id'), $programitemset->get_persistent()->get('id'));
