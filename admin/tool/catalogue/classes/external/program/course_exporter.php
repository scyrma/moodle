...
class course_exporter extends exporter {
    ...
    protected function get_other_values(renderer_base $output): array {
        ...
        $data['showprogress'] = $programitemcourse->hasprogress;
        $data['islocked'] = !$programitemcourse->isunlocked;
        $data['isenrolled'] = $programitemcourse->isenrolled;
        $data['image'] = $this->get_course_image_url();
        ...
        // If the user can view hidden courses then show the course with a badge.
        $data['showhiddencoursebadge'] = !$programitemcourse->get_course()->visible && $canviewhiddencourses;

        // If the call is from the web service we will add the given user last access to this course.
        $data['lastaccess'] = $this->related['course']->lastaccess ?? null;
