...
class course_exporter extends exporter {
    ...
    protected function get_other_values(renderer_base $output): array {
        ...
        $program = $programitemcourse->get_persistent()->get_program();
        if ($data['setid'] === $program->get_base_set()->get('id')) {
            $data['setid'] = 0;
        }
        ...
        if ($data['ishidden']) {
            ...
            $data['url'] = router::build_course_url((int) $this->related['course']->id);
        }
