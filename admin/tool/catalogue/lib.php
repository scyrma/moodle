...
function tool_catalogue_user_preferences() {
    ...
    $preferences['tool_catalogue_my_courses_filter'] = array(
        'null' => NULL_ALLOWED,
        'default' => null,
        'type' => PARAM_TEXT,
    );
    $preferences['tool_catalogue_my_courses_sort'] = array(
        'null' => NULL_ALLOWED,
        'default' => null,
        'type' => PARAM_TEXT,
    );
...
function tool_catalogue_before_footer(): string {
    ...
    if ($PAGE->course && $PAGE->course->id != SITEID && $PAGE->url->compare(new moodle_url('/course/view.php'), URL_MATCH_BASE)) {
