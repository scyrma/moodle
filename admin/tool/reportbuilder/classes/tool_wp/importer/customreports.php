...
class customreports extends importer_base {
    ...
    public function is_available(): bool {
        return !strlen($this->entrypoint) && permission::can_create(false);
    }
    ...
    public function add_to_options_form(import_settings_form $form): void {
        ...
        $mform->addElement('advcheckbox', self::IMPORT_CONTENT, null,
        ...
        $mform->addElement('advcheckbox', self::IMPORT_AUDIENCES, null, new \lang_string('audiences', 'tool_reportbuilder'));
        ...
        $mform->addElement('advcheckbox', self::IMPORT_SCHEDULES, null, new \lang_string('schedules', 'tool_reportbuilder'));
            ...
            foreach ($reports as $report) {
                $report
                    ...
                    ->set_validation_callback(function($data, wp_imported_entity $entity) {
                        ...
                        // Raise an error if the report source doesn't exist.
                    ...
                    ->set_import_callback(function($data, wp_imported_entity $entity) use ($excludefields) {
                        global $PAGE;
                    ...
                    foreach ($schedules as $schedule) {
                        $schedule
                            ...
                            ->set_import_callback(function($data, wp_imported_entity $entity) {
                                ...
                                $schedulerecord['recipients'] = json_encode($recipients);
