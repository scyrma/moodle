...
class course_selector extends filter_base {
    ...
    public function convert_condition_values(array $values, \core_reportbuilder\local\filters\base $newcondition): array {
        if ($newcondition instanceof \core_reportbuilder\local\filters\course_selector) {
            ...
            return [$newconditionname.'_values' => $operator];
        }

        // The datasource mapped this condition to something else, not "course_selector", so
