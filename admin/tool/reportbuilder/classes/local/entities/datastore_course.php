 ...
 */
class datastore_course extends entity_base {
    ...
    public function convert_get_entity_class(): string {
        return \tool_datastore\reportbuilder\local\entities\course::class;
    }
    ...
    protected function get_filters_or_conditions(bool $iscondition) : array {
        ...
        // Full name.
        list($sql, $params) = api::get_datasource_field_sql('course', 'fullname', $tablealias, null,
            \core_reportbuilder\local\report\column::TYPE_TEXT);
