...
class course_enrolment extends entity_base {
    ...
    public function convert_get_entity_class(): string {
        return \core_course\reportbuilder\local\entities\enrolment::class;
    }
    ...
    public function convert_get_filter_name(report_filter $oldfilter, \core_reportbuilder\datasource $newsource): string {
        if ($oldfilter->get_name() === 'method_filter') {
            return 'method';
        } else if ($oldfilter->get_name() === 'timecreated_filter') {
            return 'timecreated';
        } else if ($oldfilter->get_name() === 'timestarted_filter') {
            return 'timestarted';
        } else if ($oldfilter->get_name() === 'timeended_filter') {
            return 'timeended';
        } else if ($oldfilter->get_name() === 'status_filter') {
            return 'status';
        }
    ...
    public function convert_get_condition_name(report_filter $oldcondition, \core_reportbuilder\datasource $newsource): string {
        if ($oldcondition->get_name() === 'method_filter') {
            return 'method';
        } else if ($oldcondition->get_name() === 'timecreated_filter') {
            return 'timecreated';
        } else if ($oldcondition->get_name() === 'timestarted_filter') {
            return 'timestarted';
        } else if ($oldcondition->get_name() === 'timeended_filter') {
            return 'timeended';
        } else if ($oldcondition->get_name() === 'status_filter') {
            return 'status';
        }
        return parent::convert_get_filter_name($oldcondition, $newsource);
    }
    ...
    protected function get_filters_or_conditions(bool $iscondition) : array {
        ...
        $enrolmentmethods = function() {
            return array_map(function(\enrol_plugin $plugin) {
