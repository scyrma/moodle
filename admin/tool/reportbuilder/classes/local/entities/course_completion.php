...
class course_completion extends entity_base {
    ...
    public function convert_get_entity_class(): string {
        return \core_course\reportbuilder\local\entities\completion::class;
    }
    ...
    public function convert_get_column_name(report_column $oldcolumn, \core_reportbuilder\datasource $newsource): string {
        if ($oldcolumn->get_name() === 'progress') {
            return 'progresspercent';
        } else if ($oldcolumn->get_name() === 'daysenrolled') {
            return 'dayscourse';
        } else if ($oldcolumn->get_name() === 'requiredgrade') {
    ...
    public function convert_get_filter_name(report_filter $oldfilter, \core_reportbuilder\datasource $newsource): string {
        if ($oldfilter->get_name() === 'completed_filter') {
            return 'completed';
        } else if ($oldfilter->get_name() === 'timecompleted_filter') {
    ...
    public function convert_get_condition_name(report_filter $oldcondition, \core_reportbuilder\datasource $newsource): string {
        if ($oldcondition->get_name() === 'completed_filter') {
            return 'completed';
        } else if ($oldcondition->get_name() === 'timecompleted_filter') {
            return 'timecompleted';
        }
