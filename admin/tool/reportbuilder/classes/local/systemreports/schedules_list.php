...
class schedules_list extends system_report {
    ...
    protected function initialise() {
        ...
        $tenantid = database::generate_param_name();
    ...
    protected function set_columns() {
        ...
        $this->add_column((new report_column(
            ...
            ->set_is_default(true)
            ->add_attributes(['data-region' => 'tool_reportbuilder-toggle'])
    ...
    private function add_actions() {
        ...
        if (false) {
            ...
            $action = new report_action(new \moodle_url('#'), $icon, ['data-action' => 'duplicate', 'data-id' => ':id']);
            $this->add_action($action);
        }
