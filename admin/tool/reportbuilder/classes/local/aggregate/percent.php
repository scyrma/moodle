...
/**
 * Class containing the percent aggregation
 *
 * @package   tool_reportbuilder
 * @copyright 2019 Moodle Pty Ltd <support@moodle.com>
 * @author    2019, Alberto Lara Hernández <albertolara@moodle.com>
 ...
 * @license   Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class percent extends aggregation_base {
    /**
     * Get the SQL
     *
     * @param string $field
    ...
    public static function is_compatible(?int $dbtype) : bool {
        return in_array($dbtype, [constants::DB_TYPE_BOOLEAN]);
    }
    ...
    public static function get_displayname(): string {
        return get_string('aggregation_percent', 'tool_reportbuilder');
    }
