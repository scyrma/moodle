...
class filters extends external_api {
    /**
     * Parameters description for set_filter_parameters.
     *
     * @return external_function_parameters
     */
    public static function set_filter_parameters() {
        return new external_function_parameters(
            array(
                'reportid'  => new external_value(PARAM_INT, 'The report id to add the filter'),
                'filter' => new external_value(PARAM_RAW, 'The filter to set'),
                'value' => new external_value(PARAM_RAW, 'The filter value'),
                'operator' => new external_value(PARAM_INT, 'The filter operator ')
            )
        );
    }
    ...
    public static function reset_all(int $reportid) : string {
        ...
        $filterhelper = new filters_helper($params['reportid']);
    ...
    public static function reset_all_returns() {
        return new external_value(PARAM_RAW, 'If the filters has been reset');
    }
    ...
    public static function reset_filter_returns() {
        return new external_value(PARAM_RAW, 'If the filter has been reset');
    }
    ...
    public static function add_filter(int $reportid, string $filterkey) : array {
        ...
        filters_helper::add_filter($params['reportid'], $filter);
