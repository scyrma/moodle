...
use tool_reportbuilder\local\models\schedules as reportbuilder_schedule;
...
class provider implements
    ...
    public static function get_contexts_for_userid(int $userid): contextlist {
        ...
        if (reportbuilder::record_exists_select($select . ' AND type = 0', $params) or
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        // We need to get all reports that the user has created, or reports they have created schedules for.
        ...
        foreach (reportbuilder::get_records_select($select, $params) as $report) {
            ...
            if ($schedules = reportbuilder_schedule::get_records_select($select, [$report->get('id'), $user->id, $user->id])) {
     ...
     * @return void
     */
    protected static function export_schedules(context_system $context, array $contextpath, array $schedules) {
        $scheduledata = [];
