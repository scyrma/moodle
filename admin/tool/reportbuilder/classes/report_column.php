...
class report_column {
     ...
     * Set join.
     *
     * @deprecated please use \tool_reportbuilder\report_column::add_join instead
     *
     * @param string $join
     * @return report_column
     */
    public function set_join(?string $join) : report_column {
        debugging('This function is deprecated. Please use \tool_reportbuilder\report_column::add_join instead',
            DEBUG_DEVELOPER);
     ...
     *
     * @deprecated please use \tool_reportbuilder\report_column::set_is_sortable instead
     *
     * @param bool $sortenabled
     * @return report_column
     */
    public function set_is_sort_enabled(bool $sortenabled) : report_column {
        debugging('This function is deprecated. Please use \tool_reportbuilder\report_column::set_is_sortable instead',
            DEBUG_DEVELOPER);
