...
abstract class report_base {
     ...
     * @return void
     */
    public final function set_default_pagesize(int $defaultpagesize): void {
     ...
     * @return int
     */
    public final function get_default_pagesize(): int {
        return $this->defaultpagesize;
    }
     ...
     * @return array
     */
    public final function get_parameters(): array {
     ...
     * @return bool
     */
    public final function is_shared(): bool {
