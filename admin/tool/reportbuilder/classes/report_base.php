...
abstract class report_base {
     ...
     *
     * @deprecated please use \tool_reportbuilder\local\helpers\columns::get_available_columns instead
     *
    ...
    public final function get_columns_select(array $columnsinuse) : array {
        debugging('This function is deprecated. ' .
            'Please use \tool_reportbuilder\local\helpers\columns::get_available_columns instead', DEBUG_DEVELOPER);

        return columns_helper::get_available_columns($this);
    }
     ...
     */
    public final function get_filter(string $uniqueidentifier) : ?report_filter {
     ...
     *
     * @deprecated please use \tool_reportbuilder\local\helpers\filters::get_available_filters instead
     *
    ...
    public final function get_filters_select($filtersinuse) {
        debugging('This function is deprecated. ' .
            'Please use \tool_reportbuilder\local\helpers\filters::get_available_filters instead', DEBUG_DEVELOPER);

        return filters_helper::get_available_filters($this, $filtersinuse);
    }

    /**
     * Get the conditions for a select form control.
     *
     * @deprecated please use \tool_reportbuilder\local\helpers\conditions::get_available_conditions instead
     *
    ...
    public final function get_conditions_select($conditionsinuse) {
        debugging('This function is deprecated. ' .
            'Please use \tool_reportbuilder\local\helpers\conditions::get_available_conditions instead', DEBUG_DEVELOPER);

        return conditions_helper::get_available_conditions($this, $conditionsinuse);
    }
     ...
     * @return null|report_filter
     */
    public final function get_condition(string $uniqueidentifier) : ?report_filter {
     ...
     *
     * @deprecated The actions header is always show to screen readers
     *
     * @param bool $status
     * @return void
     */
    public final function set_show_actions_header(bool $status) {
        debugging('This function is deprecated. The actions header is always shown to screen readers', DEBUG_DEVELOPER);
    }
     ...
     */
    public final function get_active_columns(): array {
     ...
     */
    public final function get_active_filters(): array {
        self::$configreset += [$this->get_id() => 0];
     ...
     */
    public final function get_active_conditions(): array {
        self::$configreset += [$this->get_id() => 0];
     ...
     * @return bool
     */
    public final function set_sort_preferences(array $preferences): bool {
        $name = 'flextable_' . $this->get_report_uniqid();

        return set_user_preference($name, json_encode(['sortby' => $preferences]));
    }
     ...
     * @return array
     */
    public final function get_sort_preferences(): array {
        $name = 'flextable_' . $this->get_report_uniqid();
     ...
     * @param int $reportid
     */
    public static final function report_configuration_modified(int $reportid) {
