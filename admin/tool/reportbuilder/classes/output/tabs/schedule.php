...
class schedule extends tab {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        $schedules = system_report_factory::create(schedules_list::class, ['reportid' => $report->get_id()]);
        ...
        return array_merge($data, ['reportid' => $report->get_id()]);
    }
