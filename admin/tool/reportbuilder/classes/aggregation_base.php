...
abstract class aggregation_base {
     ...
     * @return string
     */
    abstract public static function get_shortname(): string;
     ...
     * @return string
     */
    abstract public static function get_field(string $field, ?int $dbtype = null): string;
     ...
     * @return bool
     */
    abstract public static function is_compatible(?int $dbtype): bool;
}
