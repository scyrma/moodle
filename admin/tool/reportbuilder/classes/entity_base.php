...
abstract class entity_base {
     ...
     * @return array
     */
    protected abstract function get_default_table_aliases(): array;
     ...
     * @return \lang_string
     */
    protected abstract function get_default_entity_title(): \lang_string;
     ...
     * @return string
     */
    protected abstract function get_default_entity_name(): string;
     ...
     */
    public abstract function add_to_report();
