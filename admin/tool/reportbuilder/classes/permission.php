...
class permission {
    ...
    public static function can_view_all_schedules_list(): bool {
        return self::has_edit_capability() && !sharedspace::is_shared_space();
    }
    ...
    public static function can_create_schedule(?report_base $report = null): bool {
        return self::has_edit_capability() && (is_null($report) || self::can_edit($report)) && !sharedspace::is_shared_space();
    }
