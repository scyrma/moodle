...
use tool_reportbuilder\local\entities\datastore_course as datastore_course_entity;
use tool_reportbuilder\local\entities\datastore_user as datastore_user_entity;
...
class report_course_completion extends \tool_reportbuilder\datasource {
    ...
    public function convert_get_datasource_class(): string {
        return \tool_datastore\reportbuilder\datasource\course_completion::class;
    }
    ...
    public function convert_get_entity_name(string $oldentityname, \core_reportbuilder\datasource $newsource): string {
        if ($oldentityname === 'tool_datastore_course_completion') {
            return 'completion';
        } else if ($oldentityname === 'tool_datastore_course') {
            return 'datastorecourse';
        } else if ($oldentityname === 'tool_datastore_user') {
    ...
    protected function set_columns() {
        ...
        foreach ($completionfields as $field) {
            list($sql, $params) = api::get_datasource_field_sql('course_completion', $field, $maintablealias, null,
                \core_reportbuilder\local\report\column::TYPE_TIMESTAMP);
