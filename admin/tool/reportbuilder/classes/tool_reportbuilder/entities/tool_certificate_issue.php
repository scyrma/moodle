...
/**
 * File for tool_certificate_issue entity class
 *
 ...
 * @license   Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class tool_certificate_issue extends entity_base {
    ...
    public function convert_get_entity_class(): string {
        return \tool_certificate\reportbuilder\local\entities\issue::class;
    }
    ...
    protected function get_default_entity_title(): \lang_string {
        return new \lang_string('entitycertificateissue', 'tool_reportbuilder');
    }
    ...
    protected function get_all_columns(): array {
        ...
        $newcolumn = (new report_column(
            ...
            ->add_callback([self::class, 'userdatenever'])
            ->add_aggregation_callback('min', [self::class, 'userdatenever'])
            ->add_aggregation_callback('max', [self::class, 'userdatenever']);
        $columns[] = $newcolumn;
    ...
    /**
     * Displays userdate column and never when empty.
     *
     ...
     * @return string
     */
    public static function userdatenever(?int $value, stdClass $row, ?string $format = null): string {
        return empty($value)
            ? get_string('never', 'tool_reportbuilder')
            : format::userdate($value, $row, $format);
    }
}
