...
class allusers extends audience_base {
    ...
    public function convert_get_audience_class(): string {
        return \core_reportbuilder\reportbuilder\audience\allusers::class;
    }
    ...
    public function user_can_add(): bool {
        $hasviewalldetailscap = has_capability('moodle/user:viewalldetails', context_system::instance());

        // From shared space we can browse users from all tenants.
        if (sharedspace::is_shared_space()) {
            return $hasviewalldetailscap && \tool_tenant\permission::can_browse_users_anywhere();
        }

        return $hasviewalldetailscap && \tool_tenant\permission::can_browse_users(tenancy::get_tenant_id());
    }
