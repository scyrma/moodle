...
class external extends external_api {
    ...
    public static function delete_report_filter($reportid, $filterid) {
        ...
        $availablefilters = filters_helper::get_available_filters($report, $filtersinuse);
    ...
    public static function remove_report_column($reportid, $columnid) {
        ...
        // Update number of card view setting 'visible columns' if needed.
        columns_helper::update_visible_columns($report);
    ...
    public static function reorder_sortable_column_parameters() {
        return new external_function_parameters(
            array(
                'reportid'       => new external_value(PARAM_INT, 'The report ID'),
                'columnsinorder' => new external_value(PARAM_RAW, 'JSON encoded columns ordered by ID')
            )
        );
    }
     ...
     * @throws \restricted_context_exception
     */
    public static function reorder_sortable_column($reportid, $columnsinorder) {
