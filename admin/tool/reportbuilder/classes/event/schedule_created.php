...
/**
 * Report builder schedule created event class.
 *
 * @package   tool_reportbuilder
 * @copyright 2019 David Matamoros <davidmc@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class schedule_created extends \core\event\base {
     ...
     */
    public static function create_from_object(schedules $schedule): schedule_created {
        $eventparams = [
    ...
    public static function get_name() {
        return get_string('eventreportschedulecreated', 'tool_reportbuilder');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created a schedule in reportbuilder with id '$this->objectid'.";
    }
}
