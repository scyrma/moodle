...
class report_created extends \core\event\base {
     ...
     */
    public static function create_from_object(reportbuilder $reportbuilder): report_created {
        $eventparams = [
    ...
    public static function get_name() {
        return get_string('eventreportcreated', 'tool_reportbuilder');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the reportbuilder with id '$this->objectid'.";
    }
}
