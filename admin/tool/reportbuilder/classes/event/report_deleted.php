...
class report_deleted extends \core\event\base {
     ...
     */
    public static function create_from_object(reportbuilder $reportbuilder): report_deleted {
        $eventparams = [
    ...
    public static function get_name() {
        return get_string('eventreportdeleted', 'tool_reportbuilder');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the reportbuilder with id '$this->objectid'.";
    }
}
