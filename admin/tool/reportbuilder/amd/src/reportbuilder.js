    ...
    function($,
        ...
        ReportBuilder.prototype._registerEventListeners = function() {
            ...
            this.onDelegateEvent('hidden.bs.collapse', '#columns', function() {
                // TODO tested?
                this.find(SELECTORS.TOGGLECOLUMNS).find('i').removeClass('fa-chevron-left');
                this.find(SELECTORS.TOGGLECOLUMNS).find('i').addClass('fa-chevron-right');
            }.bind(this));

            this.onDelegateEvent('shown.bs.collapse', '#columns', function() {
                this.find(SELECTORS.TOGGLECOLUMNS).find('i').removeClass('fa-chevron-right');
                this.find(SELECTORS.TOGGLECOLUMNS).find('i').addClass('fa-chevron-left');
            }.bind(this));
