...
define([
    ...
    function($, Ajax, Templates, Notification, Events, SortableList, PubSub, Config, Fragment) {
         ...
         * @private
         */
        Table.prototype._handleTableSorting = function(e) {
            e.preventDefault();
         ...
         * @private
         */
        Table.prototype._handleTableReset = function(e) {
            e.preventDefault();
            let data = $(e.currentTarget).data();
         ...
         * @private
         */
        Table.prototype._initTableSorting = function() {
            $('body')
                .on('click', SELECTORS.CUSTOMREPORT + ' ' + SELECTORS.SORTTABLE, e => {
                    this._handleTableSorting(e);
                })
                .on('click', SELECTORS.CUSTOMREPORT + ' ' + SELECTORS.RESETTABLE, e => {
