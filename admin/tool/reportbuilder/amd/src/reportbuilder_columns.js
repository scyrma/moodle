...
define([
    ...
    function(
         ...
         * @private
         */
        Columns.prototype._makeDraggable = function() {
            var params = {
                cancel: "a.ui-icon",
                revert: "invalid",
            ...
            this.reportBuilder.find(SELECTORS.COLUMNS + ' ' + SELECTORS.COLUMNDRAGGABLE).draggable(params);

            // Delegate to all elements that can be added to the page in the future (during tab reload or viewmode switch).
            $(document).on('DOMNodeInserted', function(e) {
                $(e.target).find(SELECTORS.COLUMNS + ' ' + SELECTORS.COLUMNDRAGGABLE).draggable(params);
            });
        };
