...
echo $output->header();
$corerburl = new moodle_url('/reportbuilder/index.php');
echo $OUTPUT->notification(get_string('warningonlegacypage', 'tool_reportbuilder') . ' ' .
    html_writer::link($corerburl, get_string('gotocorerb', 'tool_reportbuilder')), 'error', false);
