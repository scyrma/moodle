...
Feature: Manage report builder schedules
  ...
  Scenario: Create a report schedule
    ...
    And I set the visible field "Report" to "Report1"
    And I press "Save" in the modal form dialogue
  ...
  Scenario: Edit a report schedule
    ...
    And I set the visible field "Schedule name" to "My new schedule name"
    And I press "Save" in the modal form dialogue
  ...
  Scenario: Filter schedules table by schedule name filter
    ...
    And I press key "13" in the field "Schedule name value"
