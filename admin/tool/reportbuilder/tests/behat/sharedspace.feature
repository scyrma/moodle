...
Feature: Shared space in reportbuilder
  ...
  Scenario: Creating and viewing reports in shared space as administrator
    ...
    And I set the visible field "Report name" to "SharedReport"
    ...
    And "New schedule" "button" should exist
  ...
  Scenario: Report not shared should not show up in subtenants
    ...
    And I navigate to "Report builder" in workplace launcher
    And I follow "New report"
    And I set the visible field "Report name" to "ReportNotShared"
    And I set the visible field "Report source" to "Users list"
  ...
  Scenario: Using Course enrolment and completion datasource with courses on different tenants
    ...
    And I navigate to "Report builder" in workplace launcher
    And I follow "New report"
    And I set the visible field "Report name" to "SharedCourseEnrolment"
    And I set the visible field "Report source" to "Course enrolment and completion"
    And I press "Save" in the modal form dialogue
