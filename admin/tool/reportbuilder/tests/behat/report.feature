...
Feature: Manage a report
  ...
  Scenario: Edit report when live display of data is disabled by site administrator
    ...
    And I click on "Add field 'Last name' to the report" "button"
  ...
  Scenario: Add a new column to the report
    ...
    # Add field.
    And I click on "Add field 'Last name' to the report" "button"
    And I should see "Last name" in the "report-table" "table"
    And I should not see "Add a column to the report"
    And I click on "Show/hide filters sidebar" "button"
    And I should see "Last name" in the "region-report-sorting" "region"
    And I log out
  ...
  Scenario: Search for a report column to add
    ...
    And I navigate to "Reports > Report builder - outdated version > Manage custom reports" in site administration
    And I click on "Edit content" "link" in the "Report1" "table_row"
    And I search for "Last name" in aside
    Then I should see "Last name" in the "[data-region='aside-search-area']" "css_element"
  ...
  Scenario: Change the table sorting by heading
    ...
    And I click on "Last name" "link" in the "report-table" "table"
    ...
    # Add filter
    And I click on "Show/hide filters sidebar" "button"
    And I set the field "Last name field limiter" to "is empty"
