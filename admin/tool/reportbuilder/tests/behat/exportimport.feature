...
Feature: Export and import custom reports
  ...
  Scenario: Export a custom report
    ...
    And I press key "27" in the field "Custom reports"
    And I press "Next"
    ...
    And I click on "View export" "link" in the "Custom reports" "table_row"
  ...
  Scenario: Import a custom report into current tenant
    ...
    And I press key "27" in the field "Custom reports"
    And I press "Next"
    And I should see "Some positions do not exist"
    And I should see "Some departments do not exist"
    ...
    And I run all adhoc tasks
    And I click on "Close" "link_or_button"
    And I click on "View import" "link" in the "Custom reports" "table_row"
    Then I should see "Success" in the "Status" "table_row"
    And I should see "Instances (1)"
    And I should see "Course completion" in the "[data-region=\"exportimport-instances\"]" "css_element"
    ...
    And I should see "Couldn't import audience record"
    And I should see "Couldn't import schedule record"
    ...
    And the following should exist in the "report-table" table:
      ...
      | Course completion | Report builder | ##today##j/m/y## | ##today##j/m/y## | Tenantadmin 1 |
  ...
  Scenario: Import a custom report into different tenant
    ...
    And the following should exist in the "report-table" table:
      | Report name       | Plugin         | Created          | Last modified    | Modified by |
      | Course completion | Report builder | ##today##j/m/y## | ##today##j/m/y## | Admin User  |
