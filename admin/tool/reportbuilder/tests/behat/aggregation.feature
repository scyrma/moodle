...
Feature: Manage report builder aggregations
  ...
  Scenario: Aggregate a column with type "number"
    ...
    # Check the type of field "number" can aggregate by Comma separate distinct values.
    And I click on "Select an aggregation for the column 'Phone'" "link"
    And I set the field "New aggregation for the column 'Phone'" to "Comma separate distinct values"
    And I should see "101" in the "Department 1" "table_row"
    And I should see "102" in the "Department 1" "table_row"
  ...
  Scenario: Aggregate a column with type "text"
    ...
    # Check the type of field "text" can aggregate by Comma separate distinct values.
    And I click on "Select an aggregation for the column 'Country'" "link"
    And I set the field "New aggregation for the column 'Country'" to "Comma separate distinct values"
    And I should see "Spain" in the "Department 1" "table_row"
    And I should see "Australia" in the "Department 2" "table_row"
    And I should see "France" in the "Department 2" "table_row"
  ...
  Scenario: Aggregate a column with type "boolean"
    ...
    And I set the field "New aggregation for the column 'Registration confirmed'" to "Count unique"
    And I click on "Select an aggregation for the column 'Registration confirmed'" "link"
    And I set the field "New aggregation for the column 'Registration confirmed'" to "Comma separate values"
    And I click on "Select an aggregation for the column 'Registration confirmed'" "link"
    And I set the field "New aggregation for the column 'Registration confirmed'" to "Comma separate distinct values"
    And I click on "Select an aggregation for the column 'Registration confirmed'" "link"
    And I set the field "New aggregation for the column 'Registration confirmed'" to "Minimum"
    And I click on "Select an aggregation for the column 'Registration confirmed'" "link"
    And I set the field "New aggregation for the column 'Registration confirmed'" to "Maximum"
    And I click on "Select an aggregation for the column 'Registration confirmed'" "link"
    And I set the field "New aggregation for the column 'Registration confirmed'" to "Unique values"
    And I click on "Select an aggregation for the column 'Registration confirmed'" "link"
    And I set the field "New aggregation for the column 'Registration confirmed'" to "Percentage"
    And I click on "Add field 'Country' to the report" "button"
    ...
    # TODO
  @javascript
  Scenario: Aggregate a user custom field
  ...
  Scenario: Aggregate a fullname column (special column)
    ...
    #Test Comma separate distinct values separates values
    And I click on "Select an aggregation for the column 'Full name'" "link"
    And I set the field "New aggregation for the column 'Full name'" to "Comma separate distinct values"
    # TODO: PENDING only check that not fail.
    And I click on "Add field 'Country' to the report" "button"
  ...
  Scenario: Aggregate a course custom fields
    ...
    And I click on "Select an aggregation for the column 'Field 1'" "link"
    And I set the field "New aggregation for the column 'Field 1'" to "Comma separate distinct values"
    And I click on "Select an aggregation for the column 'Field 1'" "link"
    ...
    And I click on "Select an aggregation for the column 'Field 2'" "link"
    And I set the field "New aggregation for the column 'Field 2'" to "Comma separate distinct values"
    And I click on "Select an aggregation for the column 'Field 2'" "link"
    ...
    And I click on "Select an aggregation for the column 'Field 3'" "link"
    And I set the field "New aggregation for the column 'Field 3'" to "Comma separate distinct values"
    And I click on "Select an aggregation for the column 'Field 3'" "link"
    ...
    And I click on "Select an aggregation for the column 'Field 5'" "link"
    And I set the field "New aggregation for the column 'Field 5'" to "Comma separate distinct values"
    And I click on "Select an aggregation for the column 'Field 5'" "link"
