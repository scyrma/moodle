 ...
 */
class tool_reportbuilder_upgradelib_testcase extends advanced_testcase {
    ...
    public function test_upgrade_create_schedule_with_audiences(): void {
        ...
        $oldschedule = $this->create_old_schedule([
            ...
            'positionid' => $position->id,
            'departmentid' => $department->id,
            'recipients' => json_encode(['users' => [$user1->id]]),
        ...
        $this->assertEqualsCanonicalizing([
            ...
            (object)[
                ...
                'configdata' => json_encode(['users' => [$user1->id]]),
            ],
        ], $audiences);
        ...
        $this->assertEquals($schedule->id, $id);
     ...
     * @return stdClass
     */
    public function create_old_schedule($record): stdClass {
        global $USER;
