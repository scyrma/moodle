...
class manual_test extends advanced_testcase {
    ...
    public function test_convert_to_core_reportbuilder(): void {
        ...
        $this->get_generator()->audience_test_convert_to_core_reportbuilder(manual::class, $this);
    }
    ...
    public function test_convert_to_core_reportbuilder_config(): void {
        ...
        $this->assertEquals(json_encode(['users' => [$user1->id, $user2->id]]), $newaudience->get('configdata'));
