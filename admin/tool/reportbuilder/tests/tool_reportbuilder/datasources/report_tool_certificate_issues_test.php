...
/**
 * File containing tests for report_tool_certificate_issues datasource
 *
...
/**
 * Tests for the datasource report_tool_certificate_issues
 *
 * @package     tool_reportbuilder
 * @covers      \tool_reportbuilder\tool_reportbuilder\datasources\report_tool_certificate_issues
 * @copyright   2019 Moodle Pty Ltd <support@moodle.com>
 * @author      2019 Daniel Neis Araujo <danielneis@gmail.com>
 * @license     Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class report_tool_certificate_issues_test extends advanced_testcase {
    ...
    public function setUp(): void {
        $this->resetAfterTest();
        /** @var \tool_certificate_generator $certgenerator */
        $certgenerator = self::getDataGenerator()->get_plugin_generator('tool_certificate');
    ...
    protected function create_report(int $tenantid, bool $adddefault): int {
        return $this->get_reportbuilder_generator()->create_report([
            'source' => report_tool_certificate_issues::class,
            'tenantid' => $tenantid,
    ...
    public function test_stress_aggregation(): void {
        ...
        // Create a report from the issued certificates datasource without default columns/conditions.
    ...
    public function test_convert_to_core_reportbuilder(): void {
        ...
        $this->get_reportbuilder_generator()->datasource_test_convert_to_core_reportbuilder(
            report_tool_certificate_issues::class, $this);
    }
}
