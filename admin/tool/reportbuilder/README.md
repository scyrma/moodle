...
# How to define datasouce in a plugin

To add a new datasource that will be available as a source when creating custom report,
...
Datasource allows to build a custom SQL query and define how to format data in the table.
...
even if there are several elements using it. JOIN will not be added if the column/condition was not added or
