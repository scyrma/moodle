...
$functions = [
    ...
    'tool_reportbuilder_get_columns' => [
        ...
        'classpath' => '',
        'description' => 'DEPRECATED: Get the columns of the report (active and not active) with the status no be added',
        'ajax' => true,
        'type' => 'read'
    ],
    'tool_reportbuilder_reset_all' => [
        ...
        'classpath' => '',
        'description' => 'DEPRECATED: Reset all filters for a report and user',
        'ajax' => true,
        'type' => 'read'
    ],
    ...
    'tool_reportbuilder_reset_table_heading_sort' => [
        'classname' => tool_reportbuilder\external\columns::class,
        'methodname' => 'reset_table_heading_sort',
        'classpath' => '',
        'description' => 'DEPRECATED: Reset table preferences',
        'ajax' => true,
        'type' => 'write'
    ],
