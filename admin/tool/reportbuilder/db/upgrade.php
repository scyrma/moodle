...
function xmldb_tool_reportbuilder_upgrade($oldversion) {
    ...
    if ($oldversion < 2019052801) {
        // This step has been removed in 4.0, we no longer want to create the tool_reportbuilder_manager role.
    ...
    if ($oldversion < 2022091301) {
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2022091301, 'tool', 'reportbuilder');
    }

    if ($oldversion < 2022092900) {
        // Schedule ad-hoc task to convert reports from tool_reportbuilder to core_reporbuilder.
        $record = new \stdClass();
        $record->classname = '\tool_reportbuilder\task\convert_all_possible_reports';
        $record->component = 'tool_reportbuilder';
        ...
        // Reportbuilder savepoint reached.
        upgrade_plugin_savepoint(true, 2022092900, 'tool', 'reportbuilder');
    }
