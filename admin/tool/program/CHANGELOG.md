...
## 4.3 - 2023-11-09
### Changed
- The deprecated method api::get_program_pattern() has been removed.

## 4.2.2 Rolling - 2023-08-22
### Changed
- New external method `tool_program_allocate_users` for allocating users to programs
- The api method get_program_pattern has been deprecated.
