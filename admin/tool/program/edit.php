...
permission::require_check_access_to_program($program);
...
if (!permission::can_edit_details($program) && permission::can_edit_details_in_program_tenant($program)) {
    $redirect = new moodle_url('/admin/tool/tenant/switchtenant.php', [
        'switchtenantid' => $program->get('tenantid'),
        'redirecturl' => $editprogramurl->out_as_local_url(false),
        'sesskey' => sesskey(),
    ]);
