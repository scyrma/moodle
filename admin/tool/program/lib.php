...
/**
 * Fragment to reload users list in program manager.
 *
 * @deprecated Please use Report Builder ReportEvents.RELOADTABLE to reload tables.
 *
 * @param array $args
 * @return string
 */
function tool_program_output_fragment_programs_manager_users_list(array $args) {
    debugging('This function is deprecated. Please use ReportBuilder ReportEvents.RELOADTABLE instead.', DEBUG_DEVELOPER);
    ...
    if (class_exists('\\tool_reportbuilder\\system_report_factory')) {
        // Users list.
        $report = system_report_factory::create(allocations_report::class, ['id' => $programid]);
