...
$functions = [
    ...
    'tool_program_potential_program_selector' => [
        'classname' => tool_program\external::class,
        'methodname' => 'potential_program_selector',
        'description' => 'Search list of programs',
        'type' => 'read',
        'ajax' => true,
    ],
    'tool_program_get_user_learning_statuses' => [
        ...
        'classname' => tool_program\external::class,
        'methodname' => 'get_user_learning_statuses',
        'description' => 'Returns the list of programs and' .
            ' certifications for a user and the current status in each one',
        'type' => 'read',
    ],
    'tool_program_bulk_deallocate_user' => [
        'classname' => tool_program\external::class,
        'methodname' => 'bulk_deallocate_user',
        'description' => 'Deallocates a list of users from a program',
        'type' => 'write',
        'ajax' => true,
    ],
    'tool_program_bulk_reset_program_progress' => [
        'classname' => tool_program\external::class,
        'methodname' => 'bulk_reset_program_progress',
        'description' => 'Resets a program progress for a list of users',
        'type' => 'write',
        'ajax' => true,
    ],
    ...
    'tool_program_recalculate_program_user_completions' => [
        'classname' => tool_program\external\recalculate_program_user_completions::class,
        'description' => 'Recalculate program user completions',
        'type' => 'write',
        'ajax' => true,
    ],
];
