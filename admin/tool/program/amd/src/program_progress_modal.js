...
define([
    ...
    'core/modal_events',
    'core/str'
], function($, Fragment, Notification, ModalFactory, ModalEvents, Str) {
    return {
        init: function() {
            const showProgressModal = function(showProgressModalevent) {
                const title = Str.get_string('progressoverviewfor', 'tool_program', showProgressModalevent.dataset.userfullname);
