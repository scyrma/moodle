...
define([
     ...
     */
    var confirmResetProgramProgress = function(programid, programuserid, contextid) {
        str.get_strings([
            {'key': 'resetprogress', component: 'tool_program'},
            {'key': 'confirmresetprogress', component: 'tool_program'},
            {'key': 'yes'},
            {'key': 'no'}
        ]).done(function(s) {
    ...
    return {
        ...
        init: function() {
            ...
            $editProgramUserList.on('click', '.confirm_reset_completion', function(e) {
                e.preventDefault();
                confirmResetProgramProgress($(e.currentTarget).data('id'), $(e.currentTarget).data('programuserid'), contextid);
            });
            // Deallocate user.
