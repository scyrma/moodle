...
/**
 * Class tool_program\event\program_course_updated
 *
 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class program_course_updated extends base {
     ...
     * @return self|base
     */
    public static function create_from_program_course_updated(program_course $programcourse, int $programid): self {
    ...
    public static function get_name(): string {
        return get_string('eventcourseupdated', 'tool_program');
    }
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' updated " .
            ...
            "within the program set '" . $this->other['setid'] . "'.";
    }
