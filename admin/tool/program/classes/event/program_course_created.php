...
/**
 * Class tool_program\event\program_course_created
 *
 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class program_course_created extends base {
     ...
     * @return self|base
     */
    public static function create_from_program_course_created(program_course $programcourse, int $programid): self {
    ...
    public static function get_name(): string {
        return get_string('eventcourseadded', 'tool_program');
    }
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' added " .
            "to the program set '" . $this->other['setid'] . "' " .
