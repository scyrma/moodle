...
/**
 * Class tool_program\event\user_allocation_deleted
 *
...
class user_allocation_deleted extends base {
     ...
     * @return self|base
     */
    public static function create_from_user_allocation_deleted(program_user $programuser): self {
    ...
    public static function get_name(): string {
        return get_string('eventuserdeallocated', 'tool_program');
    }
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' deallocated " .
            ...
            "from program with id '" . $this->other['programid'] . "'.";
    }
