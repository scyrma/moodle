...
/**
 * Class tool_program\event\program_deleted
 *
...
class program_deleted extends base {
     ...
     *
     * @param program $program The program deleted.
     * @return self|base
     */
    public static function create_from_program_deleted(program $program): self {
        if (!$program->get('id')) {
    ...
    public static function get_name(): string {
        return get_string('eventprogramdeleted', 'tool_program');
    }
