...
/**
 * tool_program\event\user_allocation_updated
 *
...
class user_allocation_updated extends base {
     ...
     *
     * @param program_user $programuser The user program.
     * @return self
     */
    public static function create_from_user_allocation_updated(program_user $programuser) {
    ...
    public static function get_name(): string {
        return get_string('eventuserupdated', 'tool_program');
    }
    ...
    public function get_description(): string {
        return "The allocation for user id '$this->relateduserid' on the program with id '" .
            $this->other['programid'] . "' got updated.";
    }
