...
/**
 * File for class tool_program\event\program_set_completed
 *
...
/**
 * Class tool_program\event\program_set_completed
 *
 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class program_set_completed extends base {
     ...
     * @return self|base
     */
    public static function create_from_program_set_completed(program_set_completion $setcompletion, int $programid): self {
    ...
    public static function get_name(): string {
        return get_string('eventsetcompleted', 'tool_program');
    }
    ...
    public function get_description(): string {
        return "The user with id '$this->relateduserid' completed " .
            "the set with id '" . $this->other['setid'] . "'.";
    }
