...
class program extends base {
    ...
    protected function get_all_columns(): array {
        ...
        $column = (new column(
            ...
            ->set_is_sortable(true)
            ->set_groupby_sql("{$tablealias}.id");
        // TODO WP-3147 check if this is needed.
        if ($ismssql) {
        ...
        // TODO WP-3147 Associatedcertificationswithlink column.
    ...
    protected function get_all_filters(): array {
        ...
        // TODO WP-3147 Tags filter. Is not currently in core_reportbuilder.
