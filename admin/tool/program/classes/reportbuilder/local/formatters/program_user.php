...
class program_user {
     ...
     * @return string
     */
    public static function programstatus(?int $value, ?stdClass $row): string {
        ...
        $statuses = api::get_user_allocation_statuses((int)$row->programid, (int)$row->userid, (int)$row->certificationid);
        $statuseshtml = [];
    ...
    public static function programprogressoverviewlink(?string $value, stdClass $row): string {
        ...
        $userprogramurl = new moodle_url('/admin/tool/program/programprogress.php', [
            'programid' => $programid,
            'userid' => $userid,
        ]);
    ...
    public static function programprogress($value, stdClass $row): string {
        ...
        $programtreeprogress = new program_tree_progress(new program((int) $row->programid), (int) $row->userid);
