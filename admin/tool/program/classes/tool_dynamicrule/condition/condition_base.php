...
/**
 * This file contains the base class for program conditions.
 *
...
abstract class condition_base extends \tool_dynamicrule\condition_sql {
    ...
    public function validate_config_form(array $data): array {
        ...
        if (!permission::can_edit_dynamicrule_condition(new program($data['programid']))) {
    ...
    public function is_configuration_valid(): bool {
        return program::record_exists($this->get_programid()) &&
            !$this->get_program()->is_archived();
    }
    ...
    public function user_can_edit(array $configdata): bool {
        ...
        return permission::can_edit_dynamicrule_outcome($program);
    }
