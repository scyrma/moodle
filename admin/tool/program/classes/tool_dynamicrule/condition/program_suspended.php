...
/**
 * Class for program suspended dynamic rules' condition.
 *
 ...
 */
class program_suspended extends condition_base {
    /**
    ...
    public function get_title(): string {
        return get_string('conditionprogramsuspended', 'tool_program');
    }
    ...
    public function get_config_form(MoodleQuickForm $mform): void {
        ...
        // Optional date field.
        $dateisonorafterstr = get_string('suspendeddateonorafter', 'tool_program');
    ...
    public function get_sql(): array {
        ...
        $pro = database::generate_alias();
        $pse = database::generate_alias();
        ...
        // If date enabled, check that user was suspended on or after the chosen date.
        if ($this->get_conditiondateenabled()) {
            $where .= " AND {$pu}.timesuspended >= " . $this->get_conditiondate();
        }
    ...
    public function get_description(): string {
        ...
        if ($this->get_conditiondateenabled()) {
            ...
            $description = get_string('conditionprogramsuspendeddescriptionwithdate', 'tool_program', $options);
        } else {
            $description = get_string('conditionprogramsuspendeddescription', 'tool_program', $fullname);
        }
     ...
     *
     * @param \tool_dynamicrule\outcome_base $calleroutcome
     * @return array
     */
