...
use tool_program\tool_dynamicrule\outcome\outcome_base;
...
class user_not_allocated extends condition_base {
    ...
    public function get_sql(): array {
        ...
        $join = "LEFT JOIN {tool_program_users} {$pu} ".
            "ON (".
            "{$pu}.userid = u.id AND {$pu}.programid = :{$programid}".
            " AND {$pu}.startdate <= :{$now1}".
