        ...
        foreach ($keys as $key) {
            switch ($key) {
                case 'programid':
                    ...
                    break;
                case 'programname':
                    $data[$key] = format_string($program->get('fullname'));
                    break;
                case 'programcompletedcourses':
                    $data[$key] = $this->get_programcompletedcourses($program, $user->id);
                    break;
                case 'programcompletiondate':
                    $data[$key] = $this->get_programcompletiondate($program, $user->id);
                    break;
                default:
                    break;
            }
