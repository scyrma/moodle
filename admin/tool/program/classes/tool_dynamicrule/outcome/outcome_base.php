...
abstract class outcome_base extends \tool_dynamicrule\outcome_base {
    ...
    /** @var int Deallocate user from program */
    public const DEALLOCATE_USER = 1;
    /** @var int Suspend user allocation */
    public const SUSPEND_USER = 2;
    /** @var int Don't modify program user allocation */
    public const DONT_MODIFY_ALLOCATION = 1;
    /** @var int Unsuspend user allocation and change dates */
    public const UNSUSPEND_AND_CHANGE_DATES = 2;
    /** @var int Unsuspend user allocation and keep existing dates */
    public const UNSUSPEND_AND_KEEP_DATES = 3;
    ...
    public function validate_config_form(array $data): array {
        ...
        if (!permission::can_edit_dynamicrule_outcome(reset($program), $this->get_rule())) {
            ...
            $errors['programid'] = get_string('errornopermissionallocateusers', 'tool_program');
        }
