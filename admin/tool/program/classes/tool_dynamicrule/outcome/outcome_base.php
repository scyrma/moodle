...
abstract class outcome_base extends \tool_dynamicrule\outcome_base {
    ...
    public function validate_config_form(array $data): array {
        $errors = [];
        if (!isset($data['programid']) || !$this->program_exists($data['programid'])) {
    ...
    protected function get_programid(): int {
        return (int) $this->get_configdata()['programid'];
    }
     ...
     * @return Closure
     */
    protected function get_format_program_fullname_callback(): Closure {
