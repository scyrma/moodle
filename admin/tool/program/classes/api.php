...
class api {
    ...
    public static function send_program_completed_notification(int $userid, int $programid): void {
        ...
        $programname = (new program($programid))->get_formatted_name();
        ...
        self::send_moodle_notification($user, $provider, $subject, $fullmessage);
    }
     ...
     */
    private static function send_moodle_notification(stdClass $user, string $provider, string $subject, string $fullmessage): void {
