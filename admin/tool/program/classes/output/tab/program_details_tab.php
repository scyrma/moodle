...
/**
 * File for the class program_details_tab.
 *
 * This tab should be only available when user has no permission to edit the program.
 *
 ...
 * @license   Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class program_details_tab extends tab_form {
    ...
    public function get_form_class(): string {
        return edit_program_details_form::class;
    }
    ...
    /**
     * Check permission of the current user to edit program details
     *
     * @return bool
     */
    protected function can_edit(): bool {
        $program = new program($this->data['id'] ?? 0);
        return permission::can_view_details($program) && permission::can_edit_details($program);
    }
    ...
    public function get_template(): string {
        return 'tool_program/edit_program_details';
    }
