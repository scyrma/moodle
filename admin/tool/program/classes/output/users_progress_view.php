...
/**
 * File for class program_progress_report
 *
...
use renderer_base;
use templatable;
use tool_program\local\reports\users_progress_report;
use tool_reportbuilder\system_report_factory;

/**
 * Class program_progress_report
 *
 * @package    tool_program
 * @copyright  2019 Moodle Pty Ltd <support@moodle.com>
 * @author     2019 Mitxel Moriana <mitxel@tresipunt.com>
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class users_progress_view implements templatable, renderable {
    /**
     * @var int $programid
     */
    private $programid;
    ...
    public function export_for_template(renderer_base $output): array {
        ...
        if (class_exists('\\tool_reportbuilder\\system_report_factory')) {
            ...
            $report = system_report_factory::create(users_progress_report::class, $params);
            $table = $report->output();
        } else {
