...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        ...
        // Program dashboard user preferences filters.
        ...
        $collection->add_user_preference('tool_program_program_view_filter',
            'privacy:metadata:preference:tool_program_program_view_filter');
        $collection->add_user_preference('tool_program_program_sort_filter',
            'privacy:metadata:preference:tool_program_program_sort_filter');
    ...
    public static function export_user_preferences(int $userid): void {
        ...
        $value = get_user_preferences('tool_program_program_view_filter', null, $userid);
        if ($value) {
            $str = get_string('privacy:metadata:preference:tool_program_program_view_filter', 'tool_program');
            writer::export_user_preference('tool_program', 'tool_program_program_view_filter', $value, $str);
        }
        $value = get_user_preferences('tool_program_program_sort_filter', null, $userid);
        if ($value) {
            $str = get_string('privacy:metadata:preference:tool_program_program_sort_filter', 'tool_program');
            writer::export_user_preference('tool_program', 'tool_program_program_sort_filter', $value, $str);
        }
    }
}
