...
class programuser_format {
     ...
     * @return string
     */
    public static function programid(string $value, stdClass $row): string {
        return format::integer($row->programid);
    }
    ...
    /**
     * Formats certificationid
     *
     * @param string $value
     * @param stdClass $row
     * @return string
     */
    public static function certificationid(string $value, stdClass $row): string {
        return format::integer($row->certificationid);
    }
