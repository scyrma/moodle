...
class program_overview_view_exporter extends exporter {
    ...
    protected static function define_related(): array {
        return [
            ...
            'programstatusfilterstr' => 'string',
            'programstatusfilterval' => 'string',
            'showfilters' => 'bool',
    ...
    protected static function define_other_properties(): array {
        return [
            ...
            'programstatusfilterstr' => [
                'type' => PARAM_TEXT,
            ],
            'programstatusfilterval' => [
                'type' => PARAM_TEXT,
            ],
            'showfilters' => [
                'type' => PARAM_BOOL,
    ...
    protected function get_other_values(renderer_base $output): array {
        ...
        /** @var string $programstatusfilterstr */
        $programstatusfilterstr = $this->related['programstatusfilterstr'];
        /** @var string $programstatusfilterval */
        $programstatusfilterval = $this->related['programstatusfilterval'];
        ...
        return [
            ...
            'programstatusfilterstr' => $programstatusfilterstr,
            'programstatusfilterval' => $programstatusfilterval,
