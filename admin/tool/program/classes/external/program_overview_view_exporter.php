    ...
    protected function get_other_values(renderer_base $output): array {
        ...
        foreach ($courses as $course) {
            ...
            $relateddata = [
                'context' => $context,
                'course' => $course,
                'coursecompletion' => !is_null($coursescompletion[$course->id]->timecompleted),
                'courseprogress' => $coursesprogress[$course->id],
                'lastcourseaccess' => $lastcourseaccess,
