...
class tool_program_observer {
     ...
     *
     * {@see \tool_program\program_tree_progress::mark_program_as_completed()}
     *
     * @deprecated since 4.1 - no longer used,
     * @param \tool_program\event\program_completed $event
     */
    public static function on_program_completed(\tool_program\event\program_completed $event): void {
        null;
    }
     ...
     *
     * @deprecated since 4.1 - no longer used
     * @param \tool_program\event\user_allocation_deleted $event
     */
    public static function user_allocation_deleted(\tool_program\event\user_allocation_deleted $event): void {
        null;
    }
