...
class permission {
     ...
     * @return bool
     */
    public static function can_allocate_anybody(program $program, bool $checkallocationwindow = true): bool {
        if (!$program->get('id')) {
            return false;
        }
    ...
    public static function can_view_allocated_users(program $program): bool {
        return self::can_edit_details_in_program_tenant($program) || self::can_allocate_anybody($program, false);
    }
