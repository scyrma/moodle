...
/**
 * Tests for program_set persistent
 *
 ...
 */
class program_set_test extends advanced_testcase {
    /**
    ...
    public function test_get_subsets_ids(): void {
        ...
        $subsetsids1 = $baseset->get_subsets_ids();
        $this->assertEquals([$newset1->get('id')], $subsetsids1);

        $subsetsids2 = $newset1->get_subsets_ids();
        $this->assertEquals([$newset2->get('id')], $subsetsids2);
    }
