...
class tool_program_condition_user_not_allocated_testcase extends advanced_testcase {
    ...
    public function test_get_matching_users(): void {
        ...
        $this->generator->allocate_user_to_program($program2->get('id'), $user4->id, 0,
    ...
    /**
     * Test shared program user not allocated in shared rule
     */
    public function test_get_matching_users_user_not_allocated_shared_rule(): void {
        ...
        $this->assertEquals(5, api::count_matching_users($rule->id));
