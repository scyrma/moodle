 ...
 */
class report_programs_test extends advanced_testcase {
    ...
    public function test_convert_to_core_reportbuilder(): void {
        ...
        $this->rbgenerator->datasource_test_convert_to_core_reportbuilder(report_programs::class, $this);
    }
    ...
    public function test_convert_to_core_reportbuilder_custom_fields(): void {
        ...
        // Create program custom fields available in report_users_list datasource.
        $params = [
            'component' => 'tool_program',
            'area' => 'program',
            'itemid' => 0,
            'name' => 'Program custom field',
        ...
        $this->rbgenerator->add_column($report, "tool_program:tpid{$cftextareaid}");
        $this->rbgenerator->add_column($report, "tool_program:tpid{$cftextid}");
        $this->rbgenerator->add_column($report, "tool_program:tpid{$cfdatetimeid}");
        $this->rbgenerator->add_column($report, "tool_program:tpid{$cfcheckboxid}");
        $this->rbgenerator->add_column($report, "tool_program:tpid{$cfmenuid}");

        // Add program custom fields as report filters.
        $this->rbgenerator->add_filter($report, "tool_program:tpid{$cftextareaid}");
        $this->rbgenerator->add_filter($report, "tool_program:tpid{$cftextid}");
        $this->rbgenerator->add_filter($report, "tool_program:tpid{$cfdatetimeid}");
        $this->rbgenerator->add_filter($report, "tool_program:tpid{$cfcheckboxid}");
        $this->rbgenerator->add_filter($report, "tool_program:tpid{$cfmenuid}");

        // Add program custom fields as report conditions.
        $this->rbgenerator->add_condition($report, "tool_program:tpid{$cftextareaid}");
        $this->rbgenerator->add_condition($report, "tool_program:tpid{$cftextid}");
        $this->rbgenerator->add_condition($report, "tool_program:tpid{$cfdatetimeid}");
        $this->rbgenerator->add_condition($report, "tool_program:tpid{$cfcheckboxid}");
        $this->rbgenerator->add_condition($report, "tool_program:tpid{$cfmenuid}");
