...
class tool_program_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_get_user_programs(): void {
        ...
        $this->assertCount(1, $result['origins']);
        ...
        $this->assertEquals($program1->get('id'), $result['origins'][0]['programid']);
        $this->assertEquals($certification->get('id'), $result['origins'][0]['certificationid']);
        $this->assertEquals('certificationmsgactive', $result['origins'][0]['stringid']);
    ...
    public function test_enrol_user_to_course(): void {
        ...
        $this->assertTrue($result['status']);
        $this->assertStringContainsString($course->id, $result['redirecturl']);
