...
class upgradelib_test extends advanced_testcase {
     ...
     */
    public function test_upgrade_remove_users_from_orphaned_groups_2_1() {
        global $CFG, $DB;
        require_once($CFG->dirroot . '/' . $CFG->admin . '/tool/program/db/upgradelib.php');
        $this->resetAfterTest();
        self::setAdminUser();
     ...
     */
    public function test_upgrade_remove_users_from_orphaned_groups_2_2() {
        global $CFG, $DB;
        require_once($CFG->dirroot . '/' . $CFG->admin . '/tool/program/db/upgradelib.php');
        $this->resetAfterTest();
        self::setAdminUser();
     ...
     */
    public function test_upgrade_remove_users_from_orphaned_groups_1_4() {
        global $CFG, $DB;
        require_once($CFG->dirroot . '/' . $CFG->admin . '/tool/program/db/upgradelib.php');
        $this->resetAfterTest();
        self::setAdminUser();
     ...
     */
    public function test_remove_program_tenant_groups_to_nonexisting_program() {
        global $CFG, $DB;
        require_once($CFG->dirroot . '/' . $CFG->admin . '/tool/program/db/upgradelib.php');
        $this->resetAfterTest();
        self::setAdminUser();
     ...
     */
    public function test_remove_enrolments_to_non_existing_programs() {
        global $CFG, $DB;
        require_once($CFG->dirroot . '/' . $CFG->admin . '/tool/program/db/upgradelib.php');
        $this->resetAfterTest();
        self::setAdminUser();
