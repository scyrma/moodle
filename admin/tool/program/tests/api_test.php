...
class tool_program_api_testcase extends advanced_testcase {
    ...
    public function test_create_program(): void {
        ...
        $this->assertSame((string) $programdata->shared, $record->shared);
    ...
    public function test_delete_program_course_enrol_instance() {
        global $DB;
        self::setAdminUser();
        $program = $this->generator->generate_program();
        $baseset = $program->get_base_set();
    ...
    public function test_delete_component_course_tenant_group() {
        global $DB;
        self::setAdminUser();
        $program = $this->generator->generate_program((object)[
    ...
    public function test_get_tenant_group_records() {
        self::setAdminUser();
    ...
    public function test_can_user_be_removed_from_group() {
        self::setAdminUser();
    ...
    public function test_remove_user_from_previous_tenant_groups() {
        global $DB;
        $this->resetAfterTest();
        self::setAdminUser();
