 ...
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class tool_program_api_testcase extends advanced_testcase {
    /**
    ...
    public function test_create_program(): void {
        ...
        $this->assertSame((string) $programdata->tenantid, $record->tenantid);
        $this->assertSame((string) $programdata->fullname, $record->fullname);
        $this->assertSame((string) $programdata->idnumber, $record->idnumber);
        $this->assertSame((string) $programdata->description, $record->description);
        $this->assertSame((string) $programdata->descriptionformat, $record->descriptionformat);
        $this->assertSame((string) $programdata->startdatetype, $record->startdatetype);
        $this->assertSame((string) $programdata->startdateabsolute, $record->startdateabsolute);
        $this->assertSame((string) $programdata->enddatetype, $record->enddatetype);
        $this->assertSame((string) $programdata->enddateabsolute, $record->enddateabsolute);
        $this->assertSame((string) $programdata->archived, $record->archived);
        $this->assertSame((string) $programdata->visible, $record->visible);
        ...
        // TODO SP-85: test program tags saved.
    ...
    public function test_update_program_details(): void {
        ...
        $this->assertNotFalse($record);
        $this->assertSame($programdata->fullname, $record->fullname);
        $this->assertNotSame($originaldata->fullname, $record->fullname);
        $this->assertSame($programdata->idnumber, $record->idnumber);
        $this->assertNotSame($originaldata->idnumber, $record->idnumber);
        $this->assertSame($programdata->description, $record->description);
        $this->assertNotSame($originaldata->description, $record->description);
        $this->assertSame($programdata->descriptionformat, $record->descriptionformat);
        $this->assertNotSame($originaldata->descriptionformat, $record->descriptionformat);
        $this->assertSame((string) $programdata->visible, $record->visible);
        $this->assertNotSame((string) $originaldata->visible, $record->visible);
        $this->assertSame((string) $programdata->allowdirectallocation, $record->allowdirectallocation);
        $this->assertNotSame((string) $originaldata->allowdirectallocation, $record->allowdirectallocation);

        // TODO SP-85: test embedded files in description updated.

        // TODO SP-85: test program image updated.

        // TODO SP-85: test tags updated.
    }
    ...
    public function test_update_program_calendar(): void {
        ...
        $this->assertNotFalse($record);
        $this->assertSame((string) $programdata->startdatetype, $record->startdatetype);
        $this->assertNotSame((string) $originaldata->startdatetype, $record->startdatetype);
        $this->assertSame((string) $programdata->startdateabsolute, $record->startdateabsolute);
        $this->assertNotSame((string) $originaldata->startdateabsolute, $record->startdateabsolute);
        $this->assertSame($programdata->startdaterelative, $record->startdaterelative);
        $this->assertNotSame($originaldata->startdaterelative, $record->startdaterelative);
        $this->assertSame((string) $programdata->duedatetype, $record->duedatetype);
        $this->assertNotSame((string) $originaldata->duedatetype, $record->duedatetype);
        $this->assertSame((string) $programdata->duedateabsolute, $record->duedateabsolute);
        $this->assertNotSame((string) $originaldata->duedateabsolute, $record->duedateabsolute);
        $this->assertSame($programdata->duedaterelative, $record->duedaterelative);
        $this->assertNotSame($originaldata->duedaterelative, $record->duedaterelative);
        $this->assertSame((string) $programdata->enddatetype, $record->enddatetype);
        $this->assertNotSame((string) $originaldata->enddatetype, $record->enddatetype);
        $this->assertSame((string) $programdata->enddateabsolute, $record->enddateabsolute);
        $this->assertNotSame((string) $originaldata->enddateabsolute, $record->enddateabsolute);
        $this->assertSame($programdata->enddaterelative, $record->enddaterelative);
        $this->assertNotSame($originaldata->enddaterelative, $record->enddaterelative);
        $this->assertSame((string) $programdata->allocationstartdatetype, $record->allocationstartdatetype);
        $this->assertNotSame((string) $originaldata->allocationstartdatetype, $record->allocationstartdatetype);
        $this->assertSame((string) $programdata->allocationstartdateabsolute, $record->allocationstartdateabsolute);
        $this->assertNotSame((string) $originaldata->allocationstartdateabsolute, $record->allocationstartdateabsolute);
        $this->assertSame((string) $programdata->allocationenddatetype, $record->allocationenddatetype);
        $this->assertNotSame((string) $originaldata->allocationenddatetype, $record->allocationenddatetype);
        $this->assertSame((string) $programdata->allocationenddateabsolute, $record->allocationenddateabsolute);
        $this->assertNotSame((string) $originaldata->allocationenddateabsolute, $record->allocationenddateabsolute);
        $this->assertSame($programdata->allocationenddaterelative, $record->allocationenddaterelative);
        $this->assertNotSame($originaldata->allocationenddaterelative, $record->allocationenddaterelative);

        // Test on update program calendar, if user allocation source is certification, then user dates are not recalculated.
        $user = self::getDataGenerator()->create_user();
        $programuser = $this->generator->allocate_user_to_program($program->get('id'), $user->id, 15);
        $originaluserstartdate = (int) $programuser->get('startdate');
        $originaluserduedate = (int) $programuser->get('duedate');
        $originaluserenddate = (int) $programuser->get('enddate');

        api::update_program_calendar($programdata);

        $this->assertNotSame(0, (int) $programuser->get('startdate'));
        $this->assertSame($originaluserstartdate, (int) $programuser->get('startdate'));
        $this->assertNotSame(0, (int) $programuser->get('duedate'));
        $this->assertSame($originaluserduedate, (int) $programuser->get('duedate'));
        $this->assertNotSame(0, (int) $programuser->get('enddate'));
        $this->assertSame($originaluserenddate, (int) $programuser->get('enddate'));
        ...
        $this->assertNotSame($originaluserstartdate, (int) $programuser->get('startdate'));
        $this->assertSame(0, (int) $programuser->get('duedate'));
        $this->assertNotSame($originaluserduedate, (int) $programuser->get('duedate'));
        $this->assertSame(0, (int) $programuser->get('enddate'));
        $this->assertNotSame($originaluserenddate, (int) $programuser->get('enddate'));
    }
    ...
    public function test_delete_program(): void {
        ...
        // We check the user enrolment has been suspended.
        $sql = "SELECT ue.*
            ...
            INNER JOIN {enrol} e
                 ...
                 WHERE e.customint1 = :programid
                   ...
                   AND e.enrol = 'program' ";
        $userenrolinstance = $DB->get_record_sql($sql, ['programid' => $programid, 'userid' => $userid]);
        $this->assertEquals(ENROL_USER_SUSPENDED, $userenrolinstance->status);

        // We check if program enrol instance has been disabled.
    ...
    public function test_update_set(): void {
        self::setAdminUser();
        $newset = $this->generator->generate_set();
        ...
        $this->assertSame((string) $originalset->id, $updatedset->get('id'));
        $this->assertNotSame($originalset->name, $updatedset->get('name'));
        $this->assertSame($setdata->name, $updatedset->get('name'));
        $this->assertNotSame((string) $originalset->parent, $updatedset->get('parent'));
        $this->assertSame((string) $setdata->parent, $updatedset->get('parent'));
        $this->assertNotSame((string) $originalset->sortorder, $updatedset->get('sortorder'));
        $this->assertSame((string) $setdata->sortorder, $updatedset->get('sortorder'));
    }
    ...
    public function test_update_set_completion_criteria(): void {
        self::setAdminUser();
        $set = $this->generator->generate_set();
        ...
        $this->assertNotSame((string) $originalset->completioncriteria, $updatedset->get('completioncriteria'));
        $this->assertSame((string) $data->completioncriteria, $updatedset->get('completioncriteria'));
        ...
        $this->assertNotSame((string) $originalset->completioncriteria, $updatedset->get('completioncriteria'));
        $this->assertSame((string) $data->completioncriteria, $updatedset->get('completioncriteria'));
        $this->assertNotSame((string) $originalset->completionatleast, $updatedset->get('completionatleast'));
        $this->assertSame((string) $data->completionatleast, $updatedset->get('completionatleast'));
    }
    ...
    public function test_delete_program_course(): void {
        ...
        // Check if program enrol instance linked to the added course has been disabled.
        $enrolinstance = $DB->get_record('enrol', [
            'courseid' => $course->id,
            'enrol' => 'program',
            'customint1' => $programid,
        ...
        $this->assertNotFalse($enrolinstance);
        $this->assertSame((string) ENROL_INSTANCE_DISABLED, $enrolinstance->status);
    ...
    public function test_allocate_user(): void {
        ...
        $baseset = $program->get_base_set();
        $course = self::getDataGenerator()->create_course();
        self::getDataGenerator()->enrol_user($user->id, $course->id); // Manual enrol.
        $programcourse = $this->generator->add_course_to_set($course->id, $baseset->get('id'));
        $this->generator->enable_program_enrol_instance($programcourse);

        api::allocate_user($program, (object) [
            'programid' => $program->get('id'),
            'userid' => $user->id,
            'certificationid' => 0,
        ]);
        ...
        $sql = "SELECT ue.*
                  ...
                  JOIN {user} u
                    ON (u.id = ue.userid AND u.deleted = 0)
        ...
        // Test if user is allocated with status suspended, the timesuspended timestamp is set.
        $user = self::getDataGenerator()->create_user();
        $programuser = api::allocate_user($program, (object) [
            'programid' => $programid,
            'userid' => $user->id,
    ...
    public function test_allocate_user_triggers_event(): void {
        global $USER;
        self::setAdminUser();
        $program = $program = $this->generator->generate_program_with_base_set();
        $user = self::getDataGenerator()->create_user();
        $userid = $user->id;
    ...
    public function test_deallocate_user(): void {
        ...
        // TODO SP-85: check user enrol instances properly updated.
        ...
        $programuser1 = $this->generator->allocate_user_to_program($programid, $userid, 1);

        api::deallocate_user($programid, $userid, 1, constants::ALLOCATION_DYNAMIC);

        // Since we allocated as "manual" and tried to deallocated a "dynamic" allocation instance, the record must remain.
        $this->assertTrue($DB->record_exists('tool_program_users', ['id' => $programuser1->get('id')]));
    }
    ...
    public function test_add_set_to_parent_set(): void {
        ...
        $orphanedset = $this->generator->generate_set((object) ['programid' => 0]);
        try {
    ...
    public function test_archive_program(): void {
        ...
        $this->assertSame('1', $DB->get_field(program::TABLE, 'archived', ['id' => $programid]));
    }
    ...
    public function test_restore_program_recalculates_program_progress_for_the_allocated_users(): void {
        ...
        $program = $this->generator->generate_program_with_base_set((object) ['archived' => 1]);
        $baseset = $program->get_base_set();
        api::add_course_to_parent_set($baseset->get('id'), $course->id);
    ...
    public function test_duplicate_program(): void {
        ...
        // TODO SP-85: check duplicated program copies tags.
    ...
    public function test_get_user_allocation_statuses(): void {
        ...
        // If program completed, completed must be one of the statuses returned.
    ...
    public function test_get_user_accessible_programs(): void {
        ...
        $program1 = $this->generator->generate_program_with_base_set((object) ['tenantid' => $defaulttenantid]);
        $program2 = $this->generator->generate_program_with_base_set((object) ['tenantid' => $defaulttenantid]);
        $program3 = $this->generator->generate_program_with_base_set((object) ['tenantid' => $defaulttenantid]);
        $program4 = $this->generator->generate_program_with_base_set((object) ['tenantid' => $defaulttenantid]);
        $program5 = $this->generator->generate_program_with_base_set((object) ['tenantid' => $defaulttenantid]);
        ...
        // If program4 was from another tenant, then program4 should not be accesible.
        ...
        $this->assertArrayNotHasKey($program2->get('id'), $accessibleprograms);
        $this->assertArrayNotHasKey($program3->get('id'), $accessibleprograms);
        $this->assertArrayNotHasKey($program4->get('id'), $accessibleprograms);
        $this->assertArrayHasKey($program5->get('id'), $accessibleprograms);
        ...
        $this->assertCount(0, $accessibleprograms);
    }
    ...
    public function test_program_exists_in_tenant(): void {
        ...
        self::setUser($user1);
        $programdata = $this->generator->get_dummy_program_data();
        $programdata->tenantid = $tenant1->id;
    ...
    public function test_get_programs_in_tenant_fieldset(): void {
        ...
        $res = api::get_programs_in_tenant_fieldset($data->user->id);
        $this->assertEmpty($res);

        $programdata = $this->generator->get_dummy_program_data();
        $programdata->tenantid = $data->defaulttenantid;
        $program1 = $this->generator->generate_program($programdata);
        $this->generator->allocate_user_to_program($program1->get('id'), $data->user->id);
        $programdata->tenantid = $data->defaulttenantid;
        $programdata->fullname = 'Program number two';
        $program2 = $this->generator->generate_program($programdata);
        $this->generator->allocate_user_to_program($program2->get('id'), $data->user->id);
        $programdata->fullname = 'Program number three';
        $program3 = $this->generator->generate_program($programdata);
        $this->generator->allocate_user_to_program($program3->get('id'), $data->user->id);
        ...
        $this->generator->allocate_user_to_program($program4->get('id'), $data->user->id);
    ...
    public function test_get_programs_by_status_and_userid(): void {
        ...
        $program1 = $this->generator->generate_program_with_base_set((object) ['tenantid' => $tenant1->id]);
        $program2 = $this->generator->generate_program_with_base_set((object) ['tenantid' => $tenant1->id]);
        $program3 = $this->generator->generate_program_with_base_set((object) ['tenantid' => $tenant1->id]);
    ...
    // TODO SP-85: test add_calendar_event.
    // TODO SP-85: test update_calendar_event.
    // TODO SP-85: test delete_calendar_events.
    ...
    public function test_send_program_completed_notification(): void {
        ...
        $programname = format_string($program->get('fullname'), true, ['context' => $context, 'escape' => false]);
        ...
        $this->assertEquals($fullmessage, $messages[0]->fullmessagehtml);
    }
    ...
    public function test_send_program_user_allocated_notification(): void {
        ...
        // Sink should catch messages.
        $sink = $this->redirectMessages();
        api::send_program_user_allocated_notification($user->id, $program->get('id'));
        $messages = $sink->get_messages();
    ...
    public function test_reset_program_progress(): void {
        ...
        $this->generator->complete_set($childsetid, $data->user->id);
        $this->generator->complete_set($parentsetid, $data->user->id);
        $this->generator->complete_set($basesetid, $data->user->id);
    ...
    public function test_get_default_program_dates(): void {
        ...
        $this->assertEquals('2 week after start date', $dates->duedate);
        $this->assertEquals('3 week after start date', $dates->enddate);
        ...
        $dates = api::get_default_program_dates($program);
        $this->assertEquals('2 week after user allocation date', $dates->duedate);
        $this->assertEquals('3 week after due date', $dates->enddate);
        ...
        $dates = api::get_default_program_dates($program);
        $this->assertEquals('2 week before end date', $dates->duedate);
        $this->assertEquals('3 week after user allocation date', $dates->enddate);
    ...
    public function test_delete_program_dynamic_rules() {
        global $DB;
        $program = $this->generator->generate_program();
        // We need to test also that deletes associated dynamic rules.
