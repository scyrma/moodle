...
class api_test extends advanced_testcase {
     ...
     *
     * @todo WP-3966 remove this test (deprecated method)
     */
     ...
     * NOTE: Moved to block_mylearning
     *
     * @todo WP-3966 remove this test (deprecated method)
     */
    public function test_get_programs_tree_progress(): void {
        ...
        $user = self::getDataGenerator()->create_user();
        $userid = $user->id;
        $this->generator->allocate_user_to_program($programid, $userid);
        $this->generator->allocate_user_to_program($program2id, $userid);
