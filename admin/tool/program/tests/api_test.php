...
class tool_program_api_testcase extends advanced_testcase {
    ...
    public function test_allocate_user_triggers_event(): void {
        global $USER;
        self::setAdminUser();
        $program = $program = $this->generator->generate_program();
        $user = self::getDataGenerator()->create_user();
        $userid = $user->id;
    ...
    public function test_get_programs_by_status_and_userid(): void {
        ...
        $program1 = $this->generator->generate_program((object) ['tenantid' => $tenant1->id]);
        $program2 = $this->generator->generate_program((object) ['tenantid' => $tenant1->id]);
        $program3 = $this->generator->generate_program((object) ['tenantid' => $tenant1->id]);
