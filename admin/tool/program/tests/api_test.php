...
class tool_program_api_testcase extends advanced_testcase {
    ...
    public function test_send_program_completed_notification(): void {
        ...
        $this->assertContains($fullmessage, $messages[0]->fullmessagehtml);
    }
    ...
    public function test_update_program_name_in_calendar_events() {
        global $DB;
        $user1 = self::getDataGenerator()->create_user();
    ...
    public function test_hide_program_user_calendar_events() {
        global $DB;
        $user1 = self::getDataGenerator()->create_user();
        $user2 = self::getDataGenerator()->create_user();
    ...
    public function test_show_program_user_calendar_events() {
        global $DB;
        $user1 = self::getDataGenerator()->create_user();
        $user2 = self::getDataGenerator()->create_user();
