...
Feature: Create program
  ...
  Scenario: Create a program with basic information
    ...
    Then I press "Save"
    And I navigate to "Content" in current page administration
    ...
    # TODO ucomment when column is added again.
#    And I should see "Certification status"
    ...
    And I should see "Users who have status 'Completed' in program"
    And I should see "Users who do not have status 'Completed' in program"
    And I should see "Users who have status 'Overdue' in program"
    And I should see "Users who have status 'Suspended' in program"
    And I navigate to "Programs" in workplace launcher
  ...
  @javascript
  Scenario: Creating another program with the same idnumber
    # I can not create a program with idnumber 'num1' in shared space.
    Given shared space is enabled
    When I log in as "admin"
    And I switch to tenant "Shared space"
    And I navigate to "Programs" in workplace launcher
    Then I click on "New program" "link"
    And I set the following fields in the "New program" "dialogue" to these values:
    ...
    Then I press "Save"
    # I can create a program with idnumber 'num1' in another tenant.
    ...
    And I set the following fields in the "New program" "dialogue" to these values:
      ...
      | Program ID number | num1     |
    Then I press "Save"
    And I should not see "This ID number is already used in another program"
    And I should see "Program2" in the "#page-navbar" "css_element"
    # I can not create a program with 'num2' in a tenant because it already exists in Shared space
    And I navigate to "Programs" in workplace launcher
    Then I click on "New program" "link"
    And I set the following fields in the "New program" "dialogue" to these values:
      | Program name      | Shared program |
      | Program ID number | num2           |
    Then I press "Save"
    And I should see "This ID number is already used in another program"
    And I click on "Cancel" "button" in the "New program" "dialogue"
