...
Feature: It is possible to create programs in shared space
  ...
  Scenario: Site admin can configure dynamic rules in shared programs
    ...
    And I click on "Enable rule" "field" in the "Users not allocated to program 'Program0'" "table_row"
  ...
  Scenario: Using Programs datasource with programs on different tenants
    ...
    And I set the field "Name" in the "New report" "dialogue" to "SharedPrograms"
    And I set the field "Report source" in the "New report" "dialogue" to "Programs"
    And I press "Save"
    # Admin should see programs from both tenants.
    And I should see "Program0" in the "reportbuilder-table" "table"
    And I should see "Program1" in the "reportbuilder-table" "table"
    ...
    And I should not see "Program0" in the "reportbuilder-table" "table"
    And I click on "Reset" "button" in the "[data-region='report-filters']" "css_element"
    And I click on "Close 'SharedPrograms' editor" "button"
    And I switch to tenant "Tenant1"
    And I navigate to "Custom reports" in workplace launcher
    ...
    And I log in as "tenantadmin1"
    And I navigate to "Custom reports" in workplace launcher
    Then I click on "SharedPrograms" "link" in the "SharedPrograms" "table_row"
  ...
  Scenario: Using Program users allocation and completion datasource with programs on different tenants
    ...
    And I navigate to "Custom reports" in workplace launcher
    And I click on "New report" "button"
    And I set the field "Name" in the "New report" "dialogue" to "SharedProgramUsersAllocation"
    ...
    And I should not see "Program0" in the "reportbuilder-table" "table"
    And I click on "Reset" "button" in the "[data-region='report-filters']" "css_element"
    And I click on "Close 'SharedProgramUsersAllocation' editor" "button"
    And I switch to tenant "Tenant1"
    And I navigate to "Custom reports" in workplace launcher
    ...
    And I log in as "tenantadmin1"
    And I navigate to "Custom reports" in workplace launcher
    Then I click on "SharedProgramUsersAllocation" "link" in the "SharedProgramUsersAllocation" "table_row"
    # Tenantadmin1 should only see programs from Tenant1 and shared space.
    And I should see "Program0" in the "reportbuilder-table" "table"
    And I should see "Program1" in the "reportbuilder-table" "table"
    And I should not see "Program2" in the "reportbuilder-table" "table"
