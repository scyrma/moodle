...
Feature: Edit program content with the drag and drop editor and check overview
  ...
  Scenario: Add one course to a program
    ...
    Then I click on "Course 3" "text" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
  ...
  Scenario: Add one set with courses to a program and reorder courses
    ...
    And I should see "Course 2" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I should see "Course 3" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I should see "Course 4" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    Then I click on "Course 1" "text" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I click on "Course 2" "text" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I click on "Course 4" "text" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I press key "27" in the field "Select courses"
    And I select "All in order" from the "completioncriteria" singleselect
    Then I press "Save changes" in the modal form dialogue
    And I should not see "Nothing to display"
    ...
    Then I open the autocomplete suggestions list in the dialog
    And I click on "Course 3" "text" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I click on "Course 4" "text" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I press key "27" in the field "Select courses"
    And I select "At least" from the "completioncriteria" singleselect
    And I set the field "completionatleast" to "2"
    Then I press "Save changes" in the modal form dialogue
    And I log out
    # Check that now program is set to Complete at least 2
    And I log in as "user11"
    And I should see "Programs"
    And I should see "Complete at least 2 (0/3)" in the ".programinfo" "css_element"
    And I press "Set 2"
    And "Available" "text" should exist in the "//*[normalize-space(text()) = 'Course 4']" "xpath_element"
  ...
  Scenario: Add different completion criteria sets into another set
    ...
    Then I open the autocomplete suggestions list in the dialog
    And I should see "Course 5" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I should see "Course 6" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    Then I click on "Course 5" "text" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I click on "Course 6" "text" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I press key "27" in the field "Select courses"
