...
Feature: Check different user capabilities
  ...
  Scenario: Manager has both capabilities and can edit and allocate users
    ...
    Then I should not see "Program2" in the "reportbuilder-table" "table"
    ...
    And I press "Save changes"
    And I should see "Users" in the "Users" "tool_wp > Secondary tab"
    And I should see "User a" in the "reportbuilder-table" "table"
    And I should see "User b" in the "reportbuilder-table" "table"
    And I should not see "User c" in the "reportbuilder-table" "table"
    And I should not see "User d" in the "reportbuilder-table" "table"
    And I should not see "Suspended" in the "User a" "table_row"
    And I press "Edit" action in the "User a" report row
    And I should see "Allocation for 'User a'"
    ...
    And I navigate to "Programs" in workplace launcher
    And I should see "Active programs" in the "Active" "tool_wp > Secondary tab"
    And I should not see "Program1" in the "reportbuilder-table" "table"
    And I should see "Program2" in the "reportbuilder-table" "table"

  Scenario: Manager has allocate user capabilities but can not edit program
    When I log in as "manager2"
    And I navigate to "Programs" in workplace launcher
    Then I should see "Active programs" in the "Active" "tool_wp > Secondary tab"
    And "Archived" "tool_wp > Secondary tab" should not exist
    ...
    And I should not see "User d" in the "reportbuilder-table" "table"
    And I should not see "Suspended" in the "User a" "table_row"
    And I press "Delete" action in the "User a" report row
    And I click on "Yes" "button" in the "Delete user allocation" "dialogue"
    And I should not see "User a" in the "reportbuilder-table" "table"
    And I should see "User b" in the "reportbuilder-table" "table"
  ...
  Scenario: Organisation user has allocate user capabilities but can not edit program and has no manager capabilities
    ...
    And I should not see "User c" in the "reportbuilder-table" "table"
    And I should not see "User d" in the "reportbuilder-table" "table"
    And I should not see "User f" in the "reportbuilder-table" "table"
    And I should not see "Suspended" in the "User a" "table_row"
    And I press "Delete" action in the "User a" report row
    And I click on "Yes" "button" in the "Delete user allocation" "dialogue"
    And I should not see "User a" in the "reportbuilder-table" "table"
    ...
    And I press "Save changes"
    And I should see "Users" in the "Users" "tool_wp > Secondary tab"
    And I should see "User f" in the "reportbuilder-table" "table"
