...
Feature: Check different user capabilities
  ...
  Background:
    ...
    And I set the following system permissions of "program user manager" role:
  ...
  Scenario: Manager has both capabilities and can edit and allocate users
    ...
    And ".edit_program" "css_element" should exist in the "Program1" "table_row"
    And ".edit_details" "css_element" should exist in the "Program1" "table_row"
    And ".allocate_users" "css_element" should exist in the "Program1" "table_row"
    Then I click on ".edit_program" "css_element" in the "Program1" "table_row"
    And the "class" attribute of "a#program_calendar_tab-tab" "css_element" should not contain "disabled"
    And the "class" attribute of "a#program_users_tab-tab" "css_element" should not contain "disabled"
  ...
  Scenario: Manager has allocate user capabilities but can not edit program
    ...
    And I should see "Program1"
    And I should not see "Program2"
    And ".edit_program" "css_element" should not exist in the "Program1" "table_row"
    And ".edit_details" "css_element" should not exist in the "Program1" "table_row"
    And ".allocate_users" "css_element" should exist in the "Program1" "table_row"
    ...
    And I should not see "User d"
    Then I should not see "Suspended"
    Then I click on ".confirm_deallocate_user" "css_element" in the "User a" "table_row"
  ...
  Scenario: Manager has edit capabilities and can not allocate users
    ...
    And ".edit_program" "css_element" should exist in the "Program1" "table_row"
    And ".edit_details" "css_element" should exist in the "Program1" "table_row"
    And ".allocate_users" "css_element" should not exist in the "Program1" "table_row"
    Then I click on ".edit_program" "css_element" in the "Program1" "table_row"
    And the "class" attribute of "a#program_calendar_tab-tab" "css_element" should not contain "disabled"
    And the "class" attribute of "a#program_users_tab-tab" "css_element" should not contain "disabled"
    Then I click on "Edit details" "button"
  ...
  Scenario: Organisation user has allocate user capabilities but can not edit program and has no manager capabilities
    ...
    And I should see "User b" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I should see "User c" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I should not see "User d" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I should not see "User e" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I click on "User a" "text" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    And I click on "User b" "text" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    Then I press "Save" in the modal form dialogue
    Then I should see "Users"
