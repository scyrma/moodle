...
Feature: View program as organisation manager
  ...
  Scenario: Organisation manager should not be able to edit program
    ...
    Then I click on "Course12" "text" in the ".modal-dialog .form-autocomplete-suggestions" "css_element"
    ...
    When I click on "Edit actions of rule 'Program rules'" "link" in the "Users allocated to program 'Program1'" "table_row"
