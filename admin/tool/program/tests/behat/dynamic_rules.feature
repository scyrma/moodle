...
Feature: Program conditions and actions are marked as broken if program gets deleted or archived
  ...
  Scenario: Program completed condition and Allocate users action is marked as broken if program gets archived/deleted
    ...
    And I click on ".form-autocomplete-downarrow" "css_element" in the ".select_program_field" "css_element"
    And I should see "Program2" in the ".select_program_field .form-autocomplete-suggestions" "css_element"
    Then I click on "Program2" "text" in the ".select_program_field .form-autocomplete-suggestions" "css_element"
    And I press "Save changes"
    ...
    Then I click on ".archive_program" "css_element" in the "Program1" "table_row"
    And I press "Archive"
