...
class course_groups_test extends advanced_testcase {
     ...
     * User will be enrolled in a tenant group in the shared course and without group in a tenant course
     */
    public function test_enrol_in_groups_shared_space() {
        self::setAdminUser();
     ...
     * User will be enrolled in a tenant group in the shared course and without group in a tenant course
     */
    public function test_enrol_in_groups_per_program_shared_space() {
        self::setAdminUser();
     ...
     */
    public function test_enrol_in_program_groups_move_tenant() {
        self::setAdminUser();
     ...
     */
    public function test_enrol_in_tenant_groups_move_tenant() {
        self::setAdminUser();
