...
class export_import_test extends advanced_testcase {
     ...
     */
    public function test_program_export_active_programs(): void {
     ...
     * @return void
     */
    public function test_export_all_programs(): void {
        [$tenant, $users] = $this->tenantgenerator->create_tenant_and_users(3);
        [$tenant2, $users2] = $this->tenantgenerator->create_tenant_and_users(3);
        $params = ['tenantid' => $tenant->id];
        $program1 = $this->generator->generate_program_with_course((object)($params + ['fullname' => 'Program 1']));
     ...
     */
    public function test_export_shared_program(): void {
        global $DB;
        ...
        $exportid = $this->wpgenerator->perform_export(\tool_program\tool_wp\exporter\programs::class, $exportparams);
     ...
     */
    protected function create_and_export_program(array $programparams, array $exportsettings = [], array $users = []): array {
        global $DB, $CFG;
     ...
     */
    public function test_import_shared_program(): void {
        global $DB;
     ...
     */
    public function test_export_import_shared_program_allocations(): void {
        global $DB;
     ...
     */
    public function test_export_shared_programs_in_tenant_export(): void {
        global $DB;
     ...
     */
    public function test_program_import_idnumberconflict_skip(): void {
        global $DB;
        $this->resetAfterTest();
     ...
     */
    public function test_program_import_idnumberconflict_increment(): void {
        global $DB;
        $this->resetAfterTest();
     ...
     */
    public function test_export_review(): void {
        [$tenant, $users] = $this->tenantgenerator->create_tenant_and_users(3);
        [$tenant2, $users2] = $this->tenantgenerator->create_tenant_and_users(3);
        $params = ['tenantid' => $tenant->id];
        $program1 = $this->generator->generate_program_with_course((object)($params + ['fullname' => 'Program 1']));
     ...
     */
    public function test_import_program_with_courses(): void {
        global $DB;
     ...
     */
    public function test_import_program_with_dynamicrules(): void {
        global $DB;
     ...
     * @return program
     */
    protected function create_program_with_courses(array $programdata, array $courses): program {
    ...
    public function test_import_program_with_allocation_window_and_direct_allocation_disabled(): void {
        ...
        $programs = program::get_records();
        $this->assertFalse($programs[0]->get('allowdirectallocation'));
