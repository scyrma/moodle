...
/**
 * Programs datasource tests.
 *
 * @covers     \tool_program\reportbuilder\datasource\programs
 * @package    tool_program
 * @copyright  2022 Moodle Pty Ltd <support@moodle.com>
 * @author     2022 David Matamoros <davidmc@moodle.com>
 * @license    Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class programs_test extends core_reportbuilder_testcase {
    ...
    /**
     * Test programs datasource
     */
    public function test_programs_datasource(): void {
        $this->resetAfterTest();
        ...
        $report = $this->rbgenerator->create_report(['name' => 'Programs', 'source' => programs::class, 'default' => false]);
        ...
        // Add program archived column to the report.
        $this->rbgenerator->create_column(['reportid' => $report->get('id'), 'uniqueidentifier' => 'program:archived']);
        ...
        $this->assertEquals([
            ...
            'No', // Archived.
            'My Lionel course', // Course full name.
        ], $contentrow);
    }
    ...
    public function test_stress_datasource(): void {
        ...
        $this->datasource_stress_test_columns(programs::class);
        $this->datasource_stress_test_columns_aggregation(programs::class);
        $this->datasource_stress_test_conditions(programs::class, 'program:fullname');
    }
}
