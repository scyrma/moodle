...
class tool_program_condition_program_not_completed_testcase extends advanced_testcase {
    ...
    public function test_get_title(): void {
        $condition = new program_not_completed();
    ...
    public function test_get_config_attributes(): void {
        ...
        $reflector = new ReflectionClass(program_not_completed::class);
        $method = $reflector->getMethod('get_config_attributes');
        $method->setAccessible(true);

        $outcome = new program_not_completed();
    ...
    public function test_is_configuration_valid(): void {
        ...
        $condition = program_not_completed::create($rule->id, $configdata);
