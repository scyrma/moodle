...
class tool_program_condition_program_completed_testcase extends advanced_testcase {
    ...
    public function test_get_matching_users_shared_program(): void {
        ...
        $programgenerator->allocate_users_to_program($program1->get('id'), [$user1->id, $user2->id, $user3->id]);
        $programgenerator->allocate_users_to_program($program1->get('id'), [$user21->id, $user22->id, $user23->id]);
