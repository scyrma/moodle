...
EOF;
        ...
        $this->assertEquals('open',
            api::get_user_allocation_statuses($program->get('id'), $user1->id, 0)[0]['stringid']);
        ...
        $this->assertEquals('open',
            api::get_user_allocation_statuses($program->get('id'), $user2->id, 0)[0]['stringid']);
    }
