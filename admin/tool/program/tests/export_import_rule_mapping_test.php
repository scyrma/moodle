...
/**
 * Class containing tests for rule class field mapping during export/import
 *
 ...
 */
class export_import_rule_mapping_test extends advanced_testcase {
    ...
    public static function condition_provider(): array {
        ...
        $conditions = array_filter(api::get_conditions(), [self::class, 'filter_instance_by_plugin']);
    ...
    public static function outcome_provider(): array {
        ...
        $outcomes = array_filter(api::get_outcomes(), [self::class, 'filter_instance_by_plugin']);
