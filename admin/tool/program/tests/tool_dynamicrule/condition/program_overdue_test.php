 ...
 */
class program_overdue_test extends advanced_testcase {
    ...
    public function test_get_matching_users_given_overdue_status(): void {
        ...
        $this->generator->allocate_users_to_program($program->get('id'), [$user2->id, $user3->id]);
    ...
    /**
     * Test shared program overdue status matching in shared rule
     */
    public function test_get_matching_users_given_overdue_status_shared_rule(): void {
        ...
        // Set program allocation to Overdue.
        $now = time();
        $programuser1->set('duedate', $now - 3600);
        $programuser1->update();
        $programuser21->set('duedate', $now - 3600);
