 ...
 * @covers    \tool_program\task\deallocate_from_previous_tenant_programs
 * @copyright 2020 Moodle Pty Ltd <support@moodle.com>
 * @author    2020 David Matamoros <davidmc@moodle.com>
 * @license   Moodle Workplace License, distribution is restricted, contact support@moodle.com
 */
class deallocate_from_previous_tenant_programs_test extends advanced_testcase {
    ...
    public function test_deallocate_from_previous_tenant_programs(): void {
        ...
        $this->generator->allocate_users_to_program($program1->get('id'), [$user1->id, $user2->id, $user3->id, $user4->id]);
