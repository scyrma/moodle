 ...
 */
class program_enrolment_test extends advanced_testcase {
    ...
    public function setUp(): void {
        ...
        /** @var \tool_program_generator $generator */
        $generator = $this->getDataGenerator()->get_plugin_generator('tool_program');
    ...
    public function test_self_enrol_on_access(): void {
        ...
        external::enrol_user_to_course($this->course1->id, $this->program1->get('id'));
        ...
        // Complete the course.
        $this->generator->complete_courses([$this->course1->id], $this->user1->id);
    ...
    public function test_add_course_program_with_completed_course(): void {
        ...
        // Complete the course.
        $this->generator->complete_courses([$this->course3->id], $this->user2->id);
    ...
    public function test_allocate_user_with_completed_course(): void {
        ...
        // Complete the course.
        $this->generator->complete_courses([$this->course1->id], $this->user3->id);
