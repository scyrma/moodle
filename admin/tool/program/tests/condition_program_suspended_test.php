...
/**
 * File contains the unit tests for condition program_suspended class.
 *
...
use tool_program\tool_dynamicrule\condition\program_suspended;
...
class tool_program_condition_program_suspended_testcase extends advanced_testcase {
    ...
    public function test_get_matching_users_given_suspended_status_shared_rule(): void {
        ...
        $this->generator->allocate_users_to_program($program1->get('id'), [$user22->id, $user23->id]);
