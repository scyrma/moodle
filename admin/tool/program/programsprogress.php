...
if (!empty($userid)) {
    ...
    // TODO WP-4163 this will be properly addressed when we add a 'Reports' tab to the programs list.
    $PAGE->set_context(context_system::instance());
    $PAGE->set_title($strprogramprogress);
    $PAGE->set_heading($strprogramprogress);
} else {
