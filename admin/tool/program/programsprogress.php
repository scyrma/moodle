...
use tool_program\reportbuilder\local\systemreports\programs_progress;

require_once(__DIR__ . '/../../../config.php');

// Get URL parameters.
$userid = required_param('userid', PARAM_INT); // User id.
$type = optional_param('type', constants::STATUS_UNKNOWN, PARAM_INT); // Pre-load table filtering by this status type.
...
$report = \tool_tenant\system_report_factory::create(programs_progress::class, ['userid' => $userid]);

// Pre-filter if type is specified in URL.
if ($type !== constants::STATUS_UNKNOWN) {
