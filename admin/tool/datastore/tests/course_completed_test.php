...
class tool_datastore_course_completed_testcase extends advanced_testcase {
    ...
    public function test_get_data_in_snapshot_table() {
        ...
        $snapshot = \tool_datastore\snapshot::from_entity($entitycourse);
        ...
        $snapshot = \tool_datastore\snapshot::from_entity($entityuser);
        $data = $snapshot->get('data');
        $hash = $snapshot->get('hash');
        ...
        $coursecompletionsnapshot = \tool_datastore\snapshot::from_entity($entitycoursecompletion);
